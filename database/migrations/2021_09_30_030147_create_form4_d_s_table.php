...
class CreateForm4DSTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('form4_d_s', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('rekod_veniermuka')->nullable();
            $table->string('rekod_venierteras')->nullable();
