...
class CreateForm4ESTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('form4_e_s', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('jumlah_venier_eksport')->nullable();
            $table->string('jumlah_venier_tempatan')->nullable();
            $table->string('total_export_cleaning')->nullable();
            $table->string('jumlah_pasaran_tempatan_cleaning')->nullable();
            $table->string('jumlah_venier_eksport_cleaning')->nullable();
            $table->string('jumlah_venier_tempatan_cleaning')->nullable();
