...
class ListDController extends Controller
{
    ...
    public function shuttle_5_listD_ipjpsm($year)
    {
        ...
        $form5D_kilang = DB::select(DB::raw("SELECT DISTINCT shuttles.*, COALESCE(d.daerah_hutan, shuttles.daerah_id) as daerah_display FROM form5_d_s
    ...
    public function shuttle_5_listD_jpn($year){
        ...
        return view('admins.shuttle-five.shuttle-5-listD-jpn',compact('returnArr','form5D','user','year_list','year','buffer','formD_kilang','batch'));
    }
