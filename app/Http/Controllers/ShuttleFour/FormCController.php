...
class FormCController extends Controller
{
    public function shuttle_4_formCKKB($bulan_id, $year = null)
    {
        ...
        // FormA must be filled before FormC
        $formAFilled = FormA::where('shuttle_id', $shuttle_id)
            ->where('tahun', $year)
        ...
        if ($kemasukan_bahans->isEmpty()) {
            foreach ($species as $keySpecies => $data) {
                ...
                KemasukanBahan::create([
                    ...
                    'kayu_masuk' => 0,
                    'jumlah_stok_kayu_balak' => $baki_stok ?? 0,
                    'proses_masuk' => 0,
                    'proses_keluar' => 0,
                    ...
                    'jumlah_baki_stok' => $jumlah_baki_stok ?? 0,
                    'jumlah_kayu_masuk' => 0,
                    'total_stok_kayu_balak' => $jumlah_baki_stok ?? 0,
                    'total_kayu_masuk_jentera' =>  0,
                    'total_kayu_keluar_jentera' => 0,
                    'total_kayu_dibawa_bulan_hadapan' =>  $jumlah_baki_stok ?? 0,
