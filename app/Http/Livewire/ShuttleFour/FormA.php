...
class FormA extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.shuttle-four.form-a',compact('state','district','poskod_kilang','poskod_surat_menyurat','taraf_sah_syarikat','hak_milik','warganegara'));
    }
    ...
    public function storeA(){
        ...
        session()->flash('success', 'Maklumat Borang 4A Berjaya Ditambah.');
