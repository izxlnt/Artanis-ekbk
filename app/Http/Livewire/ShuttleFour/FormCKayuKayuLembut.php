...
class FormCKayuKayuLembut extends Component
{
    ...
    public function render()
    {
        ...
        if($this->kilang_info->shuttle_type == '3'){
            ...
            $kembali = route('user.shuttle-3-formC.KKR', $this->bulan_id);
        }
        elseif($this->kilang_info->shuttle_type == '4'){
            ...
            $kembali = route('user.shuttle-4-formC.KKR', $this->bulan_id);
        }
        ...
        return view('livewire.shuttle-four.form-c-kayu-kayu-lembut', compact('returnArr'));
    }
    ...
    public function mount()
    {
        ...
        if ($kemasukan_bahans->isEmpty()) {
            ...
            foreach ($this->species as $key => $value) {
                ...
                $this->jumlah_baki_stok[$key] = $data->jumlah_baki_stok;
                ...
                $this->jumlah_besar_baki_stok_bulan_lepas = $data->jumlah_besar_baki_stok_bulan_lepas;
    ...
    public function store()
    {
        ...
        return redirect()->route('user.shuttle-4-formC.LainLain', $this->bulan_id);
    }
