...
class FormB extends Component
{
    ...
    public function store()
    {
        ...
        foreach ($kategori_pekerja as $key => $data) {
            ...
            // could leave duplicate rows per category (e.g. duplicate "Perkeranian" rows)
            // since two concurrent requests could each pass the delete before either
            // finished recreating rows.
