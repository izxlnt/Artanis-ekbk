...
class FormA extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.shuttle-three.form-a',compact('state','district','poskod_kilang','poskod_surat_menyurat','taraf_sah_syarikat','hak_milik','warganegara','user','kilang_info'));
    }
