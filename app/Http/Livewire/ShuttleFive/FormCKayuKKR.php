...
class FormCKayuKKR extends Component
{
    ...
    public function render()
    {
        ...
        $kembali = route('user.shuttle-5-formC.KKS', $this->bulan_id);
        $returnArr = ['breadcrumbs' => $breadcrumbs, 'kembali' => $kembali];
        return view('livewire.shuttle-five.form-c-kayu-k-k-r', compact('returnArr'));
    }
    ...
    public function store()
    {
        ...
        if ($this->sebelumnya) {
            return redirect()->route('user.shuttle-5-formC.KKS', $this->bulan_id);
        }
