                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body" style="width: 100%">
                            ...
                            <br><br>
                            <div>
                                <h4 class="text-center">NOTIFIKASI KILANG - SHUTTLE 3</h4>
                            </div>
                                    ...
                                    <tbody>
                                        @foreach ($kilang_s3 as $data)
                                            <tr>
                                                ...
                                                <td>{{ $form_A_counter + $form_B_counter + $form_C_counter + $form_D_counter }}
                                                </td>

                                                <td>
                                                    @if ($form_A_counter + $form_B_counter + $form_C_counter + $form_D_counter != 0)
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <form action="{{ route('phd.notifikasi-kilang.s3.send') }}">
                                @csrf
