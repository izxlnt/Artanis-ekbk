  ...
  <div class="row">
    ...
    <div class="col-12">
      ...
      <div class="row" style="justify-content: space-around;">
        <a class="col-lg-4 col-md-6" href="{{ route('bpm.senarai_kilang_papan_aktif') }}" style="color:black;">
        ...
        <a class="col-lg-4 col-md-6" href="{{ route('bpm.senarai_kilang_papan_lapis_aktif') }}"
        style="color:black;">
    ...
    <a class="col-lg-4 col-md-6" href="{{ route('bpm.senarai_kilang_kumai_aktif') }}" style="color:black;">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
            ...
            <br>
            <div class="row" style="justify-content: space-around;">
                <a class="col-lg-4 col-md-6" href="{{ route('ipjpsm.status-permohonan-bpe') }}"
                    style="color:black;">
                    <div class="card bg-info card-hover" style="border-radius: 25px">
                        <div class="card-body"
                            style="box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2); background-color: #ee8dcd ;border-radius: 25px;text-align:center;">
                            <div class="d-flex no-block align-items-center">
                                <div class="text-white">
                                    <b><span style="font-size:40px;" id="bpe">0</span></b>
                                    <h5>Jabatan Perhutanan Semenanjung Malaysia (IPJPSM)</h5>
                                </div>
                                <div class="ml-auto">
