                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a type="button" href="{{ route('phd.shuttle-3-listD') }}" class="btn waves-effect waves-light btn-outline-info">Borang 3D</a>
                                    ...
                                    <a type="button" href="{{ route('shuttle-3-listC') }}" class="btn waves-effect waves-light btn-outline-info active">Borang 3C</a>
                                    <a type="button" href="{{ route('shuttle-3-listD') }}" class="btn waves-effect waves-light btn-outline-info">Borang 3D</a>
                                    @endif
                         ...
                         <br><br>
                         <div><h4>BORANG 3C - PENYATA KEMASUKAN & PEMPROSESAN KAYU BALAK <br> DAN PENGELUARAN KAYU GERGAJI MENGIKUT KUMPULAN KAYU-KAYAN</h4></div>
                        <div class="table-responsive">
                            <table id="example" class="display" style="width:100%">
                                ...
                                <tbody>
                                    @foreach ($shuttle_listC as $shuttle)
                                        <tr>
                                            <td>{{ $loop->index + 1 }}</td>
