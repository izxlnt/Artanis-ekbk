                    ...
                    <div class="card-body" style="width: 100%">
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <a type="button" href="{{ route('phd.shuttle-3-listA') }}" class="btn waves-effect waves-light btn-outline-info active">Borang 3A</a>
                        ...
                        <br><br>
                        <div><h4>BORANG 3A - MAKLUMAT KILANG PAPAN</h4></div>
                        <div class="table-responsive">
                            <table id="example" class="display" style="width:100%">
                                ...
                                <tbody>
                                    @foreach ($shuttle_listA as $shuttle)
                                        <tr>
                                            <td>{{ $loop->index + 1 }}</td>
                                            ...
                                            <td> <a href="{{ route('shuttle-3-formA') }}" class="mr-1 btn btn-success"><i
