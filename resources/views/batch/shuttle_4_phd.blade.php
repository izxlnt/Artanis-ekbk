...
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body" style="width: 100%">
                            ...
                            <br><br>
                            <div>
                                <h4 class="text-center">PENGESAHAN PAKEJ - SHUTTLE 4</h4>
                            </div>
                                        ...
                                        @foreach ($batch as $data)
                                            <tr>
                                                    ...
                                                    @else
                                                        @if ($data->bulan == 3 || $data->bulan == 6 || $data->bulan == 9 || $data->bulan == 12)
                                                            <img src="{{ asset('circle_times.png') }}" height='30px'
                                                                alt="" style="color: black; font-size: 18pt;"
                                                                data-toggle="tooltip" data-placement="bottom"
                                                ...
                                                <td>
                                                    ...
                                                    @if ($data->borang_c == 2 && $data->borang_d == 2 && $data->borang_e == 2)
                                                        @if ($data->bulan == 3 || $data->bulan == 6 || $data->bulan == 9 || $data->bulan == 12)
                                                            @if ($data->borang_b == 2)
                                                                @if ($data->borang_a == 1)
                                                                ...
                                                                @else
                                                                    <form
                                                                        ...
                                                                        <a type="button" alt="default"
                                                                            data-toggle="modal"
                                                                            data-target="#confirmation_borang_a{{ $data->id }}"><img
                                                                                src="{{ asset('share.png') }}"
                                                                                height='30px' alt=""
                                                                                data-toggle="tooltip"
                                                                        ...
                                                                        <div class="modal fade"
                                                                            id="confirmation_borang_a{{ $data->id }}"
                                                                                ...
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body"
                                                                                        style="text-align: left;"><b>
                                                                                            <span
                                                                                                class="text-center">Adakah
                                                                                                anda
                                                                                                pasti ingin menghantar
                                                                                                borang
                                                                                                ini?</span>
                                                                                    </div>
    ...
    <script>
        function changePage() {
            ...
            window.location.href = "<?php echo URL::to('/phd/batch/shuttle-4/" + year +"'); ?>";
        }
    </script>
