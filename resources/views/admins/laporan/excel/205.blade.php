                                ...
                                <tbody>
                                    ...
                                    @foreach ($shuttle as $kilang)
                                        ...
                                        @endphp
                                            ...
                                            <td style="text-align: right">{{ number_format($jumlah_besar_mr, 0) }}</td>
                                            <td style="text-align: right">{{ number_format($jumlah_besar_wbp, 0) }}</td>
                                            ...
                                            <td style="text-align: right">{{ number_format($nipis, 0) }}</td>
                                            <td style="text-align: right">{{ number_format($tebal, 0) }}</td>
                                        </tr>
                                    @endforeach
