    ...
    <tbody>
        ...
        @foreach ($shuttle as $kilang)
            <tr>
                ...
                <td style="text-align: right">
                    {{ number_format($data_guna_tenagas[$kilang->id]->pekerja_asing_lelaki_laporan, 0) }}
                </td>
                <td style="text-align: right">
                    {{ number_format($data_guna_tenagas[$kilang->id]->pekerja_asing_perempuan_laporan, 0) }}
                </td>

                <td style="text-align: right">
                    {{ number_format($data_kemasukan_bahans[$kilang->id]->jumlah_penggunaan, 0) }}
                </td>
                <td style="text-align: right">
                    {{ number_format($data_kemasukan_bahans[$kilang->id]->jumlah_pengeluaran, 0) }}
                </td>
