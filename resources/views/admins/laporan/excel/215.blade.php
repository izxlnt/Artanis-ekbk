    ...
    <table>
        ...
        @else
            ...
            <tr style="background-color: lightgray; font-weight: bold;">
                ...
                <td style="text-align: right">{{ number_format($jumlah_purata_lelaki = $jumlah_gaji_lelaki / max($jumlah_jumlah_lelaki, 1), 0) }}
                </td>
                <td style="text-align: right">{{ number_format($jumlah_purata_perempuan = $jumlah_gaji_perempuan / max($jumlah_jumlah_perempuan, 1), 0) }}
                </td>
                <td style="text-align: right">{{ number_format($jumlah_purata_keseluruhan = $jumlah_pendapatan / max($jumlah_jumlah_jumlah, 1), 0) }}
                </td>
