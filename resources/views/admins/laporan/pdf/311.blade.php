                    ...
                    <div class="table-responsive" style="padding-top: 15px;">
                        @foreach ($datas as $key => $data_jumlah)
                            @if (!$loop->first)
                                ...
                                @if ($nama_suku_tahun != $nama_suku_tahun_akhir)
                                    <div class="text-center card-header" style="text-align:center;">{{ $title }}
                                        : Suku
                            ...
                            @if ($key == 1)
                                <div class="text-center"
                                    style="font-weight: bold; text-align:center; padding-top: 15px;">Suku
                                    Tahun Pertama</div>
                            @elseif($key == 2)
                                <div class="text-center"
                                    style="font-weight: bold; text-align:center; padding-top: 15px;">Suku
                            ...
                            <table id="example_{{ $key }}" class="text-center table-bordered"
                                ...
                                <tr style="background-color: lightgray; font-weight: bold; text-align: right;">
                                    ...
                                    <td style="text-align: center;">{{ number_format($jumlah_lelaki, 0) }}</td>
                                    <td style="text-align: center;">{{ number_format($jumlah_perempuan, 0) }}</td>
                                    <td style="text-align: center;">{{ number_format($jumlah_guna_tenaga, 0) }}</td>

                                    <td style="text-align: center;">{{ number_format(round($jumlah_gaji_lelaki, 2)) }}</td>
                                    <td style="text-align: center;">{{ number_format(round($jumlah_gaji_perempuan, 2)) }}</td>
                                    <td style="text-align: center;">{{ number_format(round($jumlah_pendapatan, 2)) }}</td>

                                    <td style="text-align: center;">{{ number_format(round($jumlah_purata_lelaki = $jumlah_gaji_lelaki / max($jumlah_lelaki, 1), 2)) }}
                                    </td>
                                    <td style="text-align: center;">{{ number_format(round($jumlah_purata_perempuan = $jumlah_gaji_perempuan / max($jumlah_perempuan, 1), 2)) }}
                                    </td>
                                    <td style="text-align: center;">{{ number_format(round($jumlah_purata_keseluruhan = $jumlah_pendapatan / max($jumlah_guna_tenaga, 1), 2)) }}
                                    </td>
