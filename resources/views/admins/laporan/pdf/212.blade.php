                            ...
                            <table id="example_{{ $key }}" class="text-center table-bordered"
                                ...
                                <tbody>
                                    ...
                                    <tr style="background-color: lightgray; font-weight: bold; text-align: right;">
                                        ...
                                        <td style="text-align: left;">{{ $jumlah_lelaki }}</td>
                                        <td style="text-align: left;">{{ $jumlah_perempuan }}</td>
                                        <td style="text-align: left;">{{ $jumlah_guna_tenaga }}</td>

                                        <td style="text-align: left;">{{ number_format(round($jumlah_gaji_lelaki, 2)) }}</td>
                                        <td style="text-align: left;">{{ number_format(round($jumlah_gaji_perempuan, 2)) }}</td>
                                        <td style="text-align: left;">{{ number_format(round($jumlah_pendapatan, 2)) }}</td>

                                        <td style="text-align: left;">{{ number_format(round($jumlah_purata_lelaki = $jumlah_gaji_lelaki / max($jumlah_lelaki, 1), 2)) }}
                                        </td>
                                        <td style="text-align: left;">{{ number_format(round($jumlah_purata_perempuan = $jumlah_gaji_perempuan / max($jumlah_perempuan, 1), 2)) }}
                                        </td>
                                        <td style="text-align: left;">{{ number_format(round($jumlah_purata_keseluruhan = $jumlah_pendapatan / max($jumlah_guna_tenaga, 1), 2)) }}
                                        </td>
