        ...
        <div class="page-breadcrumb" style="padding: 0px">
            <div class="pb-2 row">
                <div class="col-5 align-self-center">
                    ...
                    <a href="{{ route('laporan_shuttle_4_14.excel', ['14', $tahun, $suku_tahun, $suku_tahun_akhir, $file_type = 'excel']) }}" class="btn btn-success">Excel</a>
                    <a href="{{ route('laporan_shuttle_4_14.excel', ['14', $tahun, $suku_tahun, $suku_tahun_akhir, $file_type = 'pdf']) }}" class="btn btn-danger">PDF</a>
                    <a href="{{ route('laporan_shuttle_4_14.excel', ['14', $tahun, $suku_tahun, $suku_tahun_akhir, $file_type = 'print']) }}" class="btn btn-warning">Print</a>
                </div>
