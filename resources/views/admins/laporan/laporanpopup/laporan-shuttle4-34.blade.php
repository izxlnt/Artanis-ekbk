        ...
        <div class="page-breadcrumb" style="padding: 0px">
            <div class="pb-2 row">
                <div class="col-5 align-self-center">
                    ...
                    <a href="{{ route('laporan_shuttle_4_34.excel', ['34', 'shuttle4', $tahun_mula, $tahun_akhir, ($file_type = 'excel')]) }}"
                        class="btn btn-success">Excel</a>
                    <a href="{{ route('laporan_shuttle_4_34.excel', ['34', 'shuttle4', $tahun_mula, $tahun_akhir, ($file_type = 'pdf')]) }}"
                        class="btn btn-danger">PDF</a> <a
                        href="{{ route('laporan_shuttle_4_34.excel', ['34', 'shuttle4', $tahun_mula, $tahun_akhir, ($file_type = 'print')]) }}"
                            ...
                            <table id="example" class="table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($datas as $negeri => $data)
                                        ...
                                        <tr class="text-center">
                                            ...
                                            @foreach ($data as $result)
                                                ...
                                                @endphp
                                            @endforeach
                                            {{-- <td class="text-right">{{ number_format($jumlah_row_nipis) }}</td> --}}
                                        </tr>
                                    ...
                                    <tr class="text-center" style="background-color: lightgray; font-weight: bold;">
                                        ...
                                        @endforeach
                                        {{-- <td class="text-right">{{ number_format($total_jumlah_row_nipis, 0) }}</td> --}}
                                    </tr>
                                    <tr class="text-center" style="background-color: lightgray; font-weight: bold;">
                                        <td></td>
                                        <td class="text-left"></td>
                                        ...
                                        @foreach ($grandtotal->jumlahpengeluaran['tebal'] as $data)
                                            ...
                                            @endif
                                        @endforeach
                                        {{-- <td class="text-right">{{ number_format($total_jumlah_row_tebal, 0) }}</td> --}}
                                    </tr>
