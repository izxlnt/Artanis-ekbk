        ...
        <div class="page-breadcrumb" style="padding: 0px">
            <div class="pb-2 row">
                <div class="col-5 align-self-center">
                    ...
                    <a href="{{ route('laporan_shuttle_3_41.excel', ['41', $tahun, ($file_type = 'excel')]) }}"
                        class="btn btn-success">Excel</a>
                    <a href="{{ route('laporan_shuttle_3_41.excel', ['41', $tahun, ($file_type = 'pdf')]) }}"
                        class="btn btn-danger">PDF</a> <a
                        href="{{ route('laporan_shuttle_3_41.excel', ['41', $tahun, ($file_type = 'print')]) }}"
                                            ...
                                            <td>
                                                @foreach ($datas as $data)
                                                    @if ($data[0]->bulan == $month_counter)
                                                        ...
                                                        @php
                                                            $jumlah_jualan_keseluruhan += round($data[0]->domestik);
                                                        @endphp
                                                    @endif
                                                @endforeach
                                            </td>
