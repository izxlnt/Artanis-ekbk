        ...
        <div class="page-breadcrumb" style="padding: 0px">
            <div class="pb-2 row">
                <div class="col-5 align-self-center">
                    ...
                    <a href="{{ route('laporan_shuttle_3_34.excel', ['34', $tahun, $file_type = 'excel']) }}" class="btn btn-success">Excel</a>
                    <a href="{{ route('laporan_shuttle_3_34.excel', ['34', $tahun, $file_type = 'pdf']) }}" class="btn btn-danger">PDF</a>
                    <a href="{{ route('laporan_shuttle_3_34.excel', ['34', $tahun, $file_type = 'print']) }}" class="btn btn-warning">Print</a>
                </div>
                                                    ...
                                                    @if ($species)
                                                        <tr>
                                                            ...
                                                            @forelse ($species as $bulan => $get_data)
                                                                <td class="text-right">
                                                                    {{ number_format($get_data[0]->jumlah_pengeluaran ?? 0, 0) }}

                                                                </td>
                                                                @php
                                                                    $jumlah_row += $get_data[0]->jumlah_pengeluaran ?? 0;

                                                                    $jumlah[$bulan] += $get_data[0]->jumlah_pengeluaran ?? 0;
                                                                    $jumlah_kumpulan += $get_data[0]->jumlah_pengeluaran ?? 0;

                                                                    $keseluruhan[$bulan] += $get_data[0]->jumlah_pengeluaran ?? 0;
                                                                    $keseluruhan_kumpulan += $get_data[0]->jumlah_pengeluaran ?? 0;
                                                                @endphp
                                                            @empty
                                                                0
                                                            @endforelse
