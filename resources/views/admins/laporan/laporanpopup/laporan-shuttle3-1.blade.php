        ...
        <div class="page-breadcrumb" style="padding: 0px">
            <div class="pb-2 row">
                <div class="col-5 align-self-center">
                    ...
                    <a href="{{ route('laporan_shuttle_3_1.excel', ['1', $tahun, $file_type = 'excel']) }}" class="btn btn-success">Excel</a>
                    <a href="{{ route('laporan_shuttle_3_1.excel', ['1', $tahun, $file_type = 'pdf']) }}" class="btn btn-danger">PDF</a>
                    <a href="{{ route('laporan_shuttle_3_1.excel', ['1', $tahun, $file_type = 'print']) }}" class="btn btn-warning">Print</a>
                    @elseif($title == "2. Senarai Pemilik Kilang Papan Bumiputera")
                    <a href="{{ route('laporan_shuttle_3_1.excel', ['2', $tahun, $file_type = 'excel']) }}" class="btn btn-success">Excel</a>
                    <a href="{{ route('laporan_shuttle_3_1.excel', ['2', $tahun, $file_type = 'pdf']) }}" class="btn btn-danger">PDF</a>
                    <a href="{{ route('laporan_shuttle_3_1.excel', ['2', $tahun, $file_type = 'print']) }}" class="btn btn-warning">Print</a>
                    @elseif($title == "3. Senarai Pemilik Kilang Papan Bukan Bumiputera")
                    <a href="{{ route('laporan_shuttle_3_1.excel', ['3', $tahun, $file_type = 'excel']) }}" class="btn btn-success">Excel</a>
                    <a href="{{ route('laporan_shuttle_3_1.excel', ['3', $tahun, $file_type = 'pdf']) }}" class="btn btn-danger">PDF</a>
                    <a href="{{ route('laporan_shuttle_3_1.excel', ['3', $tahun, $file_type = 'print']) }}" class="btn btn-warning">Print</a>
                    @elseif($title == "4. Senarai Pemilik Kilang Papan Bukan Warganegara")
                    <a href="{{ route('laporan_shuttle_3_1.excel', ['4', $tahun, $file_type = 'excel']) }}" class="btn btn-success">Excel</a>
                    <a href="{{ route('laporan_shuttle_3_1.excel', ['4', $tahun, $file_type = 'pdf']) }}" class="btn btn-danger">PDF</a>
                    <a href="{{ route('laporan_shuttle_3_1.excel', ['4', $tahun, $file_type = 'print']) }}" class="btn btn-warning">Print</a>
                    @endif
                            ...
                            <table id="example" class="table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td class="text-left">{{ $data->daerah_hutan_laporan ?? '' }}</td>
                                        ...
                                        <td class="text-right">{{ number_format($data->pekerja_wargabumi_lelaki_laporan, 0) }}</td>
                                        <td class="text-right">{{ number_format($data->pekerja_wargabumi_perempuan_laporan, 0) }}</td>
                                        <td class="text-right">{{ number_format($data->pekerja_bukan_wargabumi_lelaki_laporan, 0) }}</td>
                                        <td class="text-right">{{ number_format($data->pekerja_bukan_wargabumi_perempuan_laporan, 0) }}</td>
                                        <td class="text-right">{{ number_format($data->pekerja_asing_lelaki_laporan, 0) }}</td>
                                        <td class="text-right">{{ number_format($data->pekerja_asing_perempuan_laporan, 0) }}</td>

                                        <td class="text-right">{{ number_format($data->jumlah_penggunaan, 0) }}</td>
                                        <td class="text-right">{{ number_format($data->jumlah_pengeluaran, 0) }}</td>

                                        <td class="text-right">{{ number_format($data->export, 0) }}</td>
                                        <td class="text-right">{{ number_format($data->domestik, 0) }}</td>
                                    </tr>
                                    @endforeach --}}
