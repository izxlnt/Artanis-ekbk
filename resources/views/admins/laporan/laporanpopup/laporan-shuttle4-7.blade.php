        ...
        <div class="page-breadcrumb" style="padding: 0px">
            <div class="pb-2 row">
                <div class="col-5 align-self-center">
                    ...
                    @if($title == '7. Top 10 Kilang Papan Dalam Penggunaan Spesies Kayu Balak Di Kilang Papan Lapis/Venir')
                        <a href="{{ route('laporan_shuttle_4_7.excel', ['7', $tahun, ($file_type = 'excel'), ($spesies)]) }}"
                            class="btn btn-success">Excel</a>
                        <a href="{{ route('laporan_shuttle_4_7.excel', ['7', $tahun, ($file_type = 'pdf'), ($spesies)]) }}"
                            class="btn btn-danger">PDF</a>
                        <a href="{{ route('laporan_shuttle_4_7.excel', ['7', $tahun, ($file_type = 'print'), ($spesies)]) }}"
                                            ...
                                            <td class="text-right">
                                                @foreach ($datas_formc as $data)
                                                    @if ($data->shuttle_id == $kilang->shuttle->id)
                                                        {{ number_format(round($data->jumlah_penggunaan ?? 0, 2)) }}
                                                    @endif
                                                @endforeach
                                            </td>
