        ...
        <div class="page-breadcrumb" style="padding: 0px">
            <div class="pb-2 row">
                <div class="col-5 align-self-center">
                    ...
                    <a href="{{ route('laporan_shuttle_3_44.excel', ['44', $tahun, ($file_type = 'excel')]) }}"
                        class="btn btn-success">Excel</a>
                    <a href="{{ route('laporan_shuttle_3_44.excel', ['44', $tahun, ($file_type = 'pdf')]) }}"
                        class="btn btn-danger">PDF</a>
                    <a href="{{ route('laporan_shuttle_3_44.excel', ['44', $tahun, ($file_type = 'print')]) }}"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($datas as $keterangan_pembeli_key => $data)
                                        <tr class="text-right">
                                            ...
                                            @for ($i = 1; $i <= 12; $i++)
                                                <td>{{ number_format(round($data[$i][0]->jumlah_jualan ?? 0)) }}</td>
                                                @php
                                                    $total_jualan[$keterangan_pembeli_key] += round($data[$i][0]->jumlah_jualan ?? 0);
