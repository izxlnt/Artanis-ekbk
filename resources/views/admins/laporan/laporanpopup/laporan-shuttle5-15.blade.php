        ...
        <div class="page-breadcrumb" style="padding: 0px">
            <div class="pb-2 row">
                <div class="col-5 align-self-center">
                    ...
                    <a href="{{ route('laporan_shuttle_5_15.excel', ['15', $tahun, $suku_tahun, $suku_tahun_akhir, $file_type = 'excel']) }}" class="btn btn-success">Excel</a>
                    <a href="{{ route('laporan_shuttle_5_15.excel', ['15', $tahun, $suku_tahun, $suku_tahun_akhir, $file_type = 'pdf']) }}" class="btn btn-danger">PDF</a>
                    <a href="{{ route('laporan_shuttle_5_15.excel', ['15', $tahun, $suku_tahun, $suku_tahun_akhir, $file_type = 'print']) }}" class="btn btn-warning">Print</a>
                </div>
                                ...
                                <table id="example_{{ $key }}" class="text-center table-bordered"
                                    ...
                                    <thead style="background-color: #f3ce8f; font-weight: bold;">
                                        <tr>
                                            @foreach ($columns as $data)
                                                @if ($data == 'Bumiputera' || $data == 'Bukan Bumiputera' || $data == 'Bukan Warganegara' || $data == 'Jumlah Guna Tenaga' || $data == 'Pendapatan (RM)' || $data == 'Purata Pendapatan (RM)')
                                    ...
                                    @endforeach
                                        ...
                                        <tr class="text-right" style="background-color: lightgray; font-weight: bold;">
                                            ...
                                            <td>{{ number_format(round($jumlah_purata_lelaki = ($jumlah_gaji_lelaki / max($jumlah_jumlah_lelaki, 1)), 2)) }}</td>
                                            <td>{{ number_format(round($jumlah_purata_perempuan = ($jumlah_gaji_perempuan / max($jumlah_jumlah_perempuan, 1)), 2)) }}</td>
                                            <td>{{ number_format(round($jumlah_purata_keseluruhan = ($jumlah_pendapatan / max($jumlah_jumlah_jumlah, 1)), 2)) }}</td>
