        ...
        <div class="page-breadcrumb" style="padding: 0px">
            <div class="pb-2 row">
                <div class="col-5 align-self-center">
                    ...
                    <a href="{{ route('laporan_shuttle_4_36.excel', ['36', $tahun, ($file_type = 'excel')]) }}"
                        class="btn btn-success">Excel</a>
                    <a href="{{ route('laporan_shuttle_4_36.excel', ['36', $tahun, ($file_type = 'pdf')]) }}"
                        class="btn btn-danger">PDF</a> <a
                        href="{{ route('laporan_shuttle_4_36.excel', ['36', $tahun, ($file_type = 'print')]) }}"
                            ...
                            <table id="example" class="text-center table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-center" style="background-color: lightgray; font-weight: bold;">
                                        ...
                                        @for ($month_counter = 1; $month_counter <= 12; $month_counter++)
                                            <td class="text-right">{{ number_format($jumlah[$month_counter], 0) }}
                                            </td>
                                        @endfor
