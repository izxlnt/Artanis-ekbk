        ...
        <div class="page-breadcrumb" style="padding: 0px">
            <div class="pb-2 row">
                <div class="col-5 align-self-center">
                    ...
                    @if($title == '6. Top 10 Pengeluar Venir di Kilang Papan Lapis/Venir')
                        <a href="{{ route('laporan_shuttle_4_6.excel', ['6', $tahun, ($file_type = 'excel'), ($spesies = 'no_species')]) }}"
                            class="btn btn-success">Excel</a>
                        <a href="{{ route('laporan_shuttle_4_6.excel', ['6', $tahun, ($file_type = 'pdf'), ($spesies = 'no_species')]) }}"
                            class="btn btn-danger">PDF</a>
                        <a href="{{ route('laporan_shuttle_4_6.excel', ['6', $tahun, ($file_type = 'print'), ($spesies = 'no_species')]) }}"
