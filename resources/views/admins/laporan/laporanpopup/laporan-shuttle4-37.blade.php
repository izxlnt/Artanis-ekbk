        ...
        <div class="page-breadcrumb" style="padding: 0px">
            <div class="pb-2 row">
                <div class="col-5 align-self-center">
                    ...
                    <a href="{{ route('laporan_shuttle_4_37.excel', ['37', 'shuttle4', $tahun_mula, $tahun_akhir, ($file_type = 'excel')]) }}"
                        class="btn btn-success">Excel</a>
                    <a href="{{ route('laporan_shuttle_4_37.excel', ['37', 'shuttle4', $tahun_mula, $tahun_akhir, ($file_type = 'pdf')]) }}"
                        class="btn btn-danger">PDF</a> <a
                        href="{{ route('laporan_shuttle_4_37.excel', ['37', 'shuttle4', $tahun_mula, $tahun_akhir, ($file_type = 'print')]) }}"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($datas as $negeri => $data)
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td class="text-left">Muka/Face</td>
                                            @foreach ($data as $result)
                                                ...
                                                @endphp
                                            @endforeach
                                            {{-- <td class="text-right">{{ number_format($jumlah_row_muka) }}</td> --}}
                                        </tr>

                                        <tr class="text-center">
                                            <td></td>
                                            <td class="text-left"></td>
                                            <td class="text-left">Teras/Core</td>
                                            @foreach ($data as $result)
                                                <td class="text-right">
                                                ...
                                                @endphp
                                            @endforeach
                                            {{-- <td class="text-right">{{ number_format($jumlah_row_teras) }}</td> --}}
                                        </tr>
                                    @endforeach
                                    ...
                                    <tr class="text-center" style="background-color: lightgray; font-weight: bold;">
                                        ...
                                        @endforeach
                                        {{-- <td class="text-right">{{ number_format($total_jumlah_row_muka, 0) }}</td> --}}
                                    </tr>
                                    <tr class="text-center" style="background-color: lightgray; font-weight: bold;">
                                        <td></td>
                                        <td class="text-left"></td>
                                        ...
                                        @foreach ($grandtotal->jumlahpengeluaran['teras'] as $data)
                                            ...
                                            @endif
                                        @endforeach
                                        {{-- <td class="text-right">{{ number_format($total_jumlah_row_teras, 0) }}</td> --}}
                                    </tr>
