        ...
        <div class="page-breadcrumb" style="padding: 0px">
            <div class="pb-2 row">
                <div class="col-5 align-self-center">
                    ...
                    <a href="{{ route('laporan_shuttle_4_42.excel', ['42', $tahun, ($file_type = 'excel')]) }}"
                        class="btn btn-success">Excel</a>
                    <a href="{{ route('laporan_shuttle_4_42.excel', ['42', $tahun, ($file_type = 'pdf')]) }}"
                        class="btn btn-danger">PDF</a> <a
                        href="{{ route('laporan_shuttle_4_42.excel', ['42', $tahun, ($file_type = 'print')]) }}"
