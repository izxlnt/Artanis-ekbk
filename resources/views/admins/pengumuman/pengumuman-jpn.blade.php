        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                        ...
                        <table id="example" class="display" style="width:100%;text-align:center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <form action="{{ route('jpn.pengumuman-delete-jpn',$data->id) }}" method="post">
                                        @csrf
                                        <td>
                                            <a href="{{ route('jpn.pengumuman-kemaskini-jpn', $data->id) }}"
                    ...
                    <a href="{{ route('jpn.pengumuman-tambah-jpn') }}" class="btn btn-primary">Tambah</a>
