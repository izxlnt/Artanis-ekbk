            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <br>
                        <form action="{{ route('pengumuman-edit-ipjpsm',$pengumuman->id) }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select class="form-control" id="negeri_id" name="negeri"
                                                            ...
                                                            @foreach (App\Models\Daerah::distinct()->orderby('negeri')->get('negeri') as $data)
                                                                @if($pengumuman->negeri == $data->negeri)
                                                                <option value="{{ $data->negeri }}" {{ $data->negeri == $pengumuman->negeri ? 'selected' : '' }}>{{ $data->negeri }}</option>
                                                                @else
                                                                <option value="{{ $data->negeri }}">{{ $data->negeri }}</option>
                                                                @endif
                                                            @endforeach
                                                        </select>
                                                        @error('negeri')
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered"
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <span class="text-center"><b>Adakah anda pasti ingin menambah maklumat ini?</b></span>
                                                                </div>
