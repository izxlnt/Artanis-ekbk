        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                        ...
                        <table id="example" class="display" style="width:100%;text-align:center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $data->negeri }}</td>
                                    <form action="{{ route('pengumuman-delete-ipjpsm',$data->id) }}" method="post">
                                        @csrf
                                        <td>
                                            <a href="{{ route('pengumuman-kemaskini-ipjpsm', $data->id) }}"
                                                class="mr-1 btn btn-success"><i class="fas fa-pencil-alt"></i>
                                            </a>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body" style="text-align: left">
                                                            <span class="text-left"><b>Adakah anda pasti ingin menghapuskan
                                                                maklumat ini?</span>
                                                        </div>
                    ...
                    <a href="{{ route('pengumuman-tambah-ipjpsm') }}" class="btn btn-primary">Tambah</a>
