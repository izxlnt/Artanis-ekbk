  ...
  <div class="row">
      ...
      <div class="col-12">
        ...
        <div class="page-breadcrumb" style="padding: 0px">
          ...
          <div class="card">
            <form method="POST" enctype="multipart/form-data" action="{{ route('sahkan_permohonan_phd_ipjpsm',$user->id) }}">
            @csrf
              ...
              <div class="border card-body border-dark">
                  ...
                  <div class="row" style="padding-top: 15px;">
                    ...
                    <div class="col-md" style="text-align: center;">
                      <button type="button" class="btn btn-success" data-toggle="modal" data-target="#confirmation">Sahkan</button>
                    </div>
                    <div class="col-md-2"></div>
                  </div>
