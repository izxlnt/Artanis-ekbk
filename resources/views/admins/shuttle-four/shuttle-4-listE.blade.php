...
@section('content')
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <a type="button " href="{{ route('shuttle-4-listA', $year) }}"
                                            class="btn"
                                            style="background-color:white;color:black;border-color:black">Borang 4A</a>
                                        <a type="button" href="{{ route('shuttle-4-listB', $year) }}"
                                            class="btn"
                                            style="background-color:white;color:black;border-color:#ee8dcd">Borang 4B</a>
                                        <a type="button" href="{{ route('shuttle-4-listC', $year) }}"
                                            class="btn"
                                            style="background-color:white;color:black;border-color:#bbb235f3">Borang 4C</a>
                                        <a type="button" href="{{ route('shuttle-4-listD', $year) }}"
                                            class="btn"
                                            style="background-color:white;color:black;border-color:rgb(33, 235, 77)">Borang
                                            4D</a>

                                        <a type="button" href="{{ route('shuttle-4-listE', $year) }}"
                                            class="btn"
                                            style="background-color:#58afe9f3;color:black;border-color:#1145f0f3">Borang
                                            4E</a>
                            ...
                            <div class="pt-5 row">
                                <div class="col-md-12">
                                    <h4> BORANG 4E - PENYATA PENJUALAN PAPAN LAPIS/VENIR <br> DALAM PASARAN TEMPATAN DAN
                                        EKSPORT
                                                ...
                                                <td>
                                                    @foreach ($form4E as $data)
                                                        ...
                                                        @if ($shuttle->id == $data->shuttle_id)
                                                            ...
                                                            @if ($data->status == 'Tidak Diisi' && $data->bulan == '1' && $shuttle->id == $data->id)
                                                            ...
                                                            @elseif($data->status =="Dihantar ke IPJPSM" &&
                                                                ...
                                                                $data->shuttle_id)
                                                                <a href="{{ route('ipjpsm.shuttle-4-view-formE', $data->shuttle_id) }}"
                                        ...
                                        <td>
                                            @foreach ($form4E as $data)
                                                ...
                                                @if ($shuttle->id == $data->shuttle_id)
                                                    ...
                                                    @if ($data->status == 'Tidak Diisi' && $data->bulan == '2' && $shuttle->id == $data->id)
                                        ...
                                        <td>
                                            @foreach ($form4E as $data)
                                                ...
                                                @if ($shuttle->id == $data->shuttle_id)
                                                    ...
                                                    @if ($data->status == 'Tidak Diisi' && $data->bulan == '3' && $shuttle->id == $data->id)
                                        ...
                                        <td>
                                            @foreach ($form4E as $data)
                                                ...
                                                @if ($shuttle->id == $data->shuttle_id)
                                                    ...
                                                    @if ($data->status == 'Tidak Diisi' && $data->bulan == '4' && $shuttle->id == $data->id)
                                        ...
                                        <td>
                                            @foreach ($form4E as $data)
                                                ...
                                                @if ($shuttle->id == $data->shuttle_id)
                                                    ...
                                                    @if ($data->status == 'Tidak Diisi' && $data->bulan == '5' && $shuttle->id == $data->id)
                                        ...
                                        <td>
                                            @foreach ($form4E as $data)
                                                @if ($shuttle->id == $data->shuttle_id)
                                                    ...
                                                    @if ($data->status == 'Tidak Diisi' && $data->bulan == '6' && $shuttle->id == $data->id)
                                        ...
                                        <td>
                                            @foreach ($form4E as $data)
                                                @if ($shuttle->id == $data->shuttle_id)
                                                    ...
                                                    @if ($data->status == 'Tidak Diisi' && $data->bulan == '7' && $shuttle->id == $data->id)
                                        ...
                                        <td>
                                            @foreach ($form4E as $data)
                                                @if ($shuttle->id == $data->shuttle_id)
                                                    ...
                                                    @if ($data->status == 'Tidak Diisi' && $data->bulan == '8' && $shuttle->id == $data->id)
                                        ...
                                        <td>
                                            @foreach ($form4E as $data)
                                                @if ($shuttle->id == $data->shuttle_id)
                                                    ...
                                                    @if ($data->status == 'Tidak Diisi' && $data->bulan == '9' && $shuttle->id == $data->id)
                                                    ...
                                                    @elseif($data->status =="Tiada Pengeluaran" && $data->bulan
                                                        ...
                                                        <a href="{{ route('phd.shuttle-3-view-form4E', $data->id) }}"
                                                            class="btn btn-primary"><i class="fas fa-eye"
                                                                style="color: white; font-size: 18pt;" data-toggle="tooltip"
                                                                data-placement="bottom"
                                                                title="Borang perlu disahkan"></i></a>
                                        ...
                                        <td>
                                            @foreach ($form4E as $data)
                                                @if ($shuttle->id == $data->shuttle_id)
                                                    ...
                                                    @if ($data->status == 'Tidak Diisi' && $data->bulan == '10' && ($shuttle->id = $data->id))
                                        ...
                                        <td>
                                            @foreach ($form4E as $data)
                                                ...
                                                @if ($shuttle->id == $data->shuttle_id)
                                                    ...
                                                    @if ($data->status == 'Tidak Diisi' && $data->bulan == '11' && $shuttle->id == $data->id)
                                        ...
                                        <td>
                                            @foreach ($form4E as $data)
                                                @if ($shuttle->id == $data->shuttle_id)
                                                    ...
                                                    @if ($data->status == 'Tidak Diisi' && $data->bulan == '12' && $shuttle->id == $data->id)
    ...
    <script>
        function changePage() {
            ...
            window.location.href = "<?php echo URL::to('/admin/shuttle-4-listE/" + year +"'); ?>";
        }
    </script>
