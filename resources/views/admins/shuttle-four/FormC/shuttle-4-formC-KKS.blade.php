                            ...
                            <div class="tab-pane active" id="hotel" role="tabpanel" aria-labelledby="hotel-tab">
                                ...
                                <table class="table table-striped table-bordered ex3" id="">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="card">
                                                <form class="form-horizontal" action='{{ route('user.view.shuttle-4-formC.KKS.store', ['bulan' => $bulan_id, 'year' => $year]) }}' onsubmit="return checkValidationuSubmit()" method="POST" id="kkb">
                                                    @csrf
                                                    <div class="card-body">
