                            ...
                            <div class="tab-pane active" id="hotel" role="tabpanel" aria-labelledby="hotel-tab">
                                ...
                                <table class="table table-striped table-bordered ex3" id="">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="card">
                                                <form class="form-horizontal" action='{{ route('user.view.shuttle-4-formC.KayuLembut.store', ['bulan' => $bulan_id, 'year' => $year]) }}' onsubmit="return checkValidationuSubmit()" method="POST" id="kkb">
                                                    @csrf
                                                    <div class="card-body">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <div class="legend" style="border:2px solid;">
                                                                ...
                                                                <b>KKB/HHW</b>: Kayu Keras Berat / <i>Heavy Hardwood</i>
                                                                <br>
                                                                ...
                                                                <br>
                                                                <br>
                                                                <b style="color:red">Sila tekan butang CTRL+F untuk
                                                                    mencari jenis spesies kayu kayan</b>
                                                    ...
                                                    <div class="row" style="margin-bottom:-2%;">
                                                        ...
                                                        <div style="color: rgb(4, 0, 255)"> <b>HALAMAN 4/5</b>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <thead class="">
                                                                <tr style="height:50px;">
                                                                    <th style="text-align:center; width: 589px;"
                                                                        colspan="4">Kumpulan Kayu Kayan</th>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <span class="text-center"><b>
                                                        Adakah anda pasti untuk ke paparan seterusnya?</b>
                                                    </span>
                                                </div>
                                    ...
                                    <div class="modal fade" id="sebelumnya_borang_a" tabindex="-1" role="dialog"
                                        aria-labelledby="sebelumnya_borang_aTitle" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header" style="background-color:#f3ce8f  !important">
                                                    <h5 class="modal-title " id="exampleModalLongTitle"><i
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <span class="text-center"><b>Adakah anda pasti untuk ke paparan
                                                            sebelum ini?</b></span>

                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-danger"
                                                        wire:loading.attr="disabled" data-dismiss="modal">TIDAK</button>
                                    ...
                                    <div class="modal fade" id="tiada_pengeluaran" tabindex="-1" role="dialog"
                                        aria-labelledby="tiada_pengeluaranTitle" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header" style="background-color:#f3ce8f  !important">
                                                    <h5 class="modal-title " id="exampleModalLongTitle"><i
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <span class="text-center"><b>Adakah anda pasti kilang anda tiada
                                                            pengeluaran?</b></span>
