...
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="pt-5 row">
                                <div class="col-md-12">
                                    <h4> BORANG 4D - PENYATA PENGELUARAN DARIPADA JENTERA <BR>
                                        MEMPROSES PAPAN LAPIS/VENIR </h4>
                            ...
                            <div class="table-responsive">
                                <table id="example" class="display" style="width:100%">
                                    ...
                                    <tbody>
                                        @foreach ($form4D_kilang as $shuttle)
                                            <tr>
                                                <td>{{ $loop->index + 1 }}</td>
                                                    ...
                                                    @foreach ($form4D as $data)
                                                        ...
                                                        @if ($shuttle->id == $data->shuttle_id)
                                                            ...
                                                            @elseif($data->status =="Dihantar ke IPJPSM" &&
                                                                ...
                                                                $data->shuttle_id)
                                                                <a href="{{ route('ipjpsm.shuttle-4-view-formD', $data->shuttle_id) }}"
                                            ...
                                            @foreach ($form4D as $data)
                                                @if ($shuttle->id == $data->shuttle_id)
                                                    ...
                                                    @elseif($data->status =="Tiada Pengeluaran" && $data->bulan
                                                        ...
                                                        <a href="{{ route('phd.shuttle-3-view-form4D', $data->id) }}"
                                                            class="btn btn-primary"><i class="fas fa-eye"
                                                                style="color: white; font-size: 18pt;" data-toggle="tooltip"
                                                                data-placement="bottom"
                                                                title="Borang perlu disahkan"></i></a>
    ...
    <script>
        function changePage() {
            ...
            window.location.href = "<?php echo URL::to('/admin/shuttle-4-listD/" + year +"'); ?>";
        }
    </script>
