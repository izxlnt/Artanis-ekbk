                        ...
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <a type="button" href="{{ route('shuttle-4-listE', date('Y')) }}"
                                            class="btn"
                                            style="background-color:rgb(84, 175, 236);color:black;border-color:#1163a5f3">Borang
                                            4E</a>
                            ...
                            <div class="pt-5 row">
                                <div class="col-md-12">
                                    ...
                                    <h4 class="text-center"> PERAKUAN MAKLUMAT BORANG 4E- PENYATA PENJUALAN PAPAN
                                        LAPIS/VENIR DALAM PASARAN
