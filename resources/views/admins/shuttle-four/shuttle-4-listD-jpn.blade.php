...
@section('content')
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="example" class="text-center display" style="width:100%">
                                    ...
                                    <tbody>
                                        @foreach ($formD_kilang as $shuttle)
                                            <tr>
                                                <td>{{ $loop->index + 1 }}</td>
                                                        ...
                                                        @php
                                                            ...
                                                            if ($data->tahun == date('Y')) {
                                                                foreach ($batch as $checker) {
                                                                    if ($checker->tahun == $year && $checker->bulan == $data->bulan && $checker->shuttle_id == $data->shuttle_id) {
                                                            ...
                                                            @if ($data->tiada_pengeluaran == 1)
                                                                <a
                                                                    ...
                                                                    <img src="{{ asset('tpcoklat.png') }}" height='30px'
                                                                        alt="" data-toggle="tooltip" data-placement="bottom"
                                                                        title="Borang telah diperaku IPJPSM - Tiada Pengeluaran">
                                                                </a>
                                                            @else
                                                                <a
                                                                    href="{{ route('jpn.shuttle-4-view-form4D', $data->id) }}">
                            ...
                            <div class="row">
                                <a class="btn btn-primary" href="{{ route('home-jpn') }}"
    ...
    <script>
        function changePage() {
            ...
            window.location.href = "<?php echo URL::to('/jpn/shuttle-3-listD/" + year +"'); ?>";
        }
    </script>
