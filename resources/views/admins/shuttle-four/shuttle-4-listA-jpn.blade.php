...
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div>
                            ...
                            <h4 class="text-center">BORANG 4    A - MAKLUMAT KILANG PAPAN LAPIS/VENIR</h4>
                        </div>
                                    ...
                                    <tbody>
                                        @foreach ($formA as $data)
                                            <tr>
                                                ...
                                                <td>{{ $data->shuttle->daerah->daerah_hutan ?? $data->shuttle->daerah_id }}</td>
                                                <td>{{ $data->shuttle->no_ssm }}</td>
                                                <td>{{ $data->shuttle->no_lesen ?? 'Tiada' }}</td>

                                                <td>
                                                    @if ($data->status == 'Sedang Diproses')
                                                    <a href="{{ route('jpn.shuttle-3-view-formA',$data->id) }}" ><img src="{{ asset('circle_times_yellow.png') }}" height='30px' alt="" style="color: white; font-size: 20pt;"
    ...
    <script>
        function changePage() {
            ...
            window.location.href = "<?php echo URL::to('/jpn/shuttle-4-listA/" + year +"'); ?>";
        }
    </script>
