...
@section('content')
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="example" class="text-center display" style="width:100%">
                                ...
                                <tbody>
                                    @foreach ($formE_kilang as $shuttle)
                                        <tr>
                                            <td>{{ $loop->index + 1 }}</td>
                                            <td>{{ $shuttle->shuttle->nama_kilang }}</td>
                                            ...
                                            <td>
                                                @foreach ($formE as $data)
                                                    ...
                                                    @elseif($data->status == 'Tiada Pengeluaran' && $data->bulan == '1' && $shuttle->shuttle_id == $data->shuttle_id)
                                                        <a href="{{ route('phd.shuttle-4-view-formE', $data->id) }}"><img src="{{ asset('circle_times_yellow.png') }}" height='30px' alt="" data-toggle="tooltip" data-placement="bottom" title="Borang perlu disahkan PHD - Tiada Pengeluaran"></a>
                                                    @elseif($data->status == 'Sedang Diproses' && $data->bulan == '1' && $shuttle->shuttle_id == $data->shuttle_id)
                                                        <a href="{{ route('jpn.shuttle-4-view-form4E', $data->id) }}"><img
                                                    ...
                                                    @elseif($data->status == 'Tidak Lengkap' && $data->bulan == '1' && $shuttle->shuttle->id == $data->shuttle_id)
                                                        <img src="{{ asset('history.png') }}" height='30px' alt=""
                                                            style="color: #dbd400; font-size: 20pt;" data-toggle="tooltip"
                                                            data-placement="bottom" title="Borang tidak lengkap "></i>
                                                    @elseif($data->status == 'Dihantar ke IPJPSM' && $data->bulan == '1' && $shuttle->shuttle->id == $data->shuttle_id)
                                                        <a href="{{ route('jpn.shuttle-4-view-form4E', $data->id) }}">
                                                            ...
                                                            <a>
                                                            @elseif($data->status == 'Lulus' && $data->bulan == '1' && $shuttle->shuttle->id == $data->shuttle_id)
                                                ...
                                                @foreach ($formE as $data)
                                                    ...
                                                    @elseif($data->status == 'Sedang Diproses' && $data->bulan == '2' && $shuttle->shuttle_id == $data->shuttle_id)
                                                        ...
                                                        @elseif($data->status == 'Dihantar ke IPJPSM' && $data->bulan == '2' && $shuttle->shuttle->id == $data->shuttle_id)
                                                            <a
                                                                href="{{ route('jpn.shuttle-4-view-form4E', $data->id) }}">
                                                                ...
                                                                <img src="{{ asset('circle_check.png') }}" height='30px' alt=""
                                                                    ...
                                                                    title="Borang telah disahkan PHD"></i>
                                                                <a>
                                                                @elseif($data->status == 'Lulus' && $data->bulan == '2' && $shuttle->shuttle->id == $data->shuttle_id)
                                                    ...
                                                    @elseif($data->status == 'Dihantar ke IPJPSM' && $data->bulan == '3' && $shuttle->shuttle->id == $data->shuttle_id)
                                                        <a href="{{ route('jpn.shuttle-4-view-form4E', $data->id) }}">
                                                            ...
                                                            <img src="{{ asset('circle_check.png') }}" height='30px' alt=""
                                                                ...
                                                                title="Borang telah disahkan PHD"></i>
                                                            <a>
                                                            @elseif($data->status == 'Lulus' && $data->bulan == '3' && $shuttle->shuttle->id == $data->shuttle_id)
                                                                <img src="{{ asset('double_check.png') }}" height='30px'
                                                                    alt="" style="color: green; font-size: 20pt;"
                                                                    data-toggle="tooltip" data-placement="bottom"
                                                                    title="Borang telah diperaku"></i>
                                                    ...
                                                    @elseif($data->status == 'Dihantar ke IPJPSM' && $data->bulan == '4' && $shuttle->shuttle->id == $data->shuttle_id)
                                                        <a href="{{ route('jpn.shuttle-4-view-form4E', $data->id) }}">
                                                            ...
                                                            <img src="{{ asset('circle_check.png') }}" height='30px' alt=""
                                                                ...
                                                                title="Borang telah disahkan PHD"></i>
                                                            <a>
                                                            @elseif($data->status == 'Lulus' && $data->bulan == '4' && $shuttle->shuttle->id == $data->shuttle_id)
                                                                <img src="{{ asset('double_check.png') }}" height='30px'
                                                                    alt="" style="color: green; font-size: 20pt;"
                                                                    data-toggle="tooltip" data-placement="bottom"
                                                                    title="Borang telah diperaku"></i>
                                                    ...
                                                    @elseif($data->status == 'Dihantar ke IPJPSM' && $data->bulan == '5' && $shuttle->shuttle->id == $data->shuttle_id)
                                                        <a href="{{ route('jpn.shuttle-4-view-form4E', $data->id) }}">
                                                            ...
                                                            <img src="{{ asset('circle_check.png') }}" height='30px' alt=""
                                                                ...
                                                                title="Borang telah disahkan PHD"></i>
                                                            <a>
                                                            @elseif($data->status == 'Lulus' && $data->bulan == '5' && $shuttle->shuttle->id == $data->shuttle_id)
                                                                <img src="{{ asset('double_check.png') }}" height='30px'
                                                                    alt="" style="color: green; font-size: 20pt;"
                                                                    data-toggle="tooltip" data-placement="bottom"
                                                                    title="Borang telah diperaku"></i>
                                                    ...
                                                    @elseif($data->status == 'Dihantar ke IPJPSM' && $data->bulan == '6' && $shuttle->shuttle->id == $data->shuttle_id)
                                                        <a href="{{ route('jpn.shuttle-4-view-form4E', $data->id) }}">
                                                            ...
                                                            <img src="{{ asset('circle_check.png') }}" height='30px' alt=""
                                                                ...
                                                                title="Borang telah disahkan PHD"></i>
                                                            <a>
                                                            @elseif($data->status == 'Lulus' && $data->bulan == '6' && $shuttle->shuttle->id == $data->shuttle_id)
                                                                <img src="{{ asset('double_check.png') }}" height='30px'
                                                                    alt="" style="color: green; font-size: 20pt;"
                                                                    data-toggle="tooltip" data-placement="bottom"
                                                                    title="Borang telah diperaku"></i>
                                                    ...
                                                    @elseif($data->status == 'Dihantar ke IPJPSM' && $data->bulan == '7' && $shuttle->shuttle->id == $data->shuttle_id)
                                                        <a href="{{ route('jpn.shuttle-4-view-form4E', $data->id) }}">
                                                            ...
                                                            <img src="{{ asset('circle_check.png') }}" height='30px' alt=""
                                                                ...
                                                                title="Borang telah disahkan PHD"></i>
                                                            <a>
                                                            @elseif($data->status == 'Lulus' && $data->bulan == '7' && $shuttle->shuttle->id == $data->shuttle_id)
                                                                <img src="{{ asset('double_check.png') }}" height='30px'
                                                                    alt="" style="color: green; font-size: 20pt;"
                                                                    data-toggle="tooltip" data-placement="bottom"
                                                                    title="Borang telah diperaku"></i>
                                                    ...
                                                    @elseif($data->status == 'Dihantar ke IPJPSM' && $data->bulan == '8' && $shuttle->shuttle->id == $data->shuttle_id)
                                                        <a href="{{ route('jpn.shuttle-4-view-form4E', $data->id) }}">
                                                            ...
                                                            <img src="{{ asset('circle_check.png') }}" height='30px' alt=""
                                                                ...
                                                                title="Borang telah disahkan PHD"></i>
                                                            <a>
                                                            @elseif($data->status == 'Lulus' && $data->bulan == '8' && $shuttle->shuttle->id == $data->shuttle_id)
                                                                <img src="{{ asset('double_check.png') }}" height='30px'
                                                                    alt="" style="color: green; font-size: 20pt;"
                                                                    data-toggle="tooltip" data-placement="bottom"
                                                                    title="Borang telah diperaku"></i>
                                                    ...
                                                    @elseif($data->status == 'Dihantar ke IPJPSM' && $data->bulan == '9' && $shuttle->shuttle->id == $data->shuttle_id)
                                                        <a href="{{ route('jpn.shuttle-4-view-form4E', $data->id) }}">
                                                            ...
                                                            <img src="{{ asset('circle_check.png') }}" height='30px' alt=""
                                                                ...
                                                                title="Borang telah disahkan PHD"></i>
                                                            <a>
                                                            @elseif($data->status == 'Lulus' && $data->bulan == '9' && $shuttle->shuttle->id == $data->shuttle_id)
                                                                <img src="{{ asset('double_check.png') }}" height='30px'
                                                                    alt="" style="color: green; font-size: 20pt;"
                                                                    data-toggle="tooltip" data-placement="bottom"
                                                                    title="Borang telah diperaku"></i>
                                                    ...
                                                    @elseif($data->status == 'Dihantar ke IPJPSM' && $data->bulan == '10' && $shuttle->shuttle->id == $data->shuttle_id)
                                                        <a href="{{ route('jpn.shuttle-4-view-form4E', $data->id) }}">
                                                            ...
                                                            <img src="{{ asset('circle_check.png') }}" height='30px' alt=""
                                                                ...
                                                                title="Borang telah disahkan PHD"></i>
                                                            <a>
                                                            @elseif($data->status == 'Lulus' && $data->bulan == '10' && $shuttle->shuttle->id == $data->shuttle_id)
                                                                <img src="{{ asset('double_check.png') }}" height='30px'
                                                                    alt="" style="color: green; font-size: 20pt;"
                                                                    data-toggle="tooltip" data-placement="bottom"
                                                                    title="Borang telah diperaku"></i>
                                                    ...
                                                    @elseif($data->status == 'Dihantar ke IPJPSM' && $data->bulan == '11' && $shuttle->shuttle->id == $data->shuttle_id)
                                                        <a href="{{ route('jpn.shuttle-4-view-form4E', $data->id) }}">
                                                            ...
                                                            <img src="{{ asset('circle_check.png') }}" height='30px' alt=""
                                                                ...
                                                                title="Borang telah disahkan PHD"></i>
                                                            <a>
                                                            @elseif($data->status == 'Lulus' && $data->bulan == '11' && $shuttle->shuttle->id == $data->shuttle_id)
                                                                <img src="{{ asset('double_check.png') }}" height='30px'
                                                                    alt="" style="color: green; font-size: 20pt;"
                                                                    data-toggle="tooltip" data-placement="bottom"
                                                                    title="Borang telah diperaku"></i>
                                                    ...
                                                    @elseif($data->status == 'Dihantar ke IPJPSM' && $data->bulan == '12' && $shuttle->shuttle->id == $data->shuttle_id)
                                                        <a href="{{ route('jpn.shuttle-4-view-form4E', $data->id) }}">
                                                            ...
                                                            <img src="{{ asset('circle_check.png') }}" height='30px' alt=""
                                                                ...
                                                                title="Borang telah disahkan PHD"></i>
                                                            <a>
                                                            @elseif($data->status == 'Lulus' && $data->bulan == '12' && $shuttle->shuttle->id == $data->shuttle_id)
                                                                <img src="{{ asset('double_check.png') }}" height='30px'
                                                                    alt="" style="color: green; font-size: 20pt;"
                                                                    data-toggle="tooltip" data-placement="bottom"
                                                                    title="Borang telah diperaku"></i>
    ...
    <script>
        function changePage() {
            ...
            window.location.href = "<?php echo URL::to('/jpn/shuttle-4-listE/" + year +"'); ?>";
        }
    </script>
