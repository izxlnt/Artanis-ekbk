...
@section('content')
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('phd.shuttle-3-view-formA-phd', $data->id) }}">
                                                        <img src="{{ asset((!empty($data->tiada_pengeluaran) && $data->tiada_pengeluaran == 1) ? 'tpcoklat.png' : 'double_check.png') }}" height='30px' alt=""
                                                            ...
                                                            data-placement="bottom" title="{{ (!empty($data->tiada_pengeluaran) && $data->tiada_pengeluaran == 1) ? 'Borang telah diperaku IPJPSM - Tiada Pengeluaran' : 'Borang telah diperaku' }}">
                                                    </a>
                                                    @endif
                                                </td>
                                        @endforeach
    ...
    <script>
        function changePage() {
            ...
            window.location.href = "<?php echo URL::to('/phd/shuttle-4-listA/" + year +"'); ?>";
        }
    </script>
