                                            ...
                                            @if ($kilang)
                                                <section>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input readonly type="text" class="form-control" name='tahun'
                                                                placeholder="Tahun" value="{{ $kilang->tahun }}">
                                                            @error('tahun')
                                                            ...
                                                            <select disabled class="form-control" name='negeri_id'>
                                                                ...
                                                                @foreach (App\Models\Negeri::distinct()->get() as $data)
                                                                    ...
                                                                    @elseif($data->negeri == "PLS")
                                                                        <option value="{{ $data->id }}">Perlis</option>
                                                                    @endif
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <select disabled class="form-control" name='daerah_id'
                                                                placeholder="Daerah">
                                                                <option value="" selected hidden disabled>Sila Pilih Daerah
                                                                </option>
                                                                @foreach (App\Models\Negeri::distinct()->get() as $data)
                                                    ...
                                                    <div class="row">
                                                        <label for="fname"
                                                            ...
                                                            Kilang</label>
                                                        <div class="col-md-6">
                                                            <input readonly type="text" class="form-control" name='nama_kilang'
                                                                placeholder="Nama Kilang"
                                                    ...
                                                    <div class="row">
                                                        <label for="fname"
                                                            ...
                                                            Kilang</label>
                                                        <div class="col-md-6">
                                                            <input readonly type="text" class="form-control" name='alamat_kilang_1'
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input readonly type="text" class="form-control" name='alamat_kilang_2'
                                                                placeholder="Alamat Kilang"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input readonly type="text" class="form-control" name='no_ssm'
                                        ...
                                        <div class="col-md-12">
                                            <section>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input readonly type="text" class="form-control" name='no_telefon'
                                                            placeholder="No.Telefon" value="{{ $kilang->no_telefon }}">
                                                        @error('no_telefon')
                                                            <div class="alert alert-danger">
                                                                <strong>{{ $message }}</strong>
                                                            </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input readonly type="email" class="form-control" name='email_kilang'
                                                            placeholder="Emel" value="{{ $kilang->email_kilang }}">
                                                        @error('email_kilang')
                                                            <div class="alert alert-danger">
                                                                <strong>{{ $message }}</strong>
                                                            </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input readonly type="date" class="form-control" name="tarikh_tubuh"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input readonly type="date" class="form-control" name="tarikh_operasi"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input readonly type="text" class="form-control" name="status_hak_milik"
                                                ...
                                                <div class="row">
                                                    <label for="fname"
                                                        ...
                                                        Warganegara</label>
                                                    <div class="col-md-6">
                                                        <input readonly type="text" class="form-control" name="status_warganegara"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input readonly type="text" class="form-control" name='nilai_harta'
                                                            placeholder="Nilai Harta" value="{{ $kilang->nilai_harta }}">
                                                        @error('nilai_harta')
                                                            <div class="alert alert-danger">
                                                                <strong>{{ $message }}</strong>
                                                            </div>
                                                                ...
                                                                <div class="card">
                                                                    <div class="el-card-item">
                                                                        <div class="el-card-avatar el-overlay-1">
                                                                            @if(pathinfo(asset( $image_path = str_replace('public', 'storage',  $kilang ->sijil_ssm)), PATHINFO_EXTENSION) == "pdf")

                                                                                <div class="modal-body modal-dialog1" >
                                                                                <img id="" class="img-responsive" src="{{asset('/pdf.png')}}" alt="Lesen Kilang" class="imgthumbnail" ></img>
                                                                                </div>
                                                                                @else
                                                                                <div class="modal-body"  >
                                                                                <img id="" class="img-responsive" src="{{asset( $image_path = str_replace('public', 'storage',  $kilang ->sijil_ssm))}}" alt="Lesen Kilang" class="imgthumbnail" width="300px" height="300px"></img>
                                                                            </div>
                                                                            @endif
                                                        ...
                                                        <div class="row el-element-overlay" style="justify-content: center">
                                                            <div class="col-lg-6 col-md-6">
                                                                <div class="card">
                                                                    <div class="el-card-item">
                                                                        <div class="el-card-avatar el-overlay-1">
                                                                            @if(pathinfo(asset( $image_path = str_replace('public', 'storage',  $kilang ->lesen_kilang)), PATHINFO_EXTENSION) == "pdf")
                                                                                ...
                                                                                @else
                                                                                <div class="modal-body"  >
                                                                                <img id="" class="img-responsive" src="{{asset( $image_path = str_replace('public', 'storage',  $kilang ->lesen_kilang))}}" alt="Lesen Kilang" class="imgthumbnail" width="300px" height="300px"></img>
                                                                            </div>
                                                                            @endif
                                ...
                                <div id="navpills-3" class="tab-pane">
                                    <div class="row">
                                        <div class="col-md-12">
                                                            ...
                                                            <div class="card">
                                                                <div class="el-card-item">
                                                                    <div class="el-card-avatar el-overlay-1"> <img
                                                                            src="{{asset( $image_path = str_replace('public', 'storage',  $users ->gambar_ic_hadapan))}}" alt="ic hadapan" />
                                                                        <div class="el-overlay">
                                                                            <ul class="list-style-none el-info">
                                                                                <li class="el-item"><a
                                                                                        class="btn default btn-outline image-popup-vertical-fit el-link"
                                                    ...
                                                    <div class="row el-element-overlay" style="justify-content: center">
                                                        <div class="col-lg-6 col-md-6">
                                                            <div class="card">
                                                                <div class="el-card-item">
                                                                    <div class="el-card-avatar el-overlay-1"> <img
                                                                            src="{{asset( $image_path = str_replace('public', 'storage',  $users ->gambar_ic_belakang))}}" alt="ic belakang" />
                                                                        <div class="el-overlay">
                                                                            <ul class="list-style-none el-info">
                                                                                <li class="el-item"><a
                                                                                        class="btn default btn-outline image-popup-vertical-fit el-link"
                                                    ...
                                                    <div class="row el-element-overlay" style="justify-content: center">
                                                        <div class="col-lg-3 col-md-6">
                                                            <div class="card">
                                                                <div class="el-card-item">
                                                                    <div class="el-card-avatar el-overlay-1"> <img
                                                                            src="{{asset( $image_path = str_replace('public', 'storage',  $users ->gambar_passport))}}" alt="passport" />
                                                                        <div class="el-overlay">
                                                                            <ul class="list-style-none el-info">
                                                                                <li class="el-item"><a
                                                                                        class="btn default btn-outline image-popup-vertical-fit el-link"
                                            ...
                                            <div class="row">
                                                <label for="fname"
                                                    class="text-right col-sm-3 control-label col-form-label">No. Pekerja</label>
                                                <div class="col-md-6">
                                                    <input readonly type="text" class="form-control" name='jawatan'
                                                    ...
                                                    <div class="row el-element-overlay" style="justify-content: center">
                                                        <div class="col-lg-3 col-md-6">
                                                            <div class="card">
                                                                <div class="el-card-item">
                                                                    <div class="el-card-avatar el-overlay-1"> <img
                                                                            src="{{asset( $image_path = str_replace('public', 'storage',  $users ->gambar_kad_pekerja))}}" alt="kad pekerja" />
                                                                        <div class="el-overlay">
                                                                            <ul class="list-style-none el-info">
                                                                                <li class="el-item"><a
                                                                                        class="btn default btn-outline image-popup-vertical-fit el-link"
