            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body" style="width: 100%">
                        ...
                        <br><br>
                        <div><h3>Senarai IBK yang telah menghantar borang lengkap dan disahkan oleh PHD</h3></div>
                                ...
                                <tbody>
                                    @foreach ($shuttle as $data)
                                        <tr>
                                            ...
                                            <td> <a href="{{ route('ipjpsm.shuttle-3-view-formB',$data->id) }}" class="mr-1 btn btn-success"><i
