                    ...
                    <div class="card-body" style="width: 100%">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <a class="btn btn-secondary" href="{{ route('ipjpsm.status-permohonan-shuttle-4-kilang') }}">Shuttle 4</a>
                        ...
                        {{-- <div class="row">
                            <div class="col-md-12" style="text-align:left">
                                <a class="btn btn-secondary" href="{{ route('ipjpsm.status-permohonan-shuttle-5') }}">Pengguna Kilang</a>
                                <a class="btn btn-primary" href="{{ route('ipjpsm.status-permohonan-shuttle-5-kilang') }}">Kilang</a>
                            ...
                            <table id="example" class="display" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($user_check[$key] != 0)
                                            <a href="{{ route('ipjpsm.status-permohonan-shuttle-5',$data->shuttle_id) }}"  class="mr-1 btn btn-success" data-toggle="tooltip" data-placement="bottom" title="Sahkan Pengguna Kilang"><i
