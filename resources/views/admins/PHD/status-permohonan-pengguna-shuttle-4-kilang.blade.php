            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body" style="width: 100%">
                        <div class="row">
                            <div class="col-md-12">
                                <a class="btn btn-secondary" href="{{ route('ipjpsm.status-permohonan-shuttle-3-kilang') }}">Shuttle 3</a>
                                <a class="btn btn-primary" href="{{ route('ipjpsm.status-permohonan-shuttle-4-kilang') }}">Shuttle 4</a>
                                <a class="btn btn-secondary" href="{{ route('ipjpsm.status-permohonan-shuttle-5-kilang') }}">Shuttle 5</a>

                            </div>
                         </div>
                        <br><br>
                        <div><h2>PENYATA SHUTTLE 4: KILANG PAPAN LAPIS/VENIR</h2></div>

                        <div><h3>STATUS PERMOHONAN INDUSTRI BERASAS KAYU (IBK)</h3></div>
                        <br>
                        {{-- <div class="row">
                            <div class="col-md-12" style="text-align:left">
                                <a class="btn btn-secondary" href="{{ route('ipjpsm.status-permohonan-shuttle-4') }}">Pengguna Kilang</a>
                                <a class="btn btn-primary" href="{{ route('ipjpsm.status-permohonan-shuttle-4-kilang') }}">Kilang</a>
                            ...
                            <table id="example" class="display" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($user_check[$key] != 0)
                                            <a href="{{ route('ipjpsm.status-permohonan-shuttle-4',$data->shuttle_id) }}"  class="mr-1 btn btn-success" data-toggle="tooltip"
                                                data-placement="bottom"
                                                title="Sahkan pengguna kilang"><i
                                            class="fas fa-share"></i></a>
                                            @else
                                            <a href="#" class="mr-1 btn btn-secondary" data-toggle="tooltip" data-placement="bottom" title="Tiada pengguna kilang yang perlu disahkan"><i
                                                class="fas fa-share"></i></a>
                                            @endif
                                        </td>
                                        <td>
                                                @if($user_check[$key] != 0)
                                                <a href="#"  class="mr-1 btn btn-secondary" data-toggle="tooltip" data-placement="bottom" title="Pengguna kilang belum disahkan" disabled><i
                                                    class="far fa-eye"></i></a>
                                                @else
                                                <a href="{{ route('ipjpsm.lampiran-permohonan-pengguna',$data->id) }}"  class="mr-1 btn btn-success" data-toggle="tooltip"
                                                    data-placement="bottom"
                                                    title="Sahkan kilang"><i
                                                    class="far fa-eye"></i></a>
                                                @endif
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body" style="text-align: left">
                                                                ...
                                                                <span class="text-center"><b>Adakah anda pasti ingin memadam data pengguna ini?</span>
                                                            </div>
