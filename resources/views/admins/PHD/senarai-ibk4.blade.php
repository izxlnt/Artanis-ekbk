                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body" style="width: 100%">
                                    {{-- <div class="row">
                            <div class="col-md-12">
                                <a class="btn btn-secondary" href="{{ route('ipjpsm.senaraikilang3') }}">Shuttle 3</a>
                                <a class="btn btn-primary" href="{{ route('ipjpsm.senaraikilang4') }}">Shuttle 4</a>
                                <a class="btn btn-secondary" href="{{ route('ipjpsm.senaraikilang5') }}">Shuttle 5</a>
                            ...
                            <div class="col-md-12" style="text-align:left">
                                <a class="btn btn-primary" href="{{ route('ipjpsm.senaraiibk4') }}">Pengguna Kilang</a>
                                <a class="btn btn-secondary" href="{{ route('ipjpsm.senaraikilang4') }}">Kilang</a>
                                                    ...
                                                    <div class="modal fade" id="edit{{ $data->id }}" tabindex="-1"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <form
                                                                    action="{{ route('ipjpsm.emelpengguna', $data->id) }}"
                                                                    method="post">
                                                                    @csrf
                                    ...
                                    <div class="row">
                                        <a class="btn btn-primary" href="{{ route('ipjpsm.senaraikilang4') }}"
