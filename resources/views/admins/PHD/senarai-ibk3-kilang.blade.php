                                                                    ...
                                                                    <form action="{{ route('ipjpsm.jana-kata-laluan', $data->id) }}"
                                                                        ...
                                                                        <div class="modal-body" style="text-align:left">
                                                                            <span class="text-center"><b>Adakah anda pasti
                                                                                    ...
                                                                                    sedia ada akan digantikan dan dihantar
                                                                                    ke emel kilang ({{ $data->email }}).</b></span>
                                                                        </div>
                                                        ...
                                                        <div class="modal fade" id="edit{{ $data->id }}" tabindex="-1"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form
                                                                        action="{{ route('ipjpsm.emelkilang', $data->id) }}"
                                                                        method="post">
                                                                        @csrf
                                                        ...
                                                        <div class="modal fade"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body" style="text-align: left">
                                                                        <span class="text-center"><b>Adakah anda pasti
                                                                                ingin menyahaktifkan pengguna?</b></span>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-danger"
                                                                            data-dismiss="modal">Batal</button>
                                                        ...
                                                        <div class="modal fade"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body" style="text-align: left">
                                                                        <span class="text-center"><b>Adakah anda pasti
                                                                                ingin mengaktifkan pengguna?</b></span>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-danger"
                                                                            data-dismiss="modal">Batal</button>
