                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <a class="btn btn-secondary"
                                                href="{{ route('ipjpsm.senaraikilang3') }}">Shuttle 3</a>
                                            <a class="btn btn-primary" href="{{ route('ipjpsm.senaraikilang4') }}">Shuttle
                                                4</a>
                                            <a class="btn btn-secondary"
                                                href="{{ route('ipjpsm.senaraikilang5') }}">Shuttle 5</a>
                                                ...
                                                @foreach ($users as $data)
                                                    @if ($data->kategori_pengguna == 'IBK')
                                                        <tr>
                                                            ...
                                                            @endif
                                                            <td><a
                                                                    href="{{ route('ipjpsm.senaraiibk4', $data->shuttle_id) }}"><img
                                                                ...
                                                                <form action="{{ route('ipjpsm.jana-kata-laluan', $data->id) }}"
                                                                    ...
                                                                    <div class="modal-body" style="text-align:left">
                                                                        <span class="text-center"><b>Adakah anda pasti
                                                                                ...
                                                                                akaun pemilik kilang ini? Kata laluan
                                                                                sedia ada akan digantikan dan dihantar ke
                                                                                emel kilang ({{ $data->email }}).</b></span>
                                                                    </div>
