            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body" style="width: 100%">
                        ...
                        <br><br>
                        <div><h2>PENYATA SHUTTLE 3: KILANG PAPAN</h2></div>
                        <div><h3>STATUS PERMOHONAN INDUSTRI BERASAS KAYU (IBK)</h3></div>
                        <br>
                        {{-- <div class="row">
                            <div class="col-md-12" style="text-align:left">
                                <a class="btn btn-primary" href="{{ route('ipjpsm.status-permohonan-shuttle-3-kilang') }}">Pengguna Kilang</a>
                                <a class="btn btn-secondary" href="{{ route('ipjpsm.status-permohonan-shuttle-3-kilang') }}">Kilang</a>
                            ...
                            <table id="example" class="display" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @endif
                                        <td> <a href="{{ route('ipjpsm.lampiran-permohonan-pengguna',$data->id) }}"  class="mr-1 btn btn-success" data-toggle="tooltip" data-placement="bottom" title="Sahkan pengguna kilang"><i
                        ...
                        <div class="row">
                            <a class="btn btn-primary" href="{{  route('ipjpsm.status-permohonan-shuttle-3-kilang')  }}" style="color:white">Kembali</a>
