...
@section('content')
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <h4 class="text-center">BORANG 4D - PENYATA PENGELUARAN DARIPADA JENTERA MEMPROSES PAPAN LAPIS/VENIR</h4>
                            </div>
                            <div class="">
    ...
    <script>
        function changePage() {
            ...
            window.location.href = "<?php echo URL::to('/phd/senarai-tugasan-4D/" + year +"'); ?>";
        }
    </script>
