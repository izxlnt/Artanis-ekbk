                    ...
                    <div class="card-body" style="width: 100%">
                        {{-- <div class="row">
                            <div class="col-md-12">
                                ...
                                <a class="btn btn-secondary" href="{{ route('ipjpsm.status-permohonan-phd') }}">PHD</a>
                                <a class="btn btn-primary" href="{{ route('ipjpsm.status-permohonan-jpn') }}">JPN</a>
                            </div>
                         </div> --}}

                        <div><h4>STATUS PERMOHONAN JABATAN PERHUTANAN NEGERI (JPN)</h4></div>
                        <div class="table-responsive">
                            <table id="example" class="display" style="width:100%">
                                <thead style="background-color:#3edf29">
                                    <tr>
                                        <th>Bil</th>
                                        <th>Nama Penuh</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @endif
                                        <td> <a href="{{ route('ipjpsm.lampiran-permohonan-jpn',$data->id) }}"  class="mr-1 btn btn-success" data-toggle="tooltip"
