...
@section('content')
    ...
    <div>
        ...
        <link rel="stylesheet" href="{{ asset('nice-admin/assets/libs/sweetalert2/dist/sweetalert2.min.css') }}">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body" style="width: 100%">
                            ...
                            @if (!$users)
                                <form action='{{ route('sahkan_permohonan_kilang_ipjpsm', $kilang->id) }}' method='post'>
                                    @csrf
                                    <div class="tab-content br-n pn">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <section>
                                                        ...
                                                        <div class="row">
                                                            <label for="fname"
                                                                class="text-right col-sm-3 control-label col-form-label"
                                                                class="required">Pilihan
                                                                Kilang</label>
                                                            <div class="col-md-6">
                                                                @if ($kilang->shuttle_type == '3')
                                                                    <input readonly type="text" class="form-control"
                                                                        name='jawatan' placeholder="Nama Pengguna"
                                                                        value="Kilang Papan">
                                                                @elseif($kilang->shuttle_type == '4')
                                                                    <input readonly type="text" class="form-control"
                                                                        name='jawatan' placeholder="Nama Pengguna"
                                                                        value="Kilang Papan Lapis/Venir">
                                                                @elseif($kilang->shuttle_type == '5')
                                                                    <input readonly type="text" class="form-control"
                                                                        name='jawatan' placeholder="Nama Pengguna"
                                                                        value="Kilang Kayu Kumai">
                                                                @endif
                                                                @error('shuttle_type')
                                                                    <div class="alert alert-danger">
                                                                        <strong>{{ $message }}</strong>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input readonly type="text" class="form-control"
                                                                        ...
                                                                        value="{{ $kilang->alamat_kilang_poskod }}">
                                                                    @error('nama_kilang')
                                                                        <div class="alert alert-danger">
                                                                            <strong>{{ $message }}</strong>
                                                                        </div>
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label for="wphoneNumber2">Daerah Sivil</label>
                                                                    <input readonly type="text" class="form-control"
                                                                        name="alamat_kilang_daerah"
                                                                        value="{{ $kilang->alamat_kilang_daerah }}">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input readonly type="text" class="form-control"
                                                                        ...
                                                                        value="{{ $kilang->alamat_surat_menyurat_poskod }}">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input readonly type="text" class="form-control"
                                                                        ...
                                                                        value="{{ $kilang->alamat_surat_menyurat_daerah }}">
                                        ...
                                        <div id="navpills-2" class="tab-pane">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <section>
                                                        <h4 class="card-title" style="text-align: center">BAHAGIAN B
                                                        </h4>
                                                        <div class="row">
                                                            <label for="fname"
                                                                class="text-right col-sm-3 control-label col-form-label">No.
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input readonly type="text" class="form-control"
                                                                    name='no_faks' placeholder="No.Faks"
                                                                    value="{{ $kilang->no_faks }}">
                                                                @error('no_faks')
                                                                    <div class="alert alert-danger">
                                                                        <strong>{{ $message }}</strong>
                                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input readonly type="text" class="form-control"
                                                                    name='website' placeholder="Laman Sesawang (Website)"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input readonly type="text" class="form-control"
                                                                    ...
                                                                    value="{{ number_format($kilang->nilai_harta, 2) }}">
                                                                @error('nilai_harta')
                                                                    <div class="alert alert-danger">
                                                                        <strong>{{ $message }}</strong>
                                                                    </div>
                            ...
                            <div class="el-overlay">
                                <ul class="list-style-none el-info">
                                    ...
                                    <li class="el-item"><a target="_blank"
                    ...
                    <a download="Sijil SSM"" rel="noopener noreferrer" href="{{ asset($image_path = str_replace('public', 'storage', $kilang->sijil_ssm)) }}"> Muat Turun Fail</a>
                ...
                <div class="card">
                    <div class="el-card-item">
                        <div class="el-card-avatar el-overlay-1">
                            ...
                            <div class="modal-body modal-dialog1">
                                <img id="" class="img-responsive" src="{{ asset('/pdf.png') }}" alt="Lesen Kilang"
                                    class="imgthumbnail"></img>
                            </div>
                        @else
                            <div class="modal-body">
                                <img id="" class="img-responsive"
                                    ...
                                    alt="Lesen Kilang" class="imgthumbnail" width="300px" height="300px"></img>
                            </div>
                            @endif
                    ...
                    <a download="Lesen Kilang"" rel="noopener noreferrer" href="{{ asset($image_path = str_replace('public', 'storage', $kilang->lesen_kilang)) }}"> Muat Turun Fail</a>
    ...
    {{-- <button type="button" class="btn btn-danger"><i class="fas fa-times"></i>
        Batal</button> &nbsp --}}
    <button type="button" class="btn btn-success" alt="default" data-toggle="modal" data-target="#confirmation_borang_a"
        class="model_img img-fluid"><i class="fa fa-check"></i>
        Sahkan</button>
    </section>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" style="text-align: left">
                    <span class="text-center"><b>Adakah anda pasti ingin mengesahkan kilang ini?</b></span>
                </div>
...
@else
    {{-- tab 3 --}}
    <form action='{{ route('sahkan_permohonan_pengguna_ipjpsm', $users->id) }}' method='post'>
        @csrf
        <div id="navpills-3" class="tab-pane">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <label for="fname" class="text-right col-sm-3 control-label col-form-label">Nama
                            Kilang</label>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <label for="fname" class="text-right col-sm-3 control-label col-form-label">Jantina</label>
                        <div class="col-md-6">
                            <input readonly type="text" class="form-control" name='jantina' placeholder="Nama Pengguna"
                                value="{{ $users->jantina }}">

                        </div>
                    </div> <br>
                    <div class="row">
                        <label for="fname" class="text-right col-sm-3 control-label col-form-label">Warganegara</label>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <label for="fname" class="text-right col-sm-3 control-label col-form-label">Kaum</label>
                        <div class="col-md-6">
                            <input readonly type="text" class="form-control" name='kaum' placeholder="Nama Pengguna"
                                value="{{ $users->kaum }}">
                    ...
                    <div class="row">
                        <label for="fname" class="text-right col-sm-3 control-label col-form-label">Emel</label>
                        <div class="col-md-6">
                            <input readonly type="text" class="form-control" name='kaum' placeholder="Nama Pengguna"
                                value="{{ $users->email }}">
                    ...
                    <div class="row">
                        <label for="fname" class="text-right col-sm-3 control-label col-form-label">No. Kad
                            Pengenalan</label>
                        <div class="col-md-6">
                            <input readonly type="text" class="form-control" name='no_kad_pengenalan'
                                placeholder="Nama Pengguna" value="{{ $users->no_kad_pengenalan }}">
                                ...
                                <div class="row el-element-overlay" style="justify-content: center">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="card">
                                            ...
                                            <a download="Gambar Hadapan Kad Pengenalan"" rel="noopener noreferrer" href="{{ asset($image_path = str_replace('public', 'storage', $users->gambar_ic_hadapan)) }}"> Muat Turun Fail</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row el-element-overlay" style="justify-content: center">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="card">
                                            ...
                                            <a download="Gambar Belakang Kad Pengenalan"" rel="noopener noreferrer" href="{{ asset($image_path = str_replace('public', 'storage', $users->gambar_ic_belakang)) }}"> Muat Turun Fail</a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    @if ($users->gambar_passport)
                        <div class="row">
                            <div class="col-md-3"></div>
                            <div class="col-md-6">
                                <label for="wphoneNumber2">Gambar Berukuran Passport</label>
                                <div class="row el-element-overlay" style="justify-content: center">
                                    <div class="col-lg-3 col-md-6">
                                        <div class="card">
                                            <div class="el-card-item">
                                                ...
                                                <a download="Gambar Berukuran Passport"" rel="noopener noreferrer" href="{{ asset($image_path = str_replace('public', 'storage', $users->gambar_passport)) }}"> Muat Turun Fail</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    @endif
                    <div class="row">
                        <label for="fname" class="text-right col-sm-3 control-label col-form-label">Jawatan</label>
                        <div class="col-md-6">
                            <input readonly type="text" class="form-control" name='jawatan' placeholder="Nama Pengguna"
                                value="{{ $users->jawatan }}">
                    ...
                    <div class="row">
                        <label for="fname" class="text-right col-sm-3 control-label col-form-label">Pilihan
                            Kilang</label>
                        <div class="col-md-6">
                            {{-- <select type="text" class="form-control" name='shuttle_type' disabled>
                                <option value="3" {{ $users->shuttle_type == '3' ? 'selected' : '' }}>Kilang
                                    Papan</option>
                                <option value="4" {{ $users->shuttle_type == '4' ? 'selected' : '' }}>Kilang
                                    Papan Lapis/Venir</option>
                                <option value="5" {{ $users->shuttle_type == '5' ? 'selected' : '' }}>Kilang
                                    Kayu Kumai</option>
                            </select> --}}
                            @if ($users->shuttle_type == '3')
                                <input readonly type="text" class="form-control" name='jawatan'
                                    placeholder="Nama Pengguna" value="Kilang Papan">
                            @elseif($users->shuttle_type == '4')
                                <input readonly type="text" class="form-control" name='jawatan'
                                    placeholder="Nama Pengguna" value="Kilang Papan Lapis/Venir">
                            @elseif($users->shuttle_type == '5')
                                <input readonly type="text" class="form-control" name='jawatan'
                                    placeholder="Nama Pengguna" value="Kilang Kayu Kumai">
                            @endif
                            @error('shuttle_type')
                                <div class="alert alert-danger">
                                    <strong>{{ $message }}</strong>
                    ...
                    {{-- <button type="button" class="btn btn-danger"><i class="fas fa-times"></i>
                        Batal</button> &nbsp --}}
                    <button type="button" class="btn btn-success" alt="default" data-toggle="modal"
                        data-target="#confirmation_borang_a" class="model_img img-fluid"><i class="fa fa-check"
                            class="img-fluid model_img"></i>
                        Sahkan</button>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="confirmation_borang_a" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="text-align: left">
                        <span class="text-center"><b>Adakah anda pasti ingin mengesahkan pengguna ini?</b></span>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-dismiss="modal">Batal</button>
                        <button type="submit" class="btn btn-success">Sahkan</button>
