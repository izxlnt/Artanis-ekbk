                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body" style="width: 100%">
                                                            ...
                                                            <td>
                                                                <button class="mr-1 btn btn-warning" data-toggle="modal"
                                                                    data-target="#edit{{ $data->id }}"><i
                                                                        ...
                                                                        data-placement="bottom" title="Kemaskini Emel Pengguna"></i></button>
                                                                <button class="mr-1 btn btn-info" data-toggle="modal"
                                                                    data-target="#jana_password{{ $data->id }}"><i
                                                                        class="fas fa-key" data-toggle="tooltip"
                                                                        data-placement="bottom" title="Jana Kata Laluan Baharu"></i></button>
                                    ...
                                    <div class="row">
                                        <a class="btn btn-primary" href="{{ route('ipjpsm.senaraikilang3') }}"
