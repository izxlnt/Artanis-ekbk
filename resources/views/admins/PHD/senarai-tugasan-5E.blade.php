...
@section('content')
                                ...
                                <div class="col-md-2">
                                    <select name="select_year" id="select_year" class="form-control"
                                        ...
                                        @endforeach
                                                                ...
                                                                @include('partials.borang-nav', ['shuttle_type' => 5, 'current_form' => 'E', 'role' => 'phd'])
                            </div>
                            <br><br>
                            <div>
                            <h4 class="text-center">PENYATA SHUTTLE 5 - KILANG KAYU KUMAI</h4>

                                <h4 class="text-center">BORANG 5E - PENYATA PENJUALAN KAYU KUMAI DALAM PASARAN TEMPATAN DAN EKSPORT</h4>
                            </div>
                            <div class="">
                                <table id="example" class="display text-center" style="width:100%">
                                    <thead style="background-color:rgb(54, 140, 238);">
                                        <tr>
                                            <th>Bil</th>
                                            <th>Nama Kilang</th>
                                            <th>No. SSM</th>
                                            ...
                                            <tr @if($needsAction) style="background-color:#fff8e1; font-weight:600;" @endif>
                                                ...
                                                <td>
                                                    @php
                                                        ...
                                                        $packageSent = $current_batch && $current_batch->status == 'Dihantar ke IPJPSM' && $current_batch->borang_e == 2;
                                                    @endphp
                                                ...
                                                @elseif($data->status == 'Tidak Lengkap')
                                                    ...
                                                    <a href="{{ route('phd.shuttle-5-view-formE-phd', $data->id) }}">
                                                        <img src="{{ asset((!empty($data->tiada_pengeluaran) && $data->tiada_pengeluaran == 1) ? 'tpcoklat.png' : 'double_check.png') }}" height='30px'
                                                            data-toggle="tooltip" data-placement="bottom"
                                                            title="{{ (!empty($data->tiada_pengeluaran) && $data->tiada_pengeluaran == 1) ? 'Borang telah diperaku IPJPSM - Tiada Pengeluaran' : 'Borang telah diperaku' }}"></a>
                                                @endif
                                                </td>
    ...
    <script>
        function changePage() {
            ...
            window.location.href = "<?php echo URL::to('/phd/senarai-tugasan-5E/" + year +"'); ?>";
        }
    </script>
