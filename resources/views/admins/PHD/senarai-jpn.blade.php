                                        ...
                                        <div class="col-md-12" style="text-align:left">
                                            @if (auth()->user()->kategori_pengguna == 'BPE')
                                                ...
                                                <a class="btn btn-primary"
                                                    ...
                                                    (JPN)</a>
                                                <a class="btn btn-secondary"
                                                    href="{{ route('ipjpsm.senaraiipjpsm') }}">Ibu Pejabat Jabatan
                                            ...
                                            @elseif(auth()->user()->kategori_pengguna == 'BPM')
                                                ...
                                                <a class="btn btn-secondary"
                                                    ...
                                                    Perhutanan Semenanjung Malaysia (IPJPSM)</a>
                                                <a class="btn btn-secondary"
                                                    href="{{ route('ipjpsm.senaraiphd') }}">Pejabat Hutan Daerah
                                                    (PHD)</a>
                                                <a class="btn btn-primary"
                                                    href="{{ route('ipjpsm.senaraijpn') }}">Jabatan Perhutanan Negeri
                                                    (JPN)</a>
                                                    ...
                                                    <div class="modal fade" id="edit{{ $data->id }}"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <form
                                                                    action="{{ route('ipjpsm.emeljpn', $data->id) }}"
                                                                    method="post">
                                                                    @csrf
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <a id="buttonclose{{ $key }}" style="display:none;color:white" class="btn waves-effect waves-light btn-info btn-block" onclick="hideTable{{ $key }}()">Kemaskini Emel Pengguna</a>
                                                                        <a id="buttonopen{{ $key }}" style="display:block;color:white" class="btn waves-effect waves-light btn-info btn-block" onclick="showTable{{ $key }}()">Kemaskini Negeri </a>
                                                                        <script>
                                                                            function showTable{{ $key }}(){

                                                                                    console.log('buttonopen{{ $key }}');
                                                                                    document.getElementById('negeri{{ $data->id }}').style.display ="block";
                                                                            ...
                                                                            function hideTable{{ $key }}(){
                                                                                ...
                                                                                console.log('bukak');
                                                                                document.getElementById('negeri{{ $data->id }}').style.display ="none";
                                                                        ...
                                                                        <br>
                                                                        <div id="negeri{{ $data->id }}" style="display:none">
                                                                        <div class="form-group row">
                                                                            <label for="cono1"
