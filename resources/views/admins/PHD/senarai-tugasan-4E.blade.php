...
@section('content')
                                ...
                                <div class="col-md-2">
                                    <select name="select_year" id="select_year" class="form-control"
                                        ...
                                        @endforeach
                                                                ...
                                                                @include('partials.borang-nav', ['shuttle_type' => 4, 'current_form' => 'E', 'role' => 'phd'])
                            </div>
                            <br><br>
                            <div>
                                <h4 class="text-center">PENYATA SHUTTLE 4 - KILANG PAPAN LAPIS/VENIR</h4>

                                <h4 class="text-center">BORANG 4E - PENYATA PENJUALAN PAPAN LAPIS/VENIR DALAM PASARAN TEMPATAN DAN EKSPORT</h4>
                            </div>
                            <div class="">
    ...
    <script>
        function changePage() {
            ...
            window.location.href = "<?php echo URL::to('/phd/senarai-tugasan-4E/" + year +"'); ?>";
        }
    </script>
