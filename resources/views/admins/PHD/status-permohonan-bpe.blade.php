            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body" style="width: 100%">
                        ...
                        <div><h4>STATUS PERMOHONAN PEGAWAI JABATAN PERHUTANAN SEMENANJUNG MALAYSIA (IPJPSM)</h4></div>
                            ...
                            <table id="example" class="display" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="txt-oflo">Kilang Papan Lapis/Venier</td>
                                        @else
                                        ...
                                        @endif
                                        <td> <a href="{{ route('ipjpsm.lampiran-permohonan-bpe',$data->id) }}"  class="mr-1 btn btn-success"><i
