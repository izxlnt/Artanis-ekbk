                ...
                <div class="row">
                    ...
                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <a class="btn btn-secondary"
                                                href="{{ route('ipjpsm.status-permohonan-shuttle-3-kilang') }}">Shuttle 3</a>
                                            <a class="btn btn-primary"
                                                href="{{ route('ipjpsm.status-permohonan-shuttle-4-kilang') }}">Shuttle 4</a>
                                            <a class="btn btn-secondary"
                                                href="{{ route('ipjpsm.status-permohonan-shuttle-5-kilang') }}">Shuttle 5</a>
                                        </div>
                                    </div>
                                    <br><br>
                                    <div>
                        <div><h2>PENYATA SHUTTLE 4: KILANG PAPAN LAPIS/VENIR</h2></div>
                                                    ...
                                                    @if ($data->kategori_pengguna == 'IBK')
                                                        <tr>
                                                            ...
                                                            @if ($data->is_approved == '1')
                                                                <td><span
                                                                        class="label label-success label-rounded">Lulus</span>
                                                                </td>
                                                            @elseif($data->is_approved == '0')
                                                                <td><span class="label label-danger label-rounded">Belum
                                                                        Diluluskan</span> </td>
                                                            @else
                                                                <td><span class="label label-info label-rounded">Tiada
                                                                        Data</span> </td>
                                                            @endif
                                                            <td> <a href="{{ route('ipjpsm.lampiran-permohonan-pengguna', $data->id) }}"
                                    ...
                                    <div class="row">
                                        <a class="btn btn-primary" href="{{ route('ipjpsm.status-permohonan-shuttle-4-kilang') }}"
