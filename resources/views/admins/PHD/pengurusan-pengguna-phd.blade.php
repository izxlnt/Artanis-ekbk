                    ...
                    <div class="card-body" style="width: 100%">
                        ...
                        <div class="table-responsive">
                            <table id="example" class="display" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="label label-success label-rounded">Sah</span></td>
                                        @else
                                        <td><span class="label label-danger label-rounded">Belum disahkan</span></td>
                                        @endif
                                        <td><a href="{{ route('phd.lampiran-pengurusan-pengguna',$data->id) }}"  class="mr-1 btn btn-success"><i
                            ...
                            <div class="text-center form-group m-b-0">
                                <a href="{{ route('phd.tambah-pengurusan-pengguna') }}" type="button" class="btn btn-primary">Tambah Pengguna</a>
