                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <a class="btn btn-secondary" href="{{ route('ipjpsm.senaraikilang4') }}">Shuttle 4</a>
                                <a class="btn btn-primary" href="{{ route('ipjpsm.senaraikilang5') }}">Shuttle 5</a>
                                    ...
                                    <div class="row">
                                        <a class="btn btn-primary" href="{{ route('ipjpsm.senaraikilang5') }}"
