    ...
    if ($d && $d->status === 'Dihantar ke IPJPSM' && $b && $b->status === 'Dihantar ke IPJPSM' && $b->borang_b == 2) { $isPending = true; break; }
                                            ...
                                            <tr class="{{ $isPending ? 'table-warning' : '' }}">
                                                ...
                                                <td>
                                                    ...
                                                    @include('partials.cell-borang-quarterly', ['data' => $data, 'current_batch' => $cb, 'buffer' => $buffer, 'viewRoute' => 'ipjpsm.shuttle-4-view-formB', 'batchField' => 'borang_b', 'from' => 'keseluruhan'])
                                                </td>
