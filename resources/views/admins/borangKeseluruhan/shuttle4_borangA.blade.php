...
@section('content')
                                ...
                                <div class="col-md-2">
                                    <select name="select_year" id="select_year" class="form-control"
                                        ...
                                        @endfor
                                                                ...
                                                                @include('partials.borang-nav', ['shuttle_type' => 4, 'current_form' => 'A', 'role' => 'ipjpsm'])
                            </div>
                            <br><br>
                            <div>
                                <h4 class="text-center">SENARAI PENUH MAKLUMAT BORANG - BORANG 4A</h4>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($data->status == 'Sedang Diproses')
                                                        <a href="#"><img src="{{ asset('circle_times_yellow.png') }}" height='30px' alt="" data-toggle="tooltip" data-placement="bottom" title="Borang perlu disahkan PHD"></a>
    ...
    <script>
        function changePage() {
            ...
            window.location.href = "<?php echo URL::to('/admin/borang-keseluruhan/shuttle-4/borang-A/" + year +"'); ?>";
        }
    </script>
