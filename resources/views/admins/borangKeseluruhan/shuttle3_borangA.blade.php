...
@section('content')
                                ...
                                <div class="col-md-2">
                                    <select name="select_year" id="select_year" class="form-control"
                                        ...
                                        @endfor
                                                                ...
                                                                @include('partials.borang-nav', ['shuttle_type' => 3, 'current_form' => 'A', 'role' => 'ipjpsm'])
                            </div>
                            <br><br>
                            <div>
                                <h4 class="text-center">SENARAI PENUH MAKLUMAT BORANG - BORANG 3A</h4>
                            </div>
    ...
    <script>
        function changePage() {
            ...
            window.location.href = "<?php echo URL::to('/admin/borang-keselurhan/shuttle-3/borang-A/" + year +"'); ?>";
        }
    </script>
