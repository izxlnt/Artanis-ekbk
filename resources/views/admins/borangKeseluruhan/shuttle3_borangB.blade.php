    ...
    if ($d && $d->status === 'Dihantar ke IPJPSM' && $b && $b->status === 'Dihantar ke IPJPSM' && $b->borang_b == 2) { $isPending = true; break; }
                                            ...
                                            <tr class="{{ $isPending ? 'table-warning' : '' }}" style="text-align:center">
                                                ...
                                                <td>
                                                    ...
                                                    @include('partials.cell-borang-quarterly', ['data' => $data, 'current_batch' => $cb, 'buffer' => $buffer, 'viewRoute' => 'ipjpsm.shuttle-3-view-formB', 'batchField' => 'borang_b', 'from' => 'keseluruhan'])
                                                </td>
