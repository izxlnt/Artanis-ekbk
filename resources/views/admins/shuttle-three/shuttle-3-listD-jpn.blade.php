                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="example" class="display" style="width:100%">
                                    <thead>
                                        <tr style="background-color: rgb(33, 235, 77); text-align:center">
                                                ...
                                                <td>
                                                    @foreach ($formD as $data)
                                                        ...
                                                        @elseif($data->status == 'Tiada Pengeluaran' && $data->bulan == '1' && $shuttle->shuttle_id == $data->shuttle_id)
                                                            <a href="{{ route('phd.shuttle-3-view-formD', $data->id) }}"><img src="{{ asset('circle_times_yellow.png') }}" height='30px' alt="" data-toggle="tooltip" data-placement="bottom" title="Borang perlu disahkan PHD - Tiada Pengeluaran"></a>
                                                        @elseif($data->status == 'Sedang Diproses' && $data->bulan == '1' && $shuttle->shuttle_id == $data->shuttle_id)
                                                            <a href="{{ route('jpn.shuttle-3-view-formD', $data->id) }}"><img
                                                        ...
                                                        @elseif($data->status == 'Tidak Lengkap' && $data->bulan == '1' && $shuttle->shuttle->id == $data->shuttle_id)
                                                            <a href="{{ route('jpn.shuttle-3-view-formD', $data->id) }}">
                                                ...
                                                <td>
                                                    @foreach ($formD as $data)
                                                        ...
                                                        @elseif($data->status == 'Sedang Diproses' && $data->bulan == '9' && $shuttle->shuttle_id == $data->shuttle_id)
                                                            <a
                                                                href="{{ route('jpn.shuttle-3-view-formD', $data->id) }}"><img
                                                                    src="{{ asset('circle_times_yellow.png') }}"
                                                                    height='30px' alt=""
                                                                    style="color: white; font-size: 18pt;"
                                                                    data-toggle="tooltip" data-placement="bottom"
                                                        ...
                                                        @elseif($data->status == 'Tidak Lengkap' && $data->bulan == '9' && $shuttle->shuttle->id == $data->shuttle_id)
                                                            <a
                                                                href="{{ route('jpn.shuttle-3-view-formD', $data->id) }}">
                                                                <img src="{{ asset('history.png') }}" height='30px'
                                                                    alt="" style="color: #dbd400; font-size: 20pt;"
                                                                    data-toggle="tooltip" data-placement="bottom"
                                                                    title="Borang tidak lengkap "></i></a>
