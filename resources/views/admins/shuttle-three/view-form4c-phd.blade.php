                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <table>
                                                                        ...
                                                                        <tr style="height:50px;">
                                                                            ...
                                                                            @if( $keyKumpulanKayu == '0')
                                                                                ...
                                                                                {{-- <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;" type="text" size="10" wire:model='total_kayu_keluar_jentera.{{ $keyKumpulanKayu }}' value="{{ number_format($kemasukan_bahan_calc_kkb->total_kayu_keluar_jentera,2) }}"></td> --}}
                                                                                <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;" type="text" size="10" wire:model='total_kayu_dibawa_bulan_hadapan.{{ $keyKumpulanKayu }}' value="{{ number_format($kemasukan_bahan_calc_kkb->total_kayu_dibawa_bulan_hadapan,2) }}"></td>
                                                                            @elseif(  $keyKumpulanKayu == '1')
                                                                                ...
                                                                                {{-- <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;" type="text" size="10" wire:model='total_kayu_keluar_jentera.{{ $keyKumpulanKayu }}' value="{{ number_format($kemasukan_bahan_calc_kks->total_kayu_keluar_jentera,2) }}"></td> --}}
                                                                            ...
                                                                            @elseif(  $keyKumpulanKayu == '2')
                                                                                ...
                                                                                {{-- <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;" type="text" size="10" wire:model='total_kayu_keluar_jentera.{{ $keyKumpulanKayu }}' value="{{ number_format($kemasukan_bahan_calc_kkr->total_kayu_keluar_jentera,2) }}"></td> --}}
                                                                                <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;" type="text" size="10" wire:model='total_kayu_dibawa_bulan_hadapan.{{ $keyKumpulanKayu }}' value="{{ number_format($kemasukan_bahan_calc_kkr->total_kayu_dibawa_bulan_hadapan,2) }}"></td>
                                                                            ...
                                                                            @elseif(  $keyKumpulanKayu == '3')
                                                                                ...
                                                                                {{-- <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;" type="text" size="10" wire:model='total_kayu_keluar_jentera.{{ $keyKumpulanKayu }}' value="{{ number_format($kemasukan_bahan_calc_kayu_lembut->total_kayu_keluar_jentera,2) }}"></td> --}}
                                                                                <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;" type="text" size="10" wire:model='total_kayu_dibawa_bulan_hadapan.{{ $keyKumpulanKayu }}' value="{{ number_format($kemasukan_bahan_calc_kayu_lembut->total_kayu_dibawa_bulan_hadapan,2) }}"></td>
                                                                            ...
                                                                            @elseif(  $keyKumpulanKayu == '4')
                                                                                ...
                                                                                {{-- <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;" type="text" size="10" wire:model='total_kayu_keluar_jentera.{{ $keyKumpulanKayu }}' value="{{ number_format($kemasukan_bahan_calc_lain_lain->total_kayu_keluar_jentera,2) }}"></td> --}}
                                                                    ...
                                                                    @endforeach
                                                                        ...
                                                                        <tr style="height:50px;">
                                                                            ...
                                                                            {{-- <td style="text-align:right;" colspan="2"><input readonly style="background-color: #e0ec3754;text-align:right" type="text" size="10" wire:model='jumlah_besar_pengeluaran_kayu_daripada_jentera' value="{{ number_format($kemasukan_bahan_calc_lain_lain->jumlah_besar_pengeluaran_kayu_daripada_jentera,2) }}"></td> --}}
