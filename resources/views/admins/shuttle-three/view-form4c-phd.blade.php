                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <table>
                                                                        ...
                                                                        <tbody class="">
                                                                            ...
                                                                            <tr style="height:50px;">
                                                                                <th style="text-align:left;width: 489px;">{{ $data->singkatan }} </th>
                                                                            ...
                                                                            @if($data1->kumpulan_kayu->singkatan == $data->singkatan)
                                                                                ...
                                                                                <tr style="height:50px;">
                                                                                    ...
                                                                                    <td style="text-align:center;" colspan="2"><input readonly type="text" size="10" style="background-color: #e0ec3754;text-align:right" value="{{ isset($form_c_by_species[$data1->id]) ? number_format($form_c_by_species[$data1->id]->baki_stok,2) : '0.00' }}" wire:change="calcJumlahBakiStok({{ $keySpecies}}, {{ $keyKumpulanKayu }}, '{{ $data->singkatan }}');" onkeypress="return isNumberKey(event)"></td>
                                                                                    <td style="text-align:center;" colspan="2"><input readonly type="text" size="10" style="background-color: #ffffff;text-align:right" value="{{ isset($form_c_by_species[$data1->id]) ? number_format($form_c_by_species[$data1->id]->kayu_masuk,2) : '0.00' }}" wire:model='kayu_masuk.{{ $keySpecies }}' wire:change="calcJumlahKayuMasuk({{ $keySpecies}}, {{ $keyKumpulanKayu }}, '{{ $data->singkatan }}');" onkeypress="return isNumberKey(event)"></td>
                                                                                    <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;text-align:right" type="text" size="10" value="{{ isset($form_c_by_species[$data1->id]) ? number_format($form_c_by_species[$data1->id]->jumlah_stok_kayu_balak,2) : '0.00' }}" wire:model='jumlah_stok_kayu_balak.{{ $keySpecies }}' wire:change="calcTotalStokKayuDibawaBulanHadapan({{ $keySpecies}}, {{ $keyKumpulanKayu }}, '{{ $data->singkatan }}');"></td>
                                                                                    <td style="text-align:center;" colspan="2"><input readonly type="text" size="10" style="background-color: #ffffff;text-align:right" value="{{ isset($form_c_by_species[$data1->id]) ? number_format($form_c_by_species[$data1->id]->proses_masuk,2) : '0.00' }}" wire:model='proses_masuk.{{ $keySpecies }}' wire:change="calcBakiStok({{ $keySpecies}}, {{ $keyKumpulanKayu }}, '{{ $data->singkatan }}');" onkeypress="return isNumberKey(event)"></td>
                                                                                    {{-- <td style="text-align:center;" colspan="2"><input readonly type="text" size="10" style="background-color: #ffffff;" value="{{ number_format($form_c[$keySpecies]->proses_keluar,2) }}" wire:model='proses_keluar.{{ $keySpecies }}' wire:change="calcTotalPengeluaranKayuDaripadaJentera({{ $keySpecies}}, {{ $keyKumpulanKayu }}, '{{ $data->singkatan }}');" onkeypress="return isNumberKey(event)"></td> --}}
                                                                                    <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;text-align:right" type="text" size="10" value="{{ isset($form_c_by_species[$data1->id]) ? number_format($form_c_by_species[$data1->id]->baki_stok_kehadapan,2) : '0.00' }}" wire:model='baki_stok_kehadapan.{{ $keySpecies }}' ></td>
                                                                                </tr>
                                                                        ...
                                                                        <tr style="height:50px;">
                                                                            ...
                                                                            @if( $keyKumpulanKayu == '0')
                                                                                <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;text-align:right" type="text" size="10" wire:model='jumlah_baki_stoks.{{ $keyKumpulanKayu }}' value="{{ number_format($kemasukan_bahan_calc_kkb->jumlah_baki_stok ?? 0, 2) }}"></td>
                                                                                ...
                                                                                {{-- <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;" type="text" size="10" wire:model='total_kayu_keluar_jentera.{{ $keyKumpulanKayu }}' value="{{ number_format($kemasukan_bahan_calc_kkb->total_kayu_keluar_jentera ?? 0, 2) }}"></td> --}}
                                                                                <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;" type="text" size="10" wire:model='total_kayu_dibawa_bulan_hadapan.{{ $keyKumpulanKayu }}' value="{{ number_format($kemasukan_bahan_calc_kkb->total_kayu_dibawa_bulan_hadapan ?? 0, 2) }}"></td>
                                                                            @elseif(  $keyKumpulanKayu == '1')
                                                                                ...
                                                                                {{-- <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;" type="text" size="10" wire:model='total_kayu_keluar_jentera.{{ $keyKumpulanKayu }}' value="{{ number_format($kemasukan_bahan_calc_kks->total_kayu_keluar_jentera ?? 0, 2) }}"></td> --}}
                                                                            ...
                                                                            @elseif(  $keyKumpulanKayu == '2')
                                                                                <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;text-align:right" type="text" size="10" wire:model='jumlah_baki_stoks.{{ $keyKumpulanKayu }}' value="{{ number_format($kemasukan_bahan_calc_kkr->jumlah_baki_stok ?? 0, 2) }}"></td>
                                                                                ...
                                                                                {{-- <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;" type="text" size="10" wire:model='total_kayu_keluar_jentera.{{ $keyKumpulanKayu }}' value="{{ number_format($kemasukan_bahan_calc_kkr->total_kayu_keluar_jentera ?? 0, 2) }}"></td> --}}
                                                                            ...
                                                                            @elseif(  $keyKumpulanKayu == '3')
                                                                                ...
                                                                                {{-- <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;" type="text" size="10" wire:model='total_kayu_keluar_jentera.{{ $keyKumpulanKayu }}' value="{{ number_format($kemasukan_bahan_calc_kayu_lembut->total_kayu_keluar_jentera ?? 0, 2) }}"></td> --}}
                                                                                <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;" type="text" size="10" wire:model='total_kayu_dibawa_bulan_hadapan.{{ $keyKumpulanKayu }}' value="{{ number_format($kemasukan_bahan_calc_kayu_lembut->total_kayu_dibawa_bulan_hadapan ?? 0, 2) }}"></td>

                                                                            @elseif(  $keyKumpulanKayu == '4')
                                                                                <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;text-align:right" type="text" size="10" wire:model='jumlah_baki_stoks.{{ $keyKumpulanKayu }}' value="{{ number_format($kemasukan_bahan_calc_lain_lain->jumlah_baki_stok ?? 0, 2) }}"></td>
                                                                                ...
                                                                                {{-- <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;" type="text" size="10" wire:model='total_kayu_keluar_jentera.{{ $keyKumpulanKayu }}' value="{{ number_format($kemasukan_bahan_calc_lain_lain->total_kayu_keluar_jentera ?? 0, 2) }}"></td> --}}
                                                                    ...
                                                                    @endforeach
                                                                        ...
                                                                        <tr style="height:50px;">
                                                                            ...
                                                                            <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;text-align:right" type="text" size="10" wire:model='jumlah_besar_baki_stok_bulan_lepas' value="{{ number_format($kemasukan_bahan_calc_lain_lain->jumlah_besar_baki_stok_bulan_lepas ?? 0, 2) }}" ></td>
                                                                            ...
                                                                            {{-- <td style="text-align:right;" colspan="2"><input readonly style="background-color: #e0ec3754;text-align:right" type="text" size="10" wire:model='jumlah_besar_pengeluaran_kayu_daripada_jentera' value="0"></td> --}}
                                                                        ...
                                                                        <tr style="height:50px;">
                                                                            ...
                                                                            {{-- <td style="text-align:right;" colspan="2"><input readonly style="background-color: #e0ec3754;text-align:right" type="text" size="10" wire:model='jumlah_besar_pengeluaran_kayu_daripada_jentera' value="{{ number_format($kemasukan_bahan_calc_lain_lain->jumlah_besar_pengeluaran_kayu_daripada_jentera ?? 0, 2) }}"></td> --}}
