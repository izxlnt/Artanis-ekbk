...
@section('content')
                        ...
                        <div class="card-body">
                            ...
                            <div class="pt-5 row">
                                <div class="col-md-12">
                                    ...
                                    <h4 class="text-center">PERAKUAN MAKLUMAT BORANG 3D- PENYATA PENJUALAN KAYU GERGAJI
                                        DALAM PASARAN
                                                        ...
                                                        @if ($shuttle->id == $data->shuttle_id && $data->bulan == '1')
                                                            ...
                                                            @elseif($data->status == 'Dihantar ke IPJPSM')
                                                                ...
                                                                @if ($current_batch->status == 'Dihantar ke IPJPSM' && $current_batch->borang_d == 2)
                                                                    <a href="{{ route('ipjpsm.shuttle-3-view-formD', $data->id) }}"
                                                                ...
                                                                @else
                                                                    <img src="{{ asset('package.png') }}" height='40px'
                                                                        ...
                                                                        title="Pakej belum dihantar PHD">
                                                                @endif
                                        ...
                                        <td>
                                            @foreach ($formD as $data)
                                                ...
                                                @if ($shuttle->id == $data->shuttle_id && $data->bulan == '2')
                                                    ...
                                                    @elseif($data->status == 'Tidak Lengkap')
                                                       <img src="{{ asset('history.png') }}" height='30px' alt="" style="filter: grayscale(1) brightness(1.8); font-size: 20pt;"
                                                            data-toggle="tooltip" data-placement="bottom"
                                                            title="Borang tidak lengkap "></i>
                                                    @elseif($data->status == 'Sedang Diproses')
                                                        <img src="{{ asset('circle_check_yellow.png') }}" height='30px' alt="" style="color: white; font-size: 18pt;"
                                                            data-toggle="tooltip" data-placement="bottom"
                                                            title="Borang telah dihantar"></i>
    ...
    <script>
        function changePage() {
            ...
            window.location.href = "<?php echo URL::to('/admin/shuttle-3-listD/" + year +"'); ?>";
        }
    </script>
