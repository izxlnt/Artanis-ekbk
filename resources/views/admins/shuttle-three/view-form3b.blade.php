                                                            ...
                                                            <table>
                                                                ...
                                                                @forelse($form_b as $key=>$data)
                                                                    <tr style="height:50px;">
                                                                        ...
                                                                        <td style="text-align:right;padding:5px;white-space:nowrap;"><span>{{ number_format($data->jumlah_lelaki * $data->gaji_lelaki, 2) }}</span>
                                                                        </td>
                                                                        <td style="text-align:right;padding:5px;white-space:nowrap;"><span>{{ number_format($data->jumlah_perempuan * $data->gaji_perempuan, 2) }}</span>
                                                                        </td>
                                                                        <td
                                                                            style="text-align:right;padding:5px;white-space:nowrap;background-color: #f8dbee;">
