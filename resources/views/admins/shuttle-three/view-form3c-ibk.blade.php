                                                                            ...
                                                                            @foreach ($species as $keySpecies=>$data1)
                                                                                ...
                                                                                @if($data1->kumpulan_kayu->singkatan == $data->singkatan)
                                                                                    ...
                                                                                    <tr style="height:50px;">
                                                                                        ...
                                                                                        <td style="text-align:center;" colspan="2"><input readonly type="text" size="10" style="background-color: #e0ec3754; text-align:right" value="{{ number_format($form_c[$keySpecies]->baki_stok,2) }}" ></td>
                                                                                        <td style="text-align:center;" colspan="2"><input readonly type="text" size="10" style="background-color: #ffffff;text-align:right" value="{{ number_format($form_c[$keySpecies]->kayu_masuk,2) }}" ></td>
                                                                                        <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;text-align:right" type="text" size="10" value="{{ number_format($form_c[$keySpecies]->jumlah_stok_kayu_balak,2) }}"></td>
                                                                                        <td style="text-align:center;" colspan="2"><input readonly type="text" size="10" style="background-color: #ffffff;text-align:right" value="{{ number_format($form_c[$keySpecies]->proses_masuk,2) }}" ></td>
                                                                                        <td style="text-align:center;" colspan="2"><input readonly type="text" size="10" style="background-color: #ffffff;text-align:right" value="{{ number_format($form_c[$keySpecies]->proses_keluar,2) }}" ></td>
                                                                                        <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;text-align:right" type="text" size="10" value="{{ number_format($form_c[$keySpecies]->baki_stok_kehadapan,2) }}"></td>
                                                                                    </tr>
