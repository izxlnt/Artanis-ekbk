...
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                                                ...
                                                <td>
                                                    @foreach ($formD as $data)
                                                        ...
                                                        @elseif($data->status == 'Tiada Pengeluaran' && $data->bulan == '1' && $shuttle->shuttle_id == $data->shuttle_id)
                                                            <a href="{{ route('phd.shuttle-3-view-formD', $data->id) }}"><img src="{{ asset('circle_times_yellow.png') }}" height='30px' alt="" data-toggle="tooltip" data-placement="bottom" title="Borang perlu disahkan PHD"></a>
                            ...
                            <div class="row">
                                <a class="btn btn-primary" href="{{ route('home-phd') }}"
    ...
    <script>
        function changePage() {
            ...
            window.location.href = "<?php echo URL::to('/phd/shuttle-3-listD/" + year +"'); ?>";
        }
    </script>
