                                    ...
                                    <tbody>
                                        @foreach ($formB_kilang as $shuttle)
                                            <tr>
                                                ...
                                                <td align="left">{{ $shuttle->shuttle->nama_kilang }}</td>
                                                            ...
                                                            @elseif($data->status == 'Lulus' && $data->suku_tahun == '1' && $shuttle->shuttle_id == $data->shuttle_id)
                                                                <a
                                                                    ...
                                                                    <img src="{{ asset('double_check.png') }}"
                                                                        ...
                                                                        data-toggle="tooltip" data-placement="bottom"
                                                                        data-original-title="Borang telah diperaku"></i></a>
                                                            @endif
                                                        @endif
                                                    @endforeach
                                                </td>
                                                ...
                                                <td>
                                                    @foreach ($formB as $data)
                                                        ...
                                                        @elseif($data->status == 'Tiada Pengeluaran' && $data->suku_tahun == '3' && $shuttle->shuttle_id == $data->shuttle_id)
                                                            <a href="{{ route('phd.shuttle-3-view-formB', $data->id) }}"><img src="{{ asset('circle_times_yellow.png') }}" height='30px' alt="" data-toggle="tooltip" data-placement="bottom" title="Borang perlu disahkan PHD - Tiada Pengeluaran"></a>
                                                        ...
                                                        @elseif($data->status == 'Lulus' && $data->suku_tahun == '3' && $shuttle->shuttle_id == $data->shuttle_id)
                                                            <a href="{{ route('jpn.shuttle-3-view-formB', $data->id) }}">
                                                                <img src="{{ asset('double_check.png') }}" height='30px'
                                                                    alt="" style="color: green; font-size: 20pt;"
                                                                    data-toggle="tooltip" data-placement="bottom"
                                                                    data-original-title="Borang telah diluluskan"></i></a>
                                                        @endif
                                                    @endforeach
                                                </td>
                                                <td>
