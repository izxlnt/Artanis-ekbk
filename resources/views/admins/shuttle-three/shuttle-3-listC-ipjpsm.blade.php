...
@section('content')
                        ...
                        <div class="card-body">
                            ...
                            <div class="pt-5 row">
                                <div class="col-md-12">
                                    ...
                                    <h4 class="text-center">PERAKUAN MAKLUMAT BORANG 3C - PENYATA KEMASUKAN & PEMPROSESAN
                                        KAYU BALAK
                                                        ...
                                                        @if ($shuttle->id == $data->shuttle_id && $data->bulan == '1')
                                                            ...
                                                            @elseif($data->status == 'Tiada Pengeluaran')
                                                                <i class="fas fa-times"
                                                                    style="color: #dbd400; font-size: 20pt;"
                                                                    data-toggle="tooltip" data-placement="bottom"
                                                                    title="Borang perlu disahkan - Tiada Pengeluaran "></i>
                                                            @else
                                                                <img src="{{ asset('calendar.png') }}" height='30px'
                                                                    alt="" style="color: grey; font-size: 20pt;"
                                                                    data-toggle="tooltip" data-placement="bottom"
    ...
    <script>
        function changePage() {
            ...
            window.location.href = "<?php echo URL::to('/admin/shuttle-3-listC/" + year +"'); ?>";
        }
    </script>
