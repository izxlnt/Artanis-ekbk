...
@section('content')
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        @if ($user->kategori_pengguna == 'PHD')
                                            ...
                                            <a type="button" href="{{ route('phd.shuttle-3-listD', date('Y')) }}"
                                                class="btn"
                                                style="background-color:white;color:black;border-color:#1b9e21f3">Borang
                                                3D</a>
                                        @elseif($user->kategori_pengguna == 'BPE')
                                            <a type="button" href="{{ route('shuttle-3-listB') }}"
                                                class="btn waves-effect waves-light btn-outline-info ">Borang 3B</a>
                                            <a type="button" href="{{ route('shuttle-3-listC') }}"
                                                class="btn waves-effect waves-light btn-outline-info active">Borang 3C</a>
                                            <a type="button" href="{{ route('shuttle-3-listD') }}"
                                                class="btn waves-effect waves-light btn-outline-info">Borang 3D</a>
                                        @endif
                                        {{-- <select name="form_type" class="form-control" wire:model='form_type'
                                        id="form_type">
                            ...
                            <div class="pt-5 row">
                                <div class="col-md-12">
                                    ...
                                    <h4 class="text-center">BORANG 3C - PENYATA KEMASUKAN & PEMPROSESAN KAYU BALAK
                                                ...
                                                <td>
                                                    @foreach ($formC as $data)
                                                        ...
                                                        @elseif($data->status == 'Sedang Diproses' && $data->bulan == '9' && $shuttle->shuttle_id == $data->shuttle_id)
                                                            <a
                                                                href="{{ route('phd.shuttle-3-view-formC', $data->id) }}"><img
                                                                    src="{{ asset('circle_times_yellow.png') }}" height='30px'
                                                                    style="color: white; font-size: 18pt;"
                                                                    data-toggle="tooltip" data-placement="bottom"
                                                                    title="Borang perlu disahkan PHD"></i></a>
                                                        @elseif($data->status == 'Tiada Pengeluaran' && $data->bulan == '9' && $shuttle->shuttle_id == $data->shuttle_id)
                                                            <a
                                                                href="{{ route('phd.shuttle-3-view-formC', $data->id) }}">
                                                                <img src="{{ asset('circle_times_yellow.png') }}" height='30px'
                                                                    alt="" data-toggle="tooltip" data-placement="bottom"
                                                                    title="Borang perlu disahkan PHD - Tiada Pengeluaran"></a>
    ...
    <script>
        function changePage() {
            ...
            window.location.href = "<?php echo URL::to('/phd/shuttle-3-listC/" + year +"'); ?>";
        }
    </script>
