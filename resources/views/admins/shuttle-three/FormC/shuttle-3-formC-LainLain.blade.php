        ...
        <div class="col-md-12">
                            ...
                            <table class="table table-striped table-bordered ex3" id="">
                                <div class="row">
                                    ...
                                    <div class="card">
                                            ...
                                            <form class="form-horizontal" action='{{ route('user.view.shuttle-3-formC.LainLain.store', [$bulan_id, $year ?? date('Y')]) }}' onsubmit="return checkValidationuSubmit(event)"
                                                                    ...
                                                                    <tr style="height:50px;">
                                                                        ...
                                                                        <td style="text-align:center;" colspan="2">
                                                                            <input readonly
                                                                                ...
                                                                                value="{{ $jumlah_kayu_masuk[$keyKumpulanKayu] }}">
                                                                        </td>
                                                                        <td style="text-align:center;" colspan="2">
                                                                            <input readonly
                                                                                style="background-color: #e0ec3754; text-align:right"
                                                                                ...
                                                                                value="{{ $total_stok_kayu_balak[$keyKumpulanKayu] }}">
                                                                        </td>
                                                                        <td style="text-align:center;" colspan="2">
                                                                            <input readonly
                                                                                style="background-color: #e0ec3754; text-align:right"
                                                                                ...
                                                                                value="{{ $total_kayu_masuk_jentera[$keyKumpulanKayu] }}">
                                                                        </td>
                                                                        <td style="text-align:center;" colspan="2">
                                                                            <input readonly
                                                                                style="background-color: #e0ec3754; text-align:right"
                                                                                ...
                                                                                value="{{ $total_kayu_keluar_jentera[$keyKumpulanKayu] }}">
                                                                        </td>
                                                                        <td style="text-align:center;" colspan="2">
                                                                            <input readonly
                                                                                style="background-color: #e0ec3754; text-align:right"
                                                                                ...
                                                                                value="{{ $total_kayu_dibawa_bulan_hadapan[$keyKumpulanKayu] }}">
                                                                        </td>
                                                                    </tr>
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header" style="background-color:#f3ce8f  !important">
                                                    <h5 class="modal-title "
                                                        id="tiada_pengeluaranTitle"><i style="color:rgb(255, 255, 0)"
            ...
            <script>
                ...
                function checkValidationuSubmit(event) {
                    // Skip validation when clicking 'Sebelumnya' button
