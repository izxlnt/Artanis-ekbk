                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <table>
                                                                        ...
                                                                        <tbody class="">
                                                                            ...
                                                                            <tr style="height:50px;">
                                                                                ...
                                                                                @elseif(  $keyKumpulanKayu == '1')
                                                                                    ...
                                                                                    <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;" type="text" size="10" wire:model='total_kayu_dibawa_bulan_hadapan.{{ $keyKumpulanKayu }}' value="{{ number_format($kemasukan_bahan_calc_kks->total_kayu_dibawa_bulan_hadapan,2) }}"></td>
                                                                        ...
                                                                        {{-- <tr style="height:50px;">
                                                                            ...
                                                                            <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;" type="text" size="10" wire:model='jumlah_besar_baki_stok_bulan_lepas' value="{{ number_format($kemasukan_bahan_calc_lain_lain->jumlah_besar_baki_stok_bulan_lepas,2) }}" ></td>
                                                                            <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;" type="text" size="10" wire:model='jumlah_besar_kemasukan_kayu_ke_kilang' value="{{ number_format($kemasukan_bahan_calc_lain_lain->jumlah_besar_kemasukan_kayu_ke_kilang,2) }}"></td>
                                                                            <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;" type="text" size="10" wire:model='jumlah_besar_stok_kayu_balak' value="{{ number_format($kemasukan_bahan_calc_lain_lain->jumlah_besar_stok_kayu_balak,2) }}"></td>
                                                                            <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;" type="text" size="10" wire:model='jumlah_besar_kayu_ke_dalam_jentera' value="{{ number_format($kemasukan_bahan_calc_lain_lain->jumlah_besar_kayu_ke_dalam_jentera,2) }}"></td>
                                                                            ...
                                                                            <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;" type="text" size="10" wire:model='jumlah_besar_baki_stok_bulan_depan' value="{{ number_format($kemasukan_bahan_calc_lain_lain->jumlah_besar_baki_stok_bulan_depan,2) }}"></td>
                                                                        </tr> --}}
                                                                        ...
                                                                        <tr style="height:50px;">
                                                                            ...
                                                                            {{-- <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;" type="text" size="10" wire:model='jumlah_besar_pengeluaran_kayu_daripada_jentera' value="{{ number_format($kemasukan_bahan_calc_lain_lain->jumlah_besar_pengeluaran_kayu_daripada_jentera,2) }}"></td> --}}
                                                                ...
                                                                <div class="modal-dialog modal-dialog-centered"
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <span class="text-center">Adakah anda pasti
                                                                                ingin mengesahkan borang ini?</span>
                                                                        </div>
