                        ...
                        <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        @if ($user->kategori_pengguna == 'PHD')
                                            ...
                                            <a type="button" href="{{ route('jpn.shuttle-3-listA-jpn', date('Y')) }}"
                                                ...
                                                3D</a>
                                        @elseif($user->kategori_pengguna == 'JPN')
                                            <a type="button " href="{{ route('jpn.shuttle-3-listA-jpn', date('Y')) }}"
                                                class="btn"
                                                style="background-color:white;color:black;border-color:black">Borang 3A</a>
                            ...
                            <div class="table-responsive">
                                <table id="example" class="display" style="width:100%">
                                    <thead>
                                        <tr style="background-color: #f3e741f3;text-align:center">
                                                ...
                                                <td>
                                                    @foreach ($formC as $data)
                                                        @if ($data->status == 'Tidak Diisi' && $data->bulan == '1' && $shuttle->shuttle_id == $data->shuttle_id)
                                                            ...
                                                            @if (date('Y-m-d') >= $data->tarikh_buka_borang && (!$buffer || !$buffer->aktif || date('Y-m-d') <= $tarikh_tutup_terkini))
                                                                <img src="{{ asset('circle_times.png') }}" height='30px'
                                                                    alt="" style="color: red; font-size: 20pt;"
                                                        ...
                                                        @elseif($data->status == 'Sedang Diproses' && $data->bulan == '1' && $shuttle->shuttle_id == $data->shuttle_id)
                                                            <a href="{{ route('jpn.shuttle-3-view-formC', $data->id) }}"><img
