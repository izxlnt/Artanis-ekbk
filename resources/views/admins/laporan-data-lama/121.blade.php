        ...
        <div class="page-breadcrumb" style="padding: 0px">
            <div class="pb-2 row">
                <div class="col-5 align-self-center">
                    ...
                    <a href="{{ route('getreport_penggunaan_bynegeri.excel', [$shuttle,$tahun,$title, $file_type = 'excel']) }}" class="btn btn-success">Excel</a>
                    <a href="{{ route('getreport_penggunaan_bynegeri.excel', [$shuttle,$tahun,$title, $file_type = 'pdf']) }}" class="btn btn-danger">PDF</a>
                    <a href="{{ route('getreport_penggunaan_bynegeri.excel', [$shuttle,$tahun,$title, $file_type = 'pdf']) }}" class="btn btn-warning">Print</a>
                </div>
