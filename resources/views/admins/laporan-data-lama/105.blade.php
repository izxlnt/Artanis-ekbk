        ...
        <div class="page-breadcrumb" style="padding: 0px">
            <div class="pb-2 row">
                <div class="col-5 align-self-center">
                    ...
                    <a href="{{ route('getreport_top10pengeluar.excel', [$shuttle, $tahun = $tahun, $lapisvenier, $title, $file_type = 'excel']) }}" class="btn btn-success">Excel</a>
                    <a href="{{ route('getreport_top10pengeluar.excel', [$shuttle, $tahun = $tahun, $lapisvenier, $title, $file_type = 'pdf']) }}" class="btn btn-danger">PDF</a>
                    <a href="{{ route('getreport_top10pengeluar.excel', [$shuttle, $tahun = $tahun, $lapisvenier, $title, $file_type = 'pdf']) }}" class="btn btn-warning">Print</a>
                </div>
