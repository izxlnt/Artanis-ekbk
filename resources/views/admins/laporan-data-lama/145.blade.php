        ...
        <div class="page-breadcrumb" style="padding: 0px">
            <div class="pb-2 row">
                <div class="col-5 align-self-center">
                    ...
                    <a href="{{ route('getreport_jualan_bypembeli_bynegeri.excel', [$shuttle, $tahun, $title, ($file_type = 'excel')]) }}"
                        class="btn btn-success">Excel</a>
                    <a href="{{ route('getreport_jualan_bypembeli_bynegeri.excel', [$shuttle, $tahun, $title, ($file_type = 'pdf')]) }}"
                                ...
                                <tbody>
                                    ...
                                    <tr style="background-color: lightgray; font-weight: bold;">
                                        ...
                                        @foreach ($total as $data)
                                            <td class="text-right">{{ number_format($data->jualantempatan, 0) }}</td>
                                        @endforeach
                                        <td class="text-right">{{ number_format($grandtotal->jualantempatan, 0) }}
                                        </td>
                                    </tr>
                                </tbody>
                                </tfoot>
