        ...
        <div class="page-breadcrumb" style="padding: 0px">
            <div class="pb-2 row">
                <div class="col-5 align-self-center">
                    ...
                    <a href="{{ route('getreport_jualan_bynegeri.excel', [$shuttle, $tahun, $title, ($file_type = 'excel')]) }}"
                        class="btn btn-success">Excel</a>
                    <a href="{{ route('getreport_jualan_bynegeri.excel', [$shuttle, $tahun, $title, ($file_type = 'pdf')]) }}"
                        ...
                        <div class="table-responsive">
                            <table id="example" class="table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    @foreach ($results as $result)
                                        @if ($shuttle == 'shuttle4')
                                            <tr class="text-center">
                                                ...
                                                <td class="text-right">
                                                    {{ number_format($result->papanlapis->veniereksport, 0) }}</td>
                                                <td class="text-right">
                                                    {{ number_format($result->venier->veniereksport, 0) }}</td>
                                            </tr>
                                    ...
                                    <tr class="text-center" style="background-color: lightgray; font-weight: bold;">
                                        ...
                                        @if ($shuttle == 'shuttle4')
                                            <td class="text-right">
                                                {{ number_format($grandtotal->veniereksport['papanlapis'], 0) }}</td>
                                            <td class="text-right">
                                                {{ number_format($grandtotal->veniereksport['venier'], 0) }}</td>
                                        @else
                            ...
                            {{-- <tfoot>
                                    <tr class="text-center" style="background-color: lightgray; font-weight: bold;">
                                        <td></td>
                                        <td class="text-left">JUMLAH (m³)</td>
                                        @foreach ($grandtotal->veniereksport as $total)
                                            <td class="text-right">{{ number_format($total, 0) }}</td>
                                        @break
                                    @endforeach
                                </tr>
