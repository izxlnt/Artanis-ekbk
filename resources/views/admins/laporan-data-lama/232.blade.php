        ...
        <div class="page-breadcrumb" style="padding: 0px">
            <div class="pb-2 row">
                <div class="col-5 align-self-center">
                    ...
                    <a href="{{ route('getreport_pengeluaran_bynegeri_bytahun.excel', [$shuttle,$tahunmula,$tahunakhir,$title,($file_type = 'excel')]) }}"
                        class="btn btn-success">Excel</a>
                    <a href="{{ route('getreport_pengeluaran_bynegeri_bytahun.excel', [$shuttle,$tahunmula,$tahunakhir,$title,($file_type = 'pdf')]) }}"
