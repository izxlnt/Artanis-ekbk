        ...
        <div class="page-breadcrumb" style="padding: 0px">
            <div class="pb-2 row">
                <div class="col-5 align-self-center">
                    ...
                    <a href="{{ route('getreport_penggunaan_bykumpulankayu_bytahun.excel', [$shuttle,$tahun,$tahunakhir,$title,($file_type = 'excel')]) }}"
                        class="btn btn-success">Excel</a>
                    <a href="{{ route('getreport_penggunaan_bykumpulankayu_bytahun.excel', [$shuttle,$tahun,$tahunakhir,$title,($file_type = 'pdf')]) }}"
