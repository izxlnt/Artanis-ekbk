        ...
        <div class="page-breadcrumb" style="padding: 0px">
            <div class="pb-2 row">
                <div class="col-5 align-self-center">
                    ...
                    <a href="{{ route('getreport_pecahangunatenagadanpendapatan_bykategori.excel', [$shuttle,$tahun,$suku_tahun,$suku_tahun_akhir,$title,($file_type = 'excel')]) }}"
                        class="btn btn-success">Excel</a>
                    <a href="{{ route('getreport_pecahangunatenagadanpendapatan_bykategori.excel', [$shuttle,$tahun,$suku_tahun,$suku_tahun_akhir,$title,($file_type = 'pdf')]) }}"
                ...
                <div class="card">
                    ...
                    @if ($nama_suku_tahun != $nama_suku_tahun_akhir)
                        <div class="text-center card-header" style="background-color: #f3ce8f">{{ $title_laporan }} : Suku
                            ...
                            {{ $tahun }}</div>
                    @else
                        <div class="text-center card-header" style="background-color: #f3ce8f">{{ $title_laporan }} :
                            Suku
