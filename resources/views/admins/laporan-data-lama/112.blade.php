        ...
        <div class="page-breadcrumb" style="padding: 0px">
            <div class="pb-2 row">
                <div class="col-5 align-self-center">
                    ...
                    <a href="{{ route('getreport_gunatenagadanpendapatan_bykategori.excel', [$shuttle,$tahun,$suku_tahun,$suku_tahun_akhir,$title, $file_type = 'excel']) }}" class="btn btn-success">Excel</a>
                    <a href="{{ route('getreport_gunatenagadanpendapatan_bykategori.excel', [$shuttle,$tahun,$suku_tahun,$suku_tahun_akhir,$title, $file_type = 'pdf']) }}" class="btn btn-danger">PDF</a>
                    <a href="{{ route('getreport_gunatenagadanpendapatan_bykategori.excel', [$shuttle,$tahun,$suku_tahun,$suku_tahun_akhir,$title, $file_type = 'pdf']) }}" class="btn btn-warning">Print</a>
                </div>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($suku as $result)
                                            <tr class="text-center">
                                                ...
                                                <td class="text-right">{{ number_format($result->gunatenaga->l, 0) }}
                                                </td>
                                                <td class="text-right">{{ number_format($result->gunatenaga->p, 0) }}
                                                </td>
                                                <td class="text-right">
                                                    {{ number_format($result->gunatenaga->jumlah, 0) }}</td>

                                                <td class="text-right">{{ number_format($result->pendapatan->l, 2) }}
                                                </td>
                                                <td class="text-right">{{ number_format($result->pendapatan->p, 2) }}
                                                </td>
                                                <td class="text-right">
                                        ...
                                        <tr class="text-right" style="background-color: lightgray; font-weight: bold;">
                                            ...
                                            <td> {{ number_format($jumlah_purata_lelaki, 2) }}</td>
                                            <td> {{ number_format($jumlah_purata_perempuan, 2) }}</td>
                                            <td> {{ number_format($jumlah_purata_keseluruhan, 2) }}</td>
