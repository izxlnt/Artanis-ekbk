        ...
        <div class="page-breadcrumb" style="padding: 0px">
            <div class="pb-2 row">
                <div class="col-5 align-self-center">
                    ...
                    <a href="{{ route('getreport_jumlahpelaburan_bynegeri.excel', [$shuttle, $tahun, $title, ($file_type = 'excel')]) }}"
                        class="btn btn-success">Excel</a>
                    <a href="{{ route('getreport_jumlahpelaburan_bynegeri.excel', [$shuttle, $tahun, $title, ($file_type = 'pdf')]) }}"
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-center" style="background-color: lightgray;">
                                        ...
                                        <td class="text-right"><b>
                                                {{ number_format($jumlah_setiap_negeri, 2) }}</b></td>
                                    </tr>
                                </tbody>
                            </table>
