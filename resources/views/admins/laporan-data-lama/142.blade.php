        ...
        <div class="page-breadcrumb" style="padding: 0px">
            <div class="pb-2 row">
                <div class="col-5 align-self-center">
                    ...
                    <a href="{{ route('getreport_jualan_bynegeri.excel', [$shuttle, $tahun, $title, ($file_type = 'exco')]) }}"
                            ...
                            <table id="example" class="table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr style="background-color: lightgray; font-weight: bold;">
                                        ...
                                        <td>Jumlah (m³)</td>
                                        @if ($shuttle == 'shuttle4')
                                            <td class="text-right">{{ number_format($grandtotal->jualantempatan['papanlapis'], 0) }}</td>
                                            <td class="text-right">{{ number_format($grandtotal->veniertempatan['venier'], 0) }}</td>
                                        @else
