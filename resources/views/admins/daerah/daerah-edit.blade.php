            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <br>
                        <form action="{{ route('daerah-edit', $daerah->id) }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select class="form-control" id="negeri_id" name="negeri"
                                                            ...
                                                            <option disabled selected hidden value="">{{ $daerah->negeri }}
                                                            </option>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" name="daerah_hutan"
                                                            placeholder="Daerah Hutan"
                                                            value="{{ $daerah->daerah_hutan }}">
                                                        @error('daerah_hutan')
                                                            <div class="alert alert-danger">
                                                                <strong>{{ $message }}</strong>
                                                            </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" name="daerah_sivil"
                                                            placeholder="Daerah Sivil"
                                                            value="{{ $daerah->daerah_sivil }}">
                                                        @error('daerah_sivil')
                                                            <div class="alert alert-danger">
                                                                <strong>{{ $message }}</strong>
                                                            </div>
