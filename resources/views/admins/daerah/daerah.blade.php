            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <table id="example" class="display" style="width:100%;text-align:center">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align:center; ">Daerah Hutan</th>
                                        <th style="text-align:center; ">Daerah Sivil</th>
                                ...
                                <tbody>
                                    @foreach ($daerah as $data)
                                        <tr>
                                            ...
                                            <td style="text-align:left;">{{ $data->negeri }}</td>
                                            <td style="text-align:left;">{{ $data->daerah_hutan }}</td>
                                            <td style="text-align:left;">{{ $data->daerah_sivil }}</td>
                                            <td>
                                                <a href="{{ route('daerah-kemaskini', $data->id) }}"
                                                    class="mr-1 btn btn-success"><i class="fas fa-pencil-alt"
                                                        title="Kemaskini"></i>
                                                </a>
                                                <button class="btn btn-danger" data-toggle="modal"
                                                    data-target="#modalID{{ $data->id }}" type="button"><i
                                                        class="fas fa-trash-alt"></i></button>

                                                <form action="{{ route('delete_daerah',$data->id) }}" method="get">
                                                    @csrf
                                                <div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog"
                                                    aria-labelledby="mySmallModalLabel" aria-hidden="true"
                                                    style="display: none;" id="modalID{{ $data->id }}">
                        ...
                        <a href="{{ route('daerah-tambah') }}" class="btn btn-primary">Tambah</a>
