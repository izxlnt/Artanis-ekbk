                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card">
                                            ...
                                            <form class="form-horizontal" action='{{ route('user.view.shuttle-5-formC.LainLain.store', ['bulan' => $bulan_id, 'year' => $year]) }}' onsubmit="return checkValidationuSubmit()"
                                                        ...
                                                        <thead class="">
                                                            <tr style="height:50px;">
                                                                ...
                                                                <th style="text-align:center;" colspan="2">
                                                                    ...
                                                                    Lepas</th>
                                                                <th style="text-align:center;" colspan="2">
                                                                    Kemasukan Kayu Gergaji Ke
                                                                    Dalam Kawasan Kilang</th>
                                                                <th style="text-align:center;" colspan="2">
                                                                    Jumlah Stok Kayu Gergaji
                                                                </th>
