                                                                ...
                                                                <tbody class="" style="overflow-x: auto;">
                                                                    @foreach ($kumpulan_kayu as $keyKumpulanKayu => $data)
                                                                        ...
                                                                        <tr style="height:50px;">
                                                                            ...
                                                                            <td style="text-align:center;" colspan="2">
                                                                                <input readonly style="background-color: #e0ec3754; text-align:right" type="text" size="10" oninput="validate(this)" id='jumlah_baki_stok.{{ $keyKumpulanKayu }}' name='jumlah_baki_stok[]' value="{{ $jumlah_baki_stok[$keyKumpulanKayu] ?? 0 }}">
                                                                            </td>
                                                                            <td style="text-align:center;" colspan="2">
                                                                                <input readonly style="background-color: #e0ec3754; text-align:right" type="text" size="10" oninput="validate(this)" id='jumlah_kayu_masuk.{{ $keyKumpulanKayu }}' name='jumlah_kayu_masuk[]' value="{{ $jumlah_kayu_masuk[$keyKumpulanKayu] ?? 0 }}">
                                                                            </td>
                                                                            <td style="text-align:center;" colspan="2">
                                                                                <input readonly style="background-color: #e0ec3754; text-align:right" type="text" size="10" oninput="validate(this)" id='total_stok_kayu_balak.{{ $keyKumpulanKayu }}' name='total_stok_kayu_balak[]' value="{{ $total_stok_kayu_balak[$keyKumpulanKayu] ?? 0 }}">
                                                                            </td>
                                                                            <td style="text-align:center;" colspan="2">
