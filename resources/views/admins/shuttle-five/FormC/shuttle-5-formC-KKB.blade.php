                            ...
                            <div class="tab-pane active" id="hotel" role="tabpanel" aria-labelledby="hotel-tab">
                                <table class="table table-striped table-bordered ex3" id="">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="card">
                                                <form class="form-horizontal" action='{{ route('user.view.shuttle-5-formC.KKB.store', ['bulan' => $bulan_id, 'year' => $year]) }}' onsubmit="return checkValidationuSubmit()" method="POST" id="kkb">
                                                    @csrf
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row" style="margin-bottom:-2%;"">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="legend" style="border:2px solid;">
                                                                    ...
                                                                    <b style="color:red">Sila tekan butang CTRL+F untuk mencari jenis spesies kayu kayan</b><br><br>
                                                        ...
                                                        <div class="row" style="margin-bottom:-2%;">
                                                            ...
                                                            <div style="color: rgb(4, 0, 255)"> <b>HALAMAN 1/5</b></div>
                                                        </div>
                                                                ...
                                                                <tbody class="" style="overflow-x: auto;">
                                                                    @foreach ($kumpulan_kayu as $keyKumpulanKayu => $data)
                                                                        ...
                                                                        @foreach ($species as $keySpecies => $data1)
                                                                            @if ($data1->kumpulan_kayu->singkatan == $data->singkatan)
                                                                                <tr style="height:50px;">
                                                                                    ...
                                                                                    <td style="text-align:center;" colspan="2">
                                                                                        <input style="background-color: #ffffff; text-align:right"
                                                                        ...
                                                                        <tr style="height:50px;">
                                                                            ...
                                                                            <td style="text-align:center;" colspan="2">
                                                                                <input readonly style="background-color: #e0ec3754; text-align:right" type="text" size="10" oninput="validate(this)" id='jumlah_baki_stok.{{ $keyKumpulanKayu }}' name='jumlah_baki_stok[]' value="{{ array_sum($jumlah_baki_stok ?? []) }}">
                                                                            </td>
                                                                            <td style="text-align:center;" colspan="2">
                                                                                <input readonly style="background-color: #e0ec3754; text-align:right" type="text" size="10" oninput="validate(this)" id='jumlah_kayu_masuk.{{ $keyKumpulanKayu }}' name='jumlah_kayu_masuk[]' value="{{ array_sum($jumlah_kayu_masuk ?? []) }}">
                                                                            </td>
                                                                            <td style="text-align:center;" colspan="2">
                                                                                <input readonly style="background-color: #e0ec3754; text-align:right" type="text" size="10" oninput="validate(this)" id='total_stok_kayu_balak.{{ $keyKumpulanKayu }}' name='total_stok_kayu_balak[]' value="{{ array_sum($total_stok_kayu_balak ?? []) }}">
                                                                            </td>
                                                                            <td style="text-align:center;" colspan="2">
                                                                                <input readonly style="background-color: #e0ec3754; text-align:right" type="text" size="10" oninput="validate(this)" id='total_kayu_masuk_jentera.{{ $keyKumpulanKayu }}' name='total_kayu_masuk_jentera[]' value="{{ array_sum($total_kayu_masuk_jentera ?? []) }}">
                                                                            </td>
                                                                            <td style="text-align:center;" colspan="2">
                                                                                <input readonly style="background-color: #e0ec3754; text-align:right" type="text" size="10" oninput="validate(this)" id='total_kayu_keluar_jentera.{{ $keyKumpulanKayu }}' name='total_kayu_keluar_jentera[]' value="{{ array_sum($total_kayu_keluar_jentera ?? []) }}">
                                                                            </td>
                                                                            <td style="text-align:center;" colspan="2">
                                                                                <input readonly style="background-color: #e0ec3754; text-align:right" type="text" size="10" oninput="validate(this)" id='total_kayu_dibawa_bulan_hadapan.{{ $keyKumpulanKayu }}' name='total_kayu_dibawa_bulan_hadapan[]' value="{{ array_sum($total_kayu_dibawa_bulan_hadapan ?? []) }}">
                                                                            </td>
                                                                        </tr>
                                                                    @endforeach
                                                                </tbody>
                                            ...
                                            <div class="row form-group m-b-0">
                                                <div class="text-left col-5">
                                                    <button type="button" wire:loading.attr="disabled" class="btn btn-primary"
                                                        alt="default" data-toggle="modal" data-target="#tiada_pengeluaran"
                                        ...
                                        <div class="modal fade" id="confirmation_borang_a" tabindex="-1" role="dialog" aria-labelledby="confirmation_borang_aTitle" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header" style="background-color:#f3ce8f  !important">
                                                        <h5 class="modal-title " id="confirmation_borang_aTitle"><i style="color:rgb(255, 255, 0)" class="fas fa-exclamation-triangle"></i>&nbspPENGESAHAN</h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                    </div>
                                                    <div class="modal-body"><span class="text-center"><b>Adakah anda pasti untuk ke paparan seterusnya?</b></span></div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-danger" data-dismiss="modal">TIDAK</button>
                                                        <button type="submit" class="btn btn-success"><div>YA</div></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

                                        <div class="modal fade" id="sebelumnya_borang_a" tabindex="-1" role="dialog" aria-labelledby="sebelumnya_borang_aTitle" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header" style="background-color:#f3ce8f  !important">
                                                        <h5 class="modal-title " id="sebelumnya_borang_aTitle"><i style="color:rgb(255, 255, 0)" class="fas fa-exclamation-triangle"></i>&nbspPENGESAHAN</h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                    </div>
                                                    <div class="modal-body"><span class="text-center"><b>Adakah anda pasti untuk ke paparan sebelum ini?</b></span></div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-danger" wire:loading.attr="disabled" data-dismiss="modal">TIDAK</button>
                                                        <button type="submit" name="sebelumnya" value="1" class="btn btn-success"><div>YA</div></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

                                        <div class="modal fade" id="tiada_pengeluaran" tabindex="-1" role="dialog" aria-labelledby="tiada_pengeluaranTitle" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header" style="background-color:#f3ce8f  !important">
                                                        <h5 class="modal-title " id="tiada_pengeluaranTitle"><i style="color:rgb(255, 255, 0)" class="fas fa-exclamation-triangle"></i>&nbspPENGESAHAN</h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                    </div>
                                                    <div class="modal-body"><span class="text-center"><b>Adakah anda pasti kilang anda tiada pengeluaran?</b></span></div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-danger" data-dismiss="modal">TIDAK</button>
                                                        <button type="submit" name="tiadaPengeluaran" value="1" class="btn btn-success"><div>YA</div></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
