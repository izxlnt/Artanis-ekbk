...
@section('content')
                        ...
                        <div class="card-body">
                            ...
                            <div class="pt-5 row">
                                <div class="col-md-12">
                                    ...
                                    <h4 class="text-center">BORANG 5D- PENYATA PENGELUARAN KAYU KUMAI MENGIKUT JENIS KAYU
                                        KUMAI
                                    </h4>
                                    ...
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @foreach ($form5D as $data)
                                                        ...
                                                        @if ($shuttle->shuttle->id == $data->shuttle_id && $data->bulan == '1')
                                                            ...
                                                            @elseif($data->status == 'Sedang Diproses' && $data->bulan == '1' && $shuttle->shuttle_id == $data->shuttle_id)
                                                                <a href="{{ route('jpn.shuttle-5-view-form5D', $data->id) }}"><img
                                                            ...
                                                            @endphp
                                                                ...
                                                                @endif
                                                            @elseif($data->status == 'Lulus' && $data->bulan == '1' && $shuttle->shuttle_id == $data->shuttle_id)
                                                                @if ($data->tiada_pengeluaran == 1)
                                                                    <a
                                                                        href="{{ route('jpn.shuttle-5-view-form5D', $data->id) }}">

                                                                        <img src="{{ asset('tpcoklat.png') }}"
                                                                            height='30px' alt="" data-toggle="tooltip"
                                                                            data-placement="bottom"
                                                                            title="Borang telah diperaku IPJPSM - Tiada Pengeluaran"></a>
                                                                @else
                                                                    <a
                                                                        href="{{ route('jpn.shuttle-5-view-form5D', $data->id) }}">
                                        ...
                                        <td>
                                            @foreach ($form5D as $data)
                                                ...
                                                @if ($shuttle->shuttle->id == $data->shuttle_id && $data->bulan == '2')
                                        ...
                                        <td>
                                            @foreach ($form5D as $data)
                                                ...
                                                @if ($shuttle->shuttle->id == $data->shuttle_id && $data->bulan == '3')
                                        ...
                                        <td>
                                            @foreach ($form5D as $data)
                                                ...
                                                @if ($shuttle->shuttle->id == $data->shuttle_id && $data->bulan == '4')
                                        ...
                                        <td>
                                            @foreach ($form5D as $data)
                                                ...
                                                @if ($shuttle->shuttle->id == $data->shuttle_id && $data->bulan == '5')
                                        ...
                                        <td>
                                            @foreach ($form5D as $data)
                                                ...
                                                @if ($shuttle->shuttle->id == $data->shuttle_id && $data->bulan == '6')
                                        ...
                                        <td>
                                            @foreach ($form5D as $data)
                                                ...
                                                @if ($shuttle->shuttle->id == $data->shuttle_id && $data->bulan == '7')
                                        ...
                                        <td>
                                            @foreach ($form5D as $data)
                                                ...
                                                @if ($shuttle->shuttle->id == $data->shuttle_id && $data->bulan == '8')
                                        ...
                                        <td>
                                            @foreach ($form5D as $data)
                                                ...
                                                @if ($shuttle->shuttle->id == $data->shuttle_id && $data->bulan == '9')
                                        ...
                                        <td>
                                            @foreach ($form5D as $data)
                                                ...
                                                @if ($shuttle->shuttle->id == $data->shuttle_id && $data->bulan == '10')
                                        ...
                                        <td>
                                            @foreach ($form5D as $data)
                                                ...
                                                @if ($shuttle->shuttle->id == $data->shuttle_id && $data->bulan == '11')
                                                    ...
                                                    @endphp
                                                        ...
                                                        @else
                                                            <img src="{{ asset('package.png') }}" height='40px'
                                                                ...
                                                                title="Pakej belum dihantar">
                                                        @endif
                                                    @elseif($data->status == 'Lulus' && $data->bulan == '11' && $shuttle->shuttle_id == $data->shuttle_id)
                                                        @if ($data->tiada_pengeluaran == 1)
                                                            <a
                                                                href="{{ route('jpn.shuttle-5-view-form5D', $data->id) }}">
                                        ...
                                        <td>
                                            @foreach ($form5D as $data)
                                                ...
                                                @if ($shuttle->shuttle->id == $data->shuttle_id && $data->bulan == '12')
                                                    ...
                                                    @endphp
                                                        ...
                                                        @else
                                                            <img src="{{ asset('package.png') }}" height='40px'
                                                                ...
                                                                title="Pakej belum dihantar">
                                                        @endif
                                                    @elseif($data->status == 'Lulus' && $data->bulan == '12' && $shuttle->shuttle_id == $data->shuttle_id)
                                                        @if ($data->tiada_pengeluaran == 1)
                                                            <a
                                                                href="{{ route('jpn.shuttle-5-view-form5D', $data->id) }}">
    ...
    <script>
        function changePage() {
            ...
            window.location.href = "<?php echo URL::to('/jpn/shuttle-5-listD/" + year +"'); ?>";
        }
    </script>
