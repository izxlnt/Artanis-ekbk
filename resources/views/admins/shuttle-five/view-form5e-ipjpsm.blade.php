                                            ...
                                            <div class="col-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row"
                                                            style="justify-content: center;margin-bottom:1%;">
                                                            <div class="col-md-2">
                                                                <label>Tahun:</label>
                                                            ...
                                                            <div class="col-md-2">
                                                                ...
                                                                @if ($form5e->bulan <= '1')
                                                                    <input type="text" class="form-control"
                                                                        style="background-color: #ccebf96b;" value="Januari"
                                                                        readonly />
                                                                ...
                                                                @elseif($form5e->bulan <= '3')
                                                                    <input type="text" class="form-control"
                                                                        style="background-color: #ccebf96b;" value="Mac"
                                                                        readonly />
                                                                @elseif($form5e->bulan <= '4')
                                                                    <input type="text" class="form-control"
                                                                        style="background-color: #ccebf96b;" value="April"
                                                                        readonly />
                                                                @elseif($form5e->bulan <= '5')
                                                                    <input type="text" class="form-control"
                                                                        style="background-color: #ccebf96b;" value="Mei"
                                                                        readonly />
                                                                @elseif($form5e->bulan <= '6')
                                                                    <input type="text" class="form-control"
                                                                        style="background-color: #ccebf96b;" value="Jun"
                                                                        readonly />
                                                                @elseif($form5e->bulan <= '7')
                                                                    <input type="text" class="form-control"
                                                                        style="background-color: #ccebf96b;" value="Julai"
                                                                        readonly />
                                                                @elseif($form5e->bulan <= '8')
                                                                    <input type="text" class="form-control"
                                                                        style="background-color: #ccebf96b;" value="Ogos"
                                                                        readonly />
                                                                ...
                                                                @elseif($form5e->bulan <= '10')
                                                                    <input type="text" class="form-control"
                                                                        style="background-color: #ccebf96b;" value="Oktober"
                                                                        readonly />
                                                        ...
                                                        <br>
                                                        <form action="{{ route('update_status_form5E_ipjpsm', $id) }}"
                                                            method="post">
                                                            @csrf
                                                            <div class="row">
                                                                        ...
                                                                        <table>
                                                                            ...
                                                                            <tr style="height:50px;">
                                                                                <td style="text-align:center;"
                                                                                    class="">1.</td>
                                                                                <td style="" class="">Jumlah
                                                                                    kayu kumai yang dijual dalam pasaran
                                                                                    tempatan</td>
                                                                                <td style="text-align:center;padding:10px">
                                                                                    <input
                                                                                        wire:model='jumlah_jualan_pasaran_tempatan'
                                                                                        readonly
                                                                                        style="text-align:right;background-color: #9ac4f7; "
                                                                                        type="text" size="15"
                                                                                        value="{{ number_format($form5e->jumlah_jualan_pasaran_tempatan ?? '0.00', 2) }}">
                                                                                    <input
                                                                                        name='jumlah_jualan_pasaran_tempatan_cleaning'
                                                                            ...
                                                                            <tr style="height:50px;">
                                                                                ...
                                                                                <td style="text-align:center;padding:10px">
                                                                                    <input
                                                                                        ...
                                                                                        style="text-align:right;background-color: #9ac4f7; "
                                                                                        type="text" size="15"
                                                                                        value="{{ number_format($form5e->jumlah_jualan_eksport ?? '0.00', 2) }}">

                                                                                    <input
                                                                                        name='jumlah_jualan_eksport_cleaning'
                                                                                        oninput="validate(this)"
                                                                                        onkeypress="return isNumberKey(event)"
                                                                                        style="text-align:right" type="text"
                                                                                        size="15">
