...
@section('content')
                        ...
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <a type="button" href="{{ route('shuttle-5-listC', date('Y')) }}"
                                            class="btn"
                                            style="background-color:#faee41f3;color:black;border-color:#bbb235f3">Borang
                                            5C</a>
                            ...
                            <div class="pt-5 row">
                                <div class="col-md-12">
                                    ...
                                    <h4 class="text-center">PERAKUAN MAKLUMAT BORANG 5C - PENYATA KEMASUKAN & PEMPROSESAN
                                        KAYU GERGAJI
                                                            ...
                                                            @elseif($data->status == 'Dihantar ke IPJPSM')
                                                                ...
                                                                @if ($current_batch->status == 'Dihantar ke IPJPSM' && $current_batch->borang_c == 2)
                                                                    @if ($data->tiada_pengeluaran == 1)
                                                                        <a
                                                                            href="{{ route('ipjpsm.shuttle-3-view-formC', $data->id) }}">
                                                                    ...
                                                                    @else
                                                                        <a href="{{ route('ipjpsm.shuttle-3-view-formC', $data->id) }}"
                                                    ...
                                                    @foreach ($formC as $data)
                                                        ...
                                                        @if ($shuttle->id == $data->shuttle_id && $data->bulan == '10')
                                                            ...
                                                            @elseif($data->status == 'Dihantar ke IPJPSM')
                                                                ...
                                                                @endphp @if ($current_batch->status == 'Dihantar ke IPJPSM' && $current_batch->borang_c == 2)
                                                                    @if ($data->tiada_pengeluaran == 1)
                                                                        <a
                                                                            href="{{ route('ipjpsm.shuttle-3-view-formC', $data->id) }}">
                                                                            <img src="{{ asset('tpbiru.png') }}"
                                            ...
                                            @foreach ($formC as $data)
                                                ...
                                                @if ($shuttle->id == $data->shuttle_id && $data->bulan == '11')
                                                    ...
                                                    @elseif($data->status == 'Sedang Diisi')
                                                        <img src="{{ asset('circle_times.png') }}"
                                                                            height='30px' alt=""
                                                            style="color: yellow; font-size: 25pt;" data-toggle="tooltip"
                                                            data-placement="bottom" title="Borang sedang diisi"></i>
                                                    ...
                                                    @elseif($data->status == 'Dihantar ke IPJPSM')
                                                        ...
                                                        @if ($current_batch->status == 'Dihantar ke IPJPSM' && $current_batch->borang_c == 2)
                                                            ...
                                                            @else
                                                                <a href="{{ route('ipjpsm.shuttle-3-view-formC', $data->id) }}"
                                                                    class="btn btn-warning"> <img src="{{ asset('check.png') }}" height='30px' alt=""
                                                                        style="color: white; font-size: 18pt;"
                                                                        data-toggle="tooltip" data-placement="bottom"
                                                                        title="Borang perlu diperaku"></i></a>
                                                            @endif
                                                    ...
                                                    @elseif($data->status == 'Tiada Pengeluaran')
                                                        <img src="{{ asset('check.png') }}" height='30px' alt="" style="color: #dbd400; font-size: 20pt;"
                                                            data-toggle="tooltip" data-placement="bottom"
                                                            title="Tiada Pengeluaran "></i>
                                                    @else
                                                        <img src="{{ asset('calendar.png') }}" height='30px' alt=""
                                                ...
                                                @if ($shuttle->id == $data->shuttle_id && $data->bulan == '12')
                                                    ...
                                                    @elseif($data->status == 'Dihantar ke IPJPSM')
                                                        ...
                                                        @if ($current_batch->status == 'Dihantar ke IPJPSM' && $current_batch->borang_c == 2)
                                                            ...
                                                            @else
                                                                <a href="{{ route('ipjpsm.shuttle-4-view-formC', $data->id) }}"
                                                                    class="btn btn-warning"> <img src="{{ asset('check.png') }}" height='30px' alt=""
                                                                        style="color: white; font-size: 18pt;"
                                                                        data-toggle="tooltip" data-placement="bottom"
                                                                        title="Borang perlu diperaku"></i></a>
    ...
    <script>
        function changePage() {
            ...
            window.location.href = "<?php echo URL::to('/admin/shuttle-5-listC/" + year +"'); ?>";
        }
    </script>
