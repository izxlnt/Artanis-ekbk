...
@section('content')
                        ...
                        <div class="card-body">
                            ...
                            <div class="pt-5 row">
                                <div class="col-md-12">
                                    ...
                                    <h4 class="text-center">BORANG 5C - PENYATA KEMASUKAN & PEMPROSESAN KAYU GERGAJI DAN PENGELUARAN KAYU
    ...
    <script>
        function changePage() {
            ...
            window.location.href = "<?php echo URL::to('/phd/shuttle-5-listC/" + year +"'); ?>";
        }
    </script>
