...
@section('content')
                    ...
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <a type="button" href="{{ route('phd.shuttle-5-listD', date('Y')) }}"
                                            class="btn"
                                            style="background-color:rgb(33, 235, 77);color:black;border-color:#1b9e21f3">Borang 5D</a>
                            ...
                            <div class="pt-5 row">
                                ...
                                <h4 class="text-center">BORANG 5D- PENYATA PENGELUARAN KAYU KUMAI MENGIKUT JENIS KAYU KUMAI
                                    </h4>
                                                    ...
                                                    @foreach ($formD as $data)
                                                        ...
                                                        @elseif($data->status =="Dihantar ke IPJPSM" && $data->bulan ==
                                                            ...
                                                            <a href="{{ route('phd.shuttle-5-view-formD-phd', $data->id) }}">
                                                                <img src="{{ asset('tpbiru.png') }}" height='30px'alt="" data-toggle="tooltip"
                                                                data-placement="bottom" title="Borang telah disahkan PHD - Tiada Pengeluaran">
                                                            </a>
                                                            @else
                                                            <a href="{{ route('phd.shuttle-5-view-formD-phd', $data->id) }}">
    ...
    <script>
        function changePage() {
            ...
            window.location.href = "<?php echo URL::to('/phd/shuttle-5-listD/" + year +"'); ?>";
        }
    </script>
