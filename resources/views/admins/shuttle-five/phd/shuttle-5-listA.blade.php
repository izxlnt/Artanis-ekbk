...
@section('content')
                                        ...
                                        @foreach ($formA as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('phd.shuttle-3-view-formA-phd', $data->id) }}">
                                                    <img src="{{ asset((!empty($data->tiada_pengeluaran) && $data->tiada_pengeluaran == 1) ? 'tpcoklat.png' : 'double_check.png') }}" height='30px' alt="" style="color: green; font-size: 20pt;"
                                                        data-toggle="tooltip" data-placement="bottom"
    ...
    <script>
        function changePage() {
            ...
            window.location.href = "<?php echo URL::to('/phd/shuttle-5-listA/" + year +"'); ?>";
        }
    </script>
