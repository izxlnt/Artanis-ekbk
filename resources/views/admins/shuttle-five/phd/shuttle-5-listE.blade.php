...
@section('content')
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <a type="button" href="{{ route('phd.shuttle-5-listE', date('Y')) }}"
                                            class="btn"
                                            style="background-color:#58afe9f3;color:black;border-color: #2692ebf3">Borang 5E</a>
                                    </div>
                                </div>
                            </div>
                            <div class="pt-5 row">
                                ...
                                <h4 class="text-center">BORANG 5E - PENYATA PENJUALAN KAYU KUMAI
                                        DALAM PASARAN TEMPATAN DAN EKSPORT
                                    </h4>
                                                ...
                                                <td>
                                                    @foreach ($formD as $data)
                                                        ...
                                                        @elseif($data->status =="Tiada Pengeluaran" && $data->bulan
                                                            ...
                                                            <a href="{{ route('phd.shuttle-5-view-formE', $data->id) }}"><img src="{{ asset('circle_times_yellow.png') }}" height='30px' alt="" data-toggle="tooltip" data-placement="bottom" title="Borang perlu disahkan PHD"></a>
    ...
    <script>
        function changePage() {
            ...
            window.location.href = "<?php echo URL::to('/phd/shuttle-5-listE/" + year +"'); ?>";
        }
    </script>
