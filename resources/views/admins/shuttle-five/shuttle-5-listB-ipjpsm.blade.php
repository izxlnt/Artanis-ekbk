...
@section('content')
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    @foreach ($returnArr['breadcrumbs'] as $breadcrumb)
                                        ...
                                        @else
                                        <li class="breadcrumb-item active" aria-current="page" style="color: #dbd400 !important;">
                                            {{ $breadcrumb['name'] }}
                                        </li>
                                        @endif
                                    @endforeach
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <h4 class="text-center">PERAKUAN MAKLUMAT BORANG 5B - JUMLAH GUNA TENAGA PADA AKHIR BULAN
                                </h4>
                            </div>
    ...
    <script>
        function changePage() {
            ...
            window.location.href = "<?php echo URL::to('/admin/shuttle-5-listB/" + year +"'); ?>";
        }
    </script>
