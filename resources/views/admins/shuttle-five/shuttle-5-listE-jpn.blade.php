...
@section('content')
                        ...
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <a type="button" href="{{ route('jpn.shuttle-5-listE-jpn', date('Y')) }}"
                                            class="btn"
                                            style="background-color:#58afe9f3;color:black;border-color:#2692ebf3">Borang
                                            5E</a>
                            ...
                            <div class="pt-5 row">
                                <div class="col-md-12">
                                    ...
                                    <h4 class="text-center">BORANG 5E- PENYATA PENJUALAN KAYU KUMAI DALAM PASARAN
                                                    ...
                                                    @foreach ($formE as $data)
                                                        @if ($shuttle->shuttle->id == $data->shuttle_id && $data->bulan == '1')
                                                            ...
                                                            @elseif($data->status == 'Dihantar ke IPJPSM')
                                                                <a
                                                                    href="{{ route('jpn.shuttle-5-view-form5E', $data->id) }}">
    ...
    <script>
        function changePage() {
            ...
            window.location.href = "<?php echo URL::to('/admin/shuttle-5-listE/" + year +"'); ?>";
        }
    </script>
