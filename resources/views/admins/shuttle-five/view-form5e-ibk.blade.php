                ...
                <div class="col-md-12">
                    <div class="rounded-lg card" style="border-color: #000000 !important;">
                        <div class="card-header"
                            ...
                            BORANG 5E - PENYATA PENJUALAN KAYU KUMAI<br> DALAM PASARAN TEMPATAN DAN EKSPORT
                        </div>
                        <div class="card-body">
                            <!-- Tab panes -->
                                                                ...
                                                                <center>
                                                                    <table>
                                                                        <tr style="height:50px;">
                                                                            <th style="text-align:center;background-color: #9ac4f7; width:80px;"
                                                                        ...
                                                                        <tr style="height:50px;">
                                                                            <th style="text-align:center;"
                                                                                class="">1.</th>
                                                                            <td style="" class="">Jumlah kayu
                                                                                kumai yang dijual dalam pasaran tempatan
                                                                            </td>
