                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="pt-5 row">
                                <div class="col-md-12">
                                    <h4 class="text-center"> BORANG 4D - PENYATA PENGELUARAN DARIPADA JENTERA <BR>
                                                    ...
                                                    @foreach ($form5D as $data)
                                                        ...
                                                        @if ($shuttle->id == $data->shuttle_id)
                                                            ...
                                                            @elseif($data->status =="Dihantar ke IPJPSM" &&
                                                                ...
                                                                $data->shuttle_id)
                                                                <a href="{{ route('ipjpsm.shuttle-3-view-form5D', $data->shuttle_id) }}"
                                            ...
                                            @foreach ($form5D as $data)
                                                @if ($shuttle->id == $data->shuttle_id)
                                                    ...
                                                    @elseif($data->status =="Tiada Pengeluaran" && $data->bulan
                                                        ...
                                                        <a href="{{ route('phd.shuttle-3-view-form5D', $data->id) }}"
                                                            class="btn btn-primary"><i class="fas fa-eye"
                                                                style="color: white; font-size: 18pt;" data-toggle="tooltip"
                                                                data-placement="bottom"
                                                                title="Borang perlu disahkan"></i></a>
