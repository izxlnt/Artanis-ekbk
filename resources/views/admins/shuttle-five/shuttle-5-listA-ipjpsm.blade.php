...
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body" style="width: 100%">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    class="btn" style="background-color:rgb(196, 188, 186);color:black;border-color:black">Borang 5A</a>
                                <a type="button" href="{{ route('shuttle-5-listB', date('Y')) }}"
                                    class="btn" style="background-color:white;color:black;border-color:#ee8dcd">Borang 5B</a>
                                ...
                                <a type="button" href="{{ route('shuttle-5-listE', date('Y')) }}"
                                    class="btn" style="background-color:white;color:black;border-color:#2692ebf3">Borang 5E</a>
                        ...
                        <div>
                            ...
                            <h4 class="text-center">PERAKUAN MAKLUMAT BORANG 5A - MAKLUMAT KILANG KAYU KUMAI</h4>
                        </div>
    ...
    <script>
        function changePage() {
            ...
            window.location.href = "<?php echo URL::to('/admin/shuttle-5-listA/" + year +"'); ?>";
        }
    </script>
