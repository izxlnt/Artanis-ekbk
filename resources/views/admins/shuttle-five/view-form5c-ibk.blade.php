                                                                ...
                                                                <tr style="height:50px;">
                                                                    ...
                                                                    <th style="text-align:center;" colspan="2">Baki Stok
                                                                        ...
                                                                        <tbody class="">
                                                                            ...
                                                                            <tr style="height:50px;">
                                                                                <th style="text-align:center;width: 289px;">{{ $data->singkatan }} </th>
                                                                            ...
                                                                            @foreach ($species as $keySpecies=>$data1)
                                                                                ...
                                                                                @if($data1->kumpulan_kayu->singkatan == $data->singkatan)
                                                                                    ...
                                                                                    <tr style="height:50px;">
                                                                                        ...
                                                                                        <td style="text-align:center;" colspan="2"><input readonly type="text" size="10" style="background-color: #e0ec3754; text-align:right" value="{{ isset($form_c[$data1->id]) ? number_format($form_c[$data1->id]->baki_stok,2) : '0.00' }}" ></td>
                                                                                        <td style="text-align:center;" colspan="2"><input readonly type="text" size="10" style="background-color: #ffffff;text-align:right" value="{{ isset($form_c[$data1->id]) ? number_format($form_c[$data1->id]->kayu_masuk,2) : '0.00' }}" ></td>
                                                                                        <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;text-align:right" type="text" size="10" value="{{ isset($form_c[$data1->id]) ? number_format($form_c[$data1->id]->jumlah_stok_kayu_balak,2) : '0.00' }}"></td>
                                                                                        <td style="text-align:center;" colspan="2"><input readonly type="text" size="10" style="background-color: #ffffff;text-align:right" value="{{ isset($form_c[$data1->id]) ? number_format($form_c[$data1->id]->proses_masuk,2) : '0.00' }}" ></td>
                                                                                        <td style="text-align:center;" colspan="2"><input readonly type="text" size="10" style="background-color: #ffffff;text-align:right" value="{{ isset($form_c[$data1->id]) ? number_format($form_c[$data1->id]->proses_keluar,2) : '0.00' }}" ></td>
                                                                                        <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;text-align:right" type="text" size="10" value="{{ isset($form_c[$data1->id]) ? number_format($form_c[$data1->id]->baki_stok_kehadapan,2) : '0.00' }}"></td>
                                                                                    </tr>
                                                                        ...
                                                                        <tr style="height:50px;">
                                                                            ...
                                                                            <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;" type="text" size="10" wire:model='jumlah_besar_kemasukan_kayu_ke_kilang' value="0.00"></td>
                                                                            <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;" type="text" size="10" wire:model='jumlah_besar_stok_kayu_balak' value="0.00"></td>
                                                                            <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;" type="text" size="10" wire:model='jumlah_besar_kayu_ke_dalam_jentera' value="0.00"></td>
                                                                            ...
                                                                            <td style="text-align:center;" colspan="2"><input readonly style="background-color: #e0ec3754;" type="text" size="10" wire:model='jumlah_besar_baki_stok_bulan_depan' value="0.00"></td>
                                                                        </tr>
                                                                        @else
                                                                        <tr style="height:50px;">
                                                                            <th style="text-align:center;" colspan="2"> Jumlah Besar </th>
