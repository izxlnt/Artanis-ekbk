                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="pt-5 row">
                                <div class="col-md-12">
                                    <h4 class="text-center"> BORANG 4E - PENYATA PENJUALAN PAPAN LAPIS/VENIR DALAM PASARAN TEMPATAN DAN
                                        EKSPORT
                            ...
                            <div class="table-responsive">
                                <table id="example" class="display text-center" style="width:100%">
                                    ...
                                    <tbody>
                                        @foreach ($form5E_kilang as $shuttle)
                                            <tr>
                                                <td>{{ $loop->index + 1 }}</td>
                                                    ...
                                                    @foreach ($form5E as $data)
                                                        ...
                                                        @if ($shuttle->id == $data->shuttle_id)
                                                            ...
                                                            @elseif($data->status =="Dihantar ke IPJPSM" &&
                                                                ...
                                                                $data->shuttle_id)
                                                                <a href="{{ route('ipjpsm.shuttle-3-view-form5E', $data->shuttle_id) }}"
                                            ...
                                            @foreach ($form5E as $data)
                                                @if ($shuttle->id == $data->shuttle_id)
                                                    ...
                                                    @elseif($data->status =="Tiada Pengeluaran" && $data->bulan
                                                        ...
                                                        <a href="{{ route('phd.shuttle-3-view-form5E', $data->id) }}"
                                                            class="btn btn-primary"><i class="fas fa-eye"
                                                                style="color: white; font-size: 18pt;" data-toggle="tooltip"
                                                                data-placement="bottom"
                                                                title="Borang perlu disahkan"></i></a>
