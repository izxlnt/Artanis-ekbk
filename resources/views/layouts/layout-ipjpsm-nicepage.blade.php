                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <div class="text-white d-flex no-block align-items-center p-15 m-b-10"
                                    ...
                                    <div class="m-l-10">
                                        <h4 class="m-b-0">{{ optional(Auth::user())->name }}</h4>
                                        <p class=" m-b-0">{{ optional(Auth::user())->email }}</p>
                                        <p class=" m-b-0">{{ optional(Auth::user())->bahagian }}</p>


                                    </div>
                                </div>
                                <a class="dropdown-item" href="{{ route('ipjpsm.kemaskini-profil') }}">
                    ...
                    <ul id="sidebarnav">
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                ...
                                <li class="sidebar-item"><a href="javascript:void(0)"
                                        class="sidebar-link has-arrow waves-effect waves-dark">&nbsp&nbsp&nbsp<i
                                            class="fas fa-folder-open"></i>&nbsp&nbsp<span class="hide-menu">
                                            Senarai Penuh Maklumat Borang
                                        </span></a>
                                    <ul aria-expanded="false" class="collapse second-level">
                                ...
                                {{-- <li class="sidebar-item"><a href="{{ route('getreport_senaraikilang') }}" class="sidebar-link"><i
                                    class="mdi mdi-file-document"></i><span class="hide-menu"> Laporan Data Lama
                                </span></a></li> --}}
                                ...
                                <li class="sidebar-item"><a href="#"
                                    ...
                                    <ul aria-expanded="false" class="collapse second-level">
                                        ...
                                        <li class="sidebar-item"><a href="{{ route('daerah') }}"
                                                class="sidebar-link"><i class="fas fa-user-check"></i><span
                                                    class="hide-menu">&nbsp Tetapan Daerah</span></a></li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                ...
                                <li class="sidebar-item"><a
                                        href="{{ route('ipjpsm.status-permohonan-shuttle-3-kilang') }}"
                                        class="sidebar-link"><i class="mdi mdi-account-box"></i><span
                                            class="hide-menu"> Pengesahan Permohonan ID Pengguna
                                        </span></a></li>

                                <li class="sidebar-item"><a href="{{ route('ipjpsm.senaraikilang3') }}"
                                        class="sidebar-link"><i class="mdi mdi-account-box"></i><span
