...
<head>
    ...
    <!-- Custom CSS -->
    <link href="{{ asset('nice-admin/dist/css/style.min-formB.css') }}" rel="stylesheet">
                        ...
                        <ul id="sidebarnav">
                            ...
                            @if (auth()->user()->shuttle_type == '3')
                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                        ...
                                        aria-expanded="false"><i class="mdi mdi-home-variant"></i><span
                            ...
                            @if (auth()->user()->shuttle_type == '3')
                                ...
                                @elseif(auth()->user()->shuttle_type == '4')
                                    {{-- <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                        href="{{ route('user.shuttle-4-listB') }}"" aria-expanded="false"><i class="mdi mdi-mdi-autorenew"></i><span
                            class="hide-menu" style="padding-left: 10px;">Status Borang</span></a> --}}
