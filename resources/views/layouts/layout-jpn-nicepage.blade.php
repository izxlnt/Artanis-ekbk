                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <div class="text-white d-flex no-block align-items-center p-15 m-b-10"
                                    ...
                                    <div class="m-l-10">
                                        ...
                                        <p class=" m-b-0">{{ Auth::user()->jawatan }}</p>
                                        {{-- <p class=" m-b-0">Pengguna</p> --}}
                                    </div>
                                </div>
                                <a class="dropdown-item" href="{{ route('jpn.kemaskini-profil') }}">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                                href="javascript:void(0)" aria-expanded="false"><i class="fas fa-folder"></i><span
                                    class="hide-menu" style="padding-left: 10px;">Pemantauan Maklumat</span></a>
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                ...
                                {{-- <li class="sidebar-item"><a href="#" class="sidebar-link">&nbsp&nbsp&nbsp<i
                                            class="fas fa-file"></i>&nbsp&nbsp&nbsp&nbsp<span
                                            class="hide-menu">&nbsp Status Borang</span></a>
                                </li> --}}
                        ...
                        {{-- <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark"
                                href="{{ route('jpn.shuttle-3-listA-jpn', date('Y')) }}" aria-expanded="false"><i
                                    class="mdi mdi-home-variant"></i><span class="hide-menu"
                                    style="padding-left: 10px;">Pemantauan Maklumat</span></a>
