...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="text-center card-header" style="background-color: #f3ce8f;">
                  ...
                  @endif --}}
                            ...
                            <div class="row" style="padding-top: 15px;">
                                ...
                                <div class="col-md">
                                    ...
                                    <div class="mb-3 input-group">
                                        <input readonly
                                            class="form-control  @error('name') is-invalid @else border-dark @enderror"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md">
                                    ...
                                    <div class="mb-3 input-group">
                                        <input readonly
                                            class="form-control  @error('name') is-invalid @else border-dark @enderror"
                                            id="name" name="name" type="text" value="{{ $info->nama_kilang }}"
                                            oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);">
                                        @error('name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md">
                                    ...
                                    <div class="mb-3 input-group">
                                        <input readonly
                                            class="form-control  @error('name') is-invalid @else border-dark @enderror"
                                            id="name" name="name" type="text" value="{{ $info->no_ssm }}"
                                            oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);">
                                        @error('name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md">
                                    ...
                                    <div class="mb-3 input-group">
                                        <input readonly
                                            class="form-control  @error('name') is-invalid @else border-dark @enderror"
                                            id="name" name="name" type="text" value="{{ $info->no_lesen }}"
                                            oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);">
                                        @error('name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md">
                                    <label>Jantina</label>
                                    <div class="mb-3 input-group">
                                        <input readonly class="form-control border-dark" id="jantina" name="jantina"
                                            type="text" value="{{ $pengguna->jantina }}"
                                            oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md">
                                    ...
                                    <div class="mb-3 input-group">
                                        <input readonly class="form-control border-dark" id="warganegara"
                                            name="warganegara" type="text" value="{{ $pengguna->warganegara }}"
                                            oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md">
                                    <label>Kaum</label>
                                    <div class="mb-3 input-group">
                                        <input readonly class="form-control border-dark" id="kaum" name="kaum"
                                            type="text" value="{{ $pengguna->kaum }}"
                                            oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md">
                                    ...
                                    <div class="mb-3 input-group">
                                        <input readonly
                                            class="form-control  @error('ic_number') is-invalid @else border-dark @enderror"
                                            id="ic_number" name="ic_number" type="text"
                                            value="{{ $pengguna->no_kad_pengenalan }}"
                                            oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md">
                                    <label>Emel</label>
                                    <div class="mb-3 input-group">
                                        <input class="form-control  @error('email') is-invalid @else border-dark @enderror"
                                            id="email" name="email" type="email"
                                            value="{{ $user->getCurrentEmail() }}" oninput="validateEmail(this)">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <img src="{{ asset($image_path = str_replace('public', 'storage', $pengguna->gambar_ic_hadapan)) }}"
                                        alt="Sila Muatnaik Gambar Sijil SSM" id="category-img-ssm"
                                        style="width:70%;height:30vh;">
                                </div>
                                <div class="col-md-4">
                                    <p>Gambar Dimuat Naik:</p>
                                    <img src="{{ asset($image_path = str_replace('public', 'storage', $pengguna->gambar_ic_belakang)) }}"
                                        alt="Sila Muatnaik Gambar Lesen Kilang" id="category-img-tag-lesenkilang"
                                        style="width:70%;height:30vh;">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md">
                                    ...
                                    <div class="mb-3 input-group">
                                        <input class="form-control  @error('email') is-invalid @else border-dark @enderror"
                                            name="jawatan" value="{{ $pengguna->jawatan }}"
                                            oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md">
                                    ...
                                    <div class="mb-3 input-group">
                                        <input class="form-control  @error('email') is-invalid @else border-dark @enderror"
                                            name="no_pekerja" value="{{ $pengguna->no_pekerja }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <label for="wphoneNumber2" class="">Muat Naik Gambar
                                        ...
                                        <input type="file" id="gambar_passport" name="gambar_passport"
                                            accept="image/jpeg,image/jpg,image/png" style="display: none" required
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <p>Gambar Dimuat Naik:</p>
                                    <img src="{{ asset($image_path = str_replace('public', 'storage', $pengguna->gambar_passport)) }}"
                                        alt="Sila Muatnaik Gambar Sijil SSM" id="category-img-ssm"
                                        style="width:70%;height:30vh;">
                                </div>
                            </div>
                            ...
                            <div class="row" style="padding-top: 35px;">
                                ...
                                <div class="col-md" style="text-align: center;">
                                    <button type="button" class="btn waves-effect waves-light btn-info btn-block"
                                        data-toggle="modal" data-target="#confirmation">Kemaskini Profil Pengguna</button>
                                </div>
                                <div class="col-md-4"></div>
                            </div>
                                ...
                                <div class="modal-content">
                                    <div class="modal-header" style="background-color:#f3ce8f  !important">
                                        <h5 class="modal-title" id="exampleModalLongTitle"><i
                                                ...
                                                style="color:rgb(255, 255, 0)"></i>&nbspPENGESAHAN</h5>
