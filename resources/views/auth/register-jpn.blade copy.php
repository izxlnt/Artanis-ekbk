            ...
            <div class="row" style="width: 1000px;">
                <div class="col-md-12">
                    ...
                    <div class="card" style="background: #d0edfdcc;">
                        <div class="card-header text-center bg-info" style="font-weight: bold;">Pendaftaran Jabatan Perhutanan Negeri (JPN)</div>
                        <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="name" name="name"
                                            placeholder="Nama Pengguna" value="{{ old('name') }}" required>
                                    </div>
                                    @error('name')
                                        <div class="alert alert-danger">
                                            <strong>{{ $message }}</strong>
