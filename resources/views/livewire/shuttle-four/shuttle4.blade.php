                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <select name="form_type" class="form-control" wire:model='form_type' id="form_type">
                                    <option value="4A">Form 4A</option>
                                    <option value="4B">Form 4B</option>
                                    <option value="4C">Form 4C</option>
                                    <option value="4D">Form 4D</option>
                                    <option value="4E">Form 4E</option>
                                </select>
                            </div>
                        </div>
                        <br>
