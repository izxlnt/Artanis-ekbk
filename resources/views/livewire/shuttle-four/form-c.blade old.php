                        ...
                        <div class="rounded-lg card" style="border-color: #000000 !important;">
                            <div class="card-header"
                             style="text-align:center; background-color: #f0e10dbd !important; font-size: 130%; font-weight: bold;">
                                Borang 4C -PENYATA KEMASUKAN & PEMPROSESAN KAYU BALAK <BR> MENGIKUT KUMPULAN KAYU-KAYAN
                            </div>
                            <div class="card-body">
                                <!-- Tab panes -->
                                                            ...
                                                            <form class="form-horizontal" wire:submit.prevent='store'>
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <label>Bulan:</label>
                                                                            <input type="text" class="form-control" style="background-color: #e0ec3754;" value="{{ now('M') }}" readonly />
                                                                        </div>
                                                                    </div>
                                                                    <br>
