                        ...
                        <div class="rounded-lg card" style="border-color: #000000 !important;">
                            @if ($kilang_info->shuttle_type == '3')
                                <div class="card-header"
                                    ...
                                    BORANG 3C - PENYATA KEMASUKAN & PEMPROSESAN KAYU BALAK <br> DAN PENGELUARAN KAYU
                                    GERGAJI
                            ...
                            @elseif($kilang_info->shuttle_type == '4')
                                <div class="card-header"
                                    style="text-align:center; background-color: #f0e10dbd !important; font-size: 130%; font-weight: bold;">
                                    BORANG 4C - PENYATA KEMASUKAN & PEMPROSESAN KAYU BALAK <br>
                                    MENGIKUT KUMPULAN KAYU-KAYAN
                                </div>
                                    ...
                                    <div class="tab-pane active" id="hotel" role="tabpanel" aria-labelledby="hotel-tab">
                                        ...
                                        <table class="table table-striped table-bordered ex3" id="">
                                            <div class="row">
                                                        ...
                                                        <form class="form-horizontal" wire:submit.prevent='store'
                                                            ...
                                                            <div class="card-body">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <div class="legend"
                                                                            ...
                                                                            <b>KKB/HHW</b>: Kayu Keras Berat / <i>Heavy
                                                                                Hardwood</i> <br>
                                                                            <b>KKS/MHW</b>: Kayu Keras Sederhana /
                                                                            <i>Medium Hardwood</i> <br>
                                                                            ...
                                                                            <br>
                                                                            <br>
                                                                            <b style="color:red">Sila tekan butang
                                                                                CTRL+F untuk mencari jenis spesies kayu
                                                                                kayan</b>
                                                                ...
                                                                <div class="row" style="margin-bottom:-2%;">
                                                                    ...
                                                                    <div style="color: rgb(4, 0, 255)"> <b>HALAMAN 1/5
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <table>
                                                                        <thead class="">
                                                                            <tr style="height:50px;">
                                                                                ...
                                                                                <th style="text-align:center;"
                                                                                    colspan="2">Kemasukan Kayu Balak Ke
                                                                                    Dalam Jentera Memproses (dikupas)
                                                                                </th>
                                                                                <th style="text-align:center;"
                                                                        ...
                                                                        <tbody class="">
                                                                            @foreach ($kumpulan_kayu as $keyKumpulanKayu => $data)
                                                                                <tr style="height:50px;">
                                                                                    <th
                                                                                        style="text-align:center;width: 489px;">
                                                                                        {{ $data->singkatan }} </th>
                                                                                    <th
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <span class="text-center"><b>Adakah anda pasti untuk ke
                                                                    paparan senarai Borang 4C?</span>

                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-danger" wire:loading.attr="disabled"
                                                                    data-dismiss="modal">TIDAK</button>
                                                                <button type="button" wire:click="$emit('sebelumnya')" wire:loading.attr="disabled"
                                                ...
                                                <div class="modal fade" id="tiada_pengeluaran" tabindex="-1"
                                                    role="dialog" aria-labelledby="tiada_pengeluaranTitle"
                                                    aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header"
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <span class="text-center"><b>Adakah anda pasti kilang
                                                                    anda tiada pengeluaran?</span>

                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-danger"
                                                                    data-dismiss="modal">TIDAK</button>
                                                                <button type="button" wire:click="tiadaPengeluaran" wire:loading.attr="disabled"
                                                                    class="btn btn-success">YA</button>
                                                            </div>
                                                        </div>
                                                    </div>
