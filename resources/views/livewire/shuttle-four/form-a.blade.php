                                            ...
                                            <div class="card">
                                                ...
                                                <form class="form-horizontal">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                ...
                                                                <select class="form-control" wire:model='daerah_id'>
                                                                    <option value="" disabled hidden>Sila Pilih Daerah
                                                                    </option>
                                                                    @forelse ($district as $data )
                                                                    <option value="{{ $data->id }}">{{ $data->bandar }}
                                                                    </option>
                                                                    @empty
                                                                ...
                                                                <select class="form-control" wire:model='daerah_id'
                                                                    ...
                                                                    @forelse ($district as $data )
                                                                    <option value="">{{ $data->bandar }}</option>
                                                                    @empty
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="com1" class="text-right col-sm-4 control-label col-form-label">Poskod</label>
                                                            <div class="col-sm-3">
                                                            ...
                                                            <label for="com1" class="text-right col-sm-1 control-label col-form-label">Daerah</label>
                                                            <div class="col-sm-3">
                                                            ...
                                                            <select class="form-control"
                                                                ...
                                                                <option value="{{ $data->bandar }}">{{ $data->bandar }}
                                                                </option>
                                                                @empty
                                                                @endforelse
                                                            </select>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <label for="com1"
                                                                ...
                                                                @else
                                                                <select class="form-control"
                                                                    wire:model='alamat_surat_menyurat_daerah' disabled
                                                                    style="width:150px;text-align: center">
                                                                    <option value="" disabled hidden>Pilih Daerah</option>
                                                                    @forelse ($poskod_surat_menyurat as $data)
                                                                    <option value="{{ $data->bandar }}">{{ $data->bandar }}
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="abpro"
                                                                class="text-right col-sm-6 control-label col-form-label">Lokasi
                                                                Kilang</label>
                                                            <div class="col-sm-12">
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                        ...
                                        <div class="col-12">
                                            <div class="card">
                                                ...
                                                <form class="form-horizontal">
                                                    <div class="card-body">
                                                        <h4 class="card-title" style="text-align: center">Maklumat
                                                            Kilang Papan (Bahagian B)</h4>
                                                        <div class="form-group row">
                                                            <label for="fname"
                                                                class="text-right col-sm-3 control-label col-form-label">No.
                                                                Telefon</label>
                                                            <div class="col-sm-4">
                                                                <input type="text" class="form-control" wire:model='no_telefon'
                                                        ...
                                                        <div class="form-horizontal">
                                                            <div class="form-group row">
                                                                <label for="fname"
                                                                    ...
                                                                    Faks</label>
                                                                <div class="col-sm-4">
                                                                    <input type="text" class="form-control" wire:model='no_faks'
                                                                        placeholder="No. Faks">
                                                                        @error('no_faks')
                                                                        <div class="alert alert-danger">
                                                                            <strong>{{ $message }}</strong>
                                                        ...
                                                        <div class="form-horizontal">
                                                            <div class="form-group row">
                                                                <label for="fname"
                                                                    ...
                                                                    Lesen</label>
                                                                <div class="col-sm-7">
                                                                    <input type="text" class="form-control" wire:model='no_lesen'
                                                                        placeholder="Tahun">
                                                                        @error('no_lesen')
                                                                        <div class="alert alert-danger">
                                                                            <strong>{{ $message }}</strong>
                                                        ...
                                                        <div class="form-horizontal">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="date" class="form-control" wire:model='tarikh_tubuh'
                                                                        placeholder="Tahun">
                                                                        @error('tarikh_tubuh')
                                                                        <div class="alert alert-danger">
                                                                            <strong>{{ $message }}</strong>
                                                        ...
                                                        <div class="form-horizontal">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="date" class="form-control" wire:model='tarikh_operasi'
                                                                        placeholder="Tahun">
                                                        ...
                                                        <div class="form-group row">
                                                            <label
                                                                ...
                                                                Sah Syarikat</label>
                                                            <div class="col-sm-9">
                                                                <select class="form-control" wire:model='taraf_syarikat_catatan'>
                                                                    <option value="" disabled hidden>Pilih Taraf Sah Syarikat</option>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <select class="form-control" wire:model='status_hak_milik'>
                                                                    <option value="" disabled hidden>Pilih Status Hakmilik Syarikat</option>
                                                        ...
                                                        <div class="form-group row">
                                                            <label
                                                                ...
                                                                Warganegara</label>
                                                            <div class="col-sm-9">
                                                                <select class="form-control" wire:model='status_warganegara'>
                                                                    <option value="" disabled hidden>Pilih Status Warganegara</option>
                                                        ...
                                                        <div class="form-horizontal">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-3">
                                                                    <input type="text" class="form-control" wire:model='nilai_harta'
