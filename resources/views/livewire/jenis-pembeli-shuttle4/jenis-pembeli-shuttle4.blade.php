                    ...
                    <div class="card-body">
                        @if ($updatedMode == 0)
                            <div class="card-header"
                                ...
                                KEMASKINI JENIS PEMBELI - SHUTTLE 4 (KILANG PAPAN LAPIS/VENIR)
                            </div>
                            <br>
                            <div class="">
                                                ...
                                                <div class="col-12">
                                                    <div class="card">
                                                        ...
                                                        <form class="form-horizontal">
                                                            <div class="card-body">
                                                                <h4 class="card-title" style="text-align: center">
                                                                    Tambah Jenis Pembeli - Shuttle 4 (Kilang Papan)</h4>
                                                        ...
                                                        <div class="text-right form-group m-b-0">
                                                            <a href="{{  route('jenis-pembeli-shuttle4')  }}" class="btn btn-primary" >Kembali</a>
                                                            <button type="submit"
