                    ...
                    <div class="card-body">
                        @if ($updatedMode == 0)
                            <div class="card-header"
                                ...
                                KEMASKINI SENARAI TARAF SAH SYARIKAT
                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="text" class="form-control"
                                                                        ...
                                                                        placeholder="Taraf Sah Syarikat">
                                                                        @error('keterangan')
                                                    ...
                                                    <form class="form-horizontal">
                                                        <div class="card-body">
                                                            <h4 class="card-title" style="text-align: center">
                                                                Kemaskini Senarai Taraf Sah Syarikat</h4>
                                                            <div class="form-group row">
                                                                <label for="fname"
                                                                    class="text-right col-sm-3 control-label col-form-label">Keterangan</label>
                                                                <div class="col-sm-9">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <span class="text-center"><b>Adakah anda pasti
                                                                            ingin mengemaskini maklumat ini?</span>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-danger"
                                                                            data-dismiss="modal">Batal</button>
