                                                    ...
                                                    <div style="text-align:center">
                                                        <button type="button" wire:click='edit({{ $data->id }})'
                                                            ...
                                                            <div class="modal fade bs-example-modal-sm" tabindex="-1"
                                                                ...
                                                                <div class="modal-dialog " id="mySmallModalLabel"
                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            ...
                                            <form class="form-horizontal">
                                                <div class="card-body">
                                                    <h4 class="card-title" style="text-align: center">Tambah Hak
                                                        Milik Syarikat</h4>
                                                ...
                                                {{-- <div class="card-body">
                                                        <div class="text-right form-group m-b-0">
                                                            <a href="{{ route('hak-milik-syarikat') }}" class="btn btn-primary" >Kembali</a>
                                                ...
                                                <div class="modal fade" id="confirmation_borang_a" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <span class="text-center"><b>Adakah anda pasti ingin
                                                                        mengemaskini maklumat ini?</span>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-danger"
                                                                    data-dismiss="modal">Batal</button>
