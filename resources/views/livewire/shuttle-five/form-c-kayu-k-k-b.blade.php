                                        ...
                                        <table class="table table-striped table-bordered ex3" id="">
                                            <div class="row">
                                                ...
                                                <div class="modal fade" id="sebelumnya_borang_a" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <span class="text-center"><b>Adakah anda pasti untuk ke paparan senarai Borang 5C?</b></span>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-danger" wire:loading.attr="disabled" data-dismiss="modal">TIDAK</button>
                                                ...
                                                <div class="modal fade" id="tiada_pengeluaran" tabindex="-1"
                                                    role="dialog" aria-labelledby="tiada_pengeluaranTitle" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header" style="background-color:#f3ce8f !important">
                                                                <h5 class="modal-title" id="exampleModalLongTitle">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="button" wire:click="tiadaPengeluaran" wire:loading.attr="disabled" class="btn btn-success">YA</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
