            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="rounded-lg card" style="border-color: #000000 !important;">
                        ...
                        <form action="{{ route('update_status_form3A_ipjpsm', $kilang_info->id) }}" method="post">
                            @csrf
                            <div class="card-body">
                                <div class="">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input readonly type="text" class="form-control"
                                                                    ...
                                                                    value="{{ $kilang_info->tahun }}" placeholder="Tahun">
                                                                </input>
                                                                @error('tahun')
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" class="form-control" name='website'
                                                                    readonly placeholder="Laman Sesawang (Website)"
                                                        ...
                                                        <div class="row">
                                                            <label for="fname"
                                                                ...
                                                                Lesen</label>
                                                            <div class="col-md-8">
                                                                <input type="text" class="form-control" name='no_lesen'
                                                                    readonly placeholder="No.Lesen"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <img src="{{ asset($image_path = str_replace('public', 'storage', $kilang_info->sijil_ssm)) }}"
                                                                    ...
                                                                    id="category-img-ssm" style="width:100%;height:30vh;">
                                                            </div>
                                                            <div class="col-md-4">
                                                        ...
                                                        <div class="row" style="text-align:center">
                                                            <div class="col-md-12">
                                                                @if ($forma->shuttle->shuttle_type == '3')
                                                                <a href="{{ route('ipjpsm.borang-keseluruhan.shuttle3.borangA', date('Y')) }}"
                                                                class="btn btn-primary">Kembali</a>
                                                                @elseif ($forma->shuttle->shuttle_type == '4')
                                                                <a href="{{ route('ipjpsm.borang-keseluruhan.shuttle4.borangA', date('Y')) }}"
                                                                class="btn btn-primary">Kembali</a>
                                                                @else
                                                                <a href="{{ route('ipjpsm.borang-keseluruhan.shuttle5.borangA', date('Y')) }}"
                                                                class="btn btn-primary">Kembali</a>
                                                                @endif
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <span class="text-center"><b>Adakah anda pasti
                                                                                ingin memperaku borang ini?</b></span>
                                                                    </div>
