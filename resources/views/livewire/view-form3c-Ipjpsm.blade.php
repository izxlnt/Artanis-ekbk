                                                                        ...
                                                                        <thead class="">
                                                                            <tr style="height:50px;">
                                                                                ...
                                                                                @if ($formc->shuttle_type == 3)
                                                                                    ...
                                                                                    <th style="text-align:center;"
                                                                                        colspan="2">
                                                                                        Pengeluaran Kayu Gergaji Daripada
                                                                                        Jentera Memproses</th>
                                                                                @else
                                                                                    <th style="text-align:center;"
                                                                                        colspan="2">
                                                                                ...
                                                                                @if ($formc->shuttle_type == 3)
                                                                                    ...
                                                                                    <th style="text-align:center;"
                                                                                        colspan="2">
                                                                                        Baki Stok Kayu Balak Dibawa Ke Bulan
                                                                                        Hadapan</th>
                                                                                @else
                                                                                    <th style="text-align:center;"
                                                                                        colspan="2">
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    @if ($kilang_info->shuttle_type == '3')
                                                                        <input type="text" name="status" value="Lulus"
                                                                            ...
                                                                            <a href="{{ route('ipjpsm.borang-keseluruhan.shuttle3.borangC', date('Y')) }}"
                                                                            class="btn btn-primary">Kembali</a>
                                                                            @else
                                                                            <a href="{{ route('shuttle-3-listC', date('Y')) }}"
                                                                            class="btn btn-primary">Kembali</a>
                                                                            @endif
                                                                    @elseif($kilang_info->shuttle_type=="4")
                                                                        <input type="text" name="status" value="Lulus"
                                                                            hidden>
                                                                        <a href="{{ route('shuttle-4-listC', date('Y')) }}"
                                                                            class="btn btn-primary">Kembali</a>
                                                                    @elseif($kilang_info->shuttle_type=="5")
                                                                        <input type="text" name="status" value="Lulus"
                                                                            hidden>
