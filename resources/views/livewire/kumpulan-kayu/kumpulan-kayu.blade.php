                    ...
                    <div class="card-body">
                        @if ($updatedMode == 0)
                            <div class="card-header"
                                ...
                                KEMASKINI SENARAI KUMPULAN KAYU KAYAN
                            </div>
                                ...
                                <table id="example" class="display" style="width:100%;text-align:center">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align:center;style=width:20%">Singkatan</th>
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h4 class="modal-title"
                                                                                id="mySmallModalLabel">Adakah anda ingin
                                                                                menghapuskan maklumat?</h4>
                                                ...
                                                <div class="card">
                                                    ...
                                                    <form class="form-horizontal">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group row">
                                                                <label for="fname"
                                                                    class="text-right col-sm-3 control-label col-form-label">Singkatan</label>
                                                                <div class="col-sm-9">
                                                                    <input type="text" class="form-control"
                                                                        wire:model='singkatan' placeholder="Singkatan">
                                                                        @error('singkatan')
                                                                            <div class="alert alert-danger">
                                                                                <strong>{{ $message }}</strong>
                                                                            </div>
                                                        ...
                                                        {{-- <div class="card-body">
                                                            <div class="text-right form-group m-b-0">
                                                                <a href="{{ route('kumpulan-kayu') }}" class="btn btn-primary" >Kembali</a>
                                                    ...
                                                    <form class="form-horizontal">
                                                        <div class="card-body">
                                                            <h4 class="card-title" style="text-align: center">
                                                                Kemaskini Senarai Kumpulan Kayu</h4>
                                                            <div class="form-group row">
                                                                <label for="fname"
                                                                    class="text-right col-sm-3 control-label col-form-label">Keterangan</label>
                                                                <div class="col-sm-9">
