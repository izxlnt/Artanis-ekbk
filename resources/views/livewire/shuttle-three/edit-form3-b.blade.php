                                ...
                                <div class="row">
                                                ...
                                                <div class="card-body" style="padding-top: 0%;">
                                                    <div class="row"
                                                        ...
                                                        <div class="col-md-2">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{ $formb_id->shuttle->tahun }}" readonly />
                                                        </div>
                                                        <div class="col-md-2">
                                                            <label><b>Suku Tahun:</b></label>
                                                            @if ($formb_id->suku_tahun <= '1')

                                                                <input type="text" class="form-control"
                                                                    style="background-color: #f8dbee; border-color: #d89bc4"
                                                                    value="Pertama (Mac)" readonly />
                                                            @elseif($formb_id->suku_tahun
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                style="background-color: #f8dbee;border-color: #d89bc4""
                                                                value=" {{ $formb_id->shuttle->nama_kilang }}"
                                                                readonly />
                                                        </div>
                                                        ...
                                                        <div class="col-md-2">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                style="background-color: #f8dbee;border-color: #d89bc4""
                                                                value=" {{ $formb_id->shuttle->no_ssm }}" readonly />
                                                        </div>
                                                        <div class="col-md-2">
                                                            <label><b>No. Lesen:</b></label>
                                                            <input type="text" class="form-control"
                                                                style="background-color: #f8dbee;border-color: #d89bc4""
                                                                value=" {{ $formb_id->shuttle->no_lesen }}"
                                                                readonly />
                                                        </div>
                                                    ...
                                                    <table style="padding-top:0% !important;">
                                                        ...
                                                        <tr style="height:50px;background-color:#f8dbee;">
                                                            ...
                                                            <th style="text-align:center;" colspan="3" rowspan="3">
                                                                Purata Bayaran Gaji dan <br>Upah Per
                                                                Pekerja<br>(Sebulan)<br>(RM / bulan / pekerja)
                                                            </th>
                                                            <th style="text-align:center;" colspan="3" rowspan="3">
                                                        ...
                                                        <tr style="height:50px;background-color:#f8dbee;">
                                                            ...
                                                            <th style="text-align:center;">(16) =<br>(14)+(15)
                                                            </th>
                                                        </tr>
                                                        ...
                                                        @forelse($kategori_pekerja as $key=>$data)
                                                            <tr style="height:50px;">
                                                                ...
                                                                <td style="text-align:center;padding:5px"><input
                                                                        style="text-align:center" type="text" size="3"
                                                                ...
                                                                <td
                                                                    style="text-align:center;width:100px;background-color:#f8dbee;">
                                                                    <input readonly type style="text-align:center"
                                                                ...
                                                                <td style="text-align:center;background-color:#f8dbee;">
                                                                    <input readonly type="text" style="text-align:center"
                                                        ...
                                                        <tr style="height:50px;">
                                                            ...
                                                            <td style="text-align:center ;background-color:#f8dbee;">
                                                                <input readonly type="text" style="text-align:center;font-weight:bold"
                                                                    style="background-color: #f8dbee;" size="6"
                                                                    id="fb_tot_jl" value="{{ $total_pekerja_lelaki ?? '' }}">
                                                            </td>
                                                            <td style="text-align:center;background-color:#f8dbee;">
                                                                <input readonly type="text" style="text-align:center;font-weight:bold"
                                                                    style="background-color: #f8dbee;" size="6"
                                                                    id="fb_tot_jp" value="{{ $total_pekerja_perempuan ?? '' }}">
                                                            </td>
                                                            <td style="text-align:center;background-color:#f8dbee;">
                                                                <input readonly type="text" style="text-align:center;font-weight:bold"
                                                                    style="background-color: #f8dbee;" size="6"
                                                                    id="fb_tot_j" value="{{ $total_pekerja ?? '' }}">
                                                            </td>
                                                            <td style="text-align:center;"><input readonly type="text"
                                                                    style="text-align:center;font-weight:bold"
                                                                    style="background-color: #f8dbee;" size="6"
                                                            ...
                                                            <td style="text-align:center;background-color:#f8dbee;">
                                                                <input readonly type="text" style="text-align:center;font-weight:bold"
                                                                    style="background-color: #f8dbee;" size="7"
                                                                    id="fb_tot_glp" value="{{ $jumlah_lelaki_perempuan ?? '' }}">
                                                            </td>

                                                            <td style="text-align:center;background-color:#f8dbee;">
                                                                <input readonly type="text" style="text-align:center;font-weight:bold"
                                                                    style="background-color: #f8dbee;" size="7"
                                                                    id="fb_tot_tgl" value="{{ $jumlah_total_lelaki ?? '' }}">
                                                            </td>
                                                            <td style="text-align:center;background-color:#f8dbee;">
                                                                <input readonly type="text" style="text-align:center;font-weight:bold"
                                                                    style="background-color: #f8dbee;" size="7"
                                                                    id="fb_tot_tgp" value="{{ $jumlah_total_perempuan ?? '' }}">
                                                            </td>
                                                            <td style="text-align:center;background-color:#f8dbee;">
                                                                <input readonly type="text" style="text-align:center;font-weight:bold"
                                                                    style="background-color: #f8dbee;" size="7"
                                                                    id="fb_tot_tg" value="{{ $jumlah_total_gaji ?? '' }}">
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <br>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="text-right form-group m-b-0">
                                            ...
                                            @if ($formb_id->shuttle_type == 3)
                                                <a href="{{ route('user.shuttle-3-senaraiB', date('Y')) }}"
                                                    class="btn btn-primary">Kembali</a>
                                            @elseif($formb_id->shuttle_type == 4)
                                                <a href="{{ route('user.shuttle-4-senaraiB', date('Y')) }}"
                                                    class="btn btn-primary">Kembali</a>

                                            @elseif($formb_id->shuttle_type == 5)
                                                <a href="{{ route('user.shuttle-5-senaraiB', date('Y')) }}"
                                                    class="btn btn-primary">Kembali</a>
                                            @endif
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" id="submit-button" class="btn btn-danger"
