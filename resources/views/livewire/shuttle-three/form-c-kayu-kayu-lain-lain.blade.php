                    ...
                    <div class="col-md-12">
                        <div class="rounded-lg card" style="border-color: #000000 !important;">
                            ...
                            @elseif($kilang_info->shuttle_type == '4')
                                <div class="card-header"
                                    style="text-align:center; background-color: #f0e10dbd !important; font-size: 130%; font-weight: bold;">
                                    BORANG 4C - PENYATA KEMASUKAN & PEMPROSESAN KAYU BALAK <br> DAN PENGELUARAN KAYU
                                    GERGAJI
                                    MENGIKUT KUMPULAN KAYU-KAYAN
                                </div>
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <form class="form-horizontal" wire:submit.prevent='store'
                                                            ...
                                                            <div class="row" style="margin-bottom:-2%;">
                                                                ...
                                                                <div style="color: rgb(4, 0, 255)"> <b>HALAMAN 5/5
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="modal fade" id="tiada_pengeluaran"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered"
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <span class="text-center"><b>Adakah anda pasti kilang anda tiada pengeluaran?</span>
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <div wire:loading.remove wire:target="tiadaPengeluaran">YA</div>                                                                </button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
<script>
    $('#lain-lain-form').submit(function(e) {
        e.preventDefault();
        // Coding
        // console.log('lol');
