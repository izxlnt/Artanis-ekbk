                                                ...
                                                <div class="row">
                                                                ...
                                                                <table>
                                                                    ...
                                                                    <tr style="height:50px;">
                                                                        ...
                                                                        <td style="text-align:center;">
                                                                            ...
                                                                            <input type="text" size="10"
                                                                                name="jumlah_venier_eksport_cleaning" style="text-align:right"
                                                                                oninput="validate(this)"
                                                                                onkeypress="return isNumberKey(event)">
                                                                        </td>
                                                                    </tr>
                                                                    ...
                                                                    <tr style="height:50px;">
                                                                        ...
                                                                        <td style="text-align:center;">
                                                                            ...
                                                                            <input type="text" size="10"
                                                                                name="jumlah_venier_tempatan_cleaning" style="text-align:right"
                                                                                oninput="validate(this)"
                                                                                onkeypress="return isNumberKey(event)">
                                                                        </td>
                                                                    </tr>
                                                                        ...
                                                                        <tr style="height:50px;">
                                                                            ...
                                                                            <td style="text-align:center;">
                                                                                ...
                                                                                <input type="text" size="10"
                                                                                    ...
                                                                                    id="jumlah_jualan_cleaning.{{ $key }}"
                                                                                    style="text-align:right"
                                                                                     oninput="validate(this);calcTotalJumlahJualan()"
                                                                                    onkeypress="return isNumberKey(event)">
                                                                            </td>
                                                                        </tr>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="text-center form-group m-b-0">
                                                            ...
                                                            <a href="{{ route('shuttle-4-listE', date('Y')) }}"
