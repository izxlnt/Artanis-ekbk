                    ...
                    <div class="card-body">
                        @if ($updatedMode == 0)
                            <div class="card-header"
                                ...
                                KEMASKINI SENARAI KEWARGANEGARAAN
                            </div>
                                                    ...
                                                    <form class="form-horizontal">
                                                        ...
                                                        {{-- <div class="card-body">
                                                            <div class="text-right form-group m-b-0">
                                                                <a href=" {{ route('kewarganegaraan')}}" class="btn btn-primary" >Kembali</a>
                                                    ...
                                                    <form class="form-horizontal">
                                                        <div class="card-body">
                                                            <h4 class="card-title" style="text-align: center">
                                                                Kemaskini Senarai Kewarganegaraan</h4>
                                                            <div class="form-group row">
                                                                <label for="fname"
                                                                    class="text-right col-sm-3 control-label col-form-label">Keterangan</label>
                                                                <div class="col-sm-9">
