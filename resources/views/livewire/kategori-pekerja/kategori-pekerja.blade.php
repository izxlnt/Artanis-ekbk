                    ...
                    <div class="card-body">
                        @if ($updatedMode == 0)
                            <div class="card-header"
                                ...
                                KEMASKINI SENARAI KATEGORI PEKERJA
                            </div>
                            <br>
                            <div class="">
                                <table id="example" class="display" style="width:100%;text-align:center">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align:center;style=width:30%">Keterangan</th>
                                            <th style="text-align:center;style=width:5%">Gaji Minimum</th>
                                            <th style="text-align:center;style=width:5%">Gaji Maksimum</th>
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <form class="form-horizontal">
                                                            <div class="card-body">
                                                                ...
                                                                <div class="form-group row">
                                                                    <label for="fname"
                                                                        class="text-right col-sm-3 control-label col-form-label">Gaji
                                                                        Minimum</label>
                                                                    <div class="col-sm-9">
                                                                        <input type="text" class="form-control"
                                                                            wire:model='gaji_min'
                                                        ...
                                                        <div class="text-right form-group m-b-0">
                                                            <a href="{{  route('kategori-pekerja')  }}" class="btn btn-primary" >Kembali</a>
                                                            <button type="submit"
