...
@if ($data)
    ...
    @elseif ($data->status == 'Tidak Diisi')
        @php
            ...
            // off by default) - see FormFlowService and cell-borang-monthly.blade.php.
            // When it's off, a quarter must never show as closed just because its own
            // tarikh_tutup_borang has passed.
