...
@section('content')
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <a type="button " href="{{ route('user.shuttle-4-listA', date('Y')) }}"
                                            class="btn" style="background-color:white;color:black;border-color:rgb(196, 188, 186)">Borang 4A</a>
                                        <a type="button" href="{{ route('user.shuttle-4-listB', date('Y')) }}"
                                            class="btn" style="background-color:white;color:black;border-color:#e72cc8f3">Borang 4B</a>
                                        <a type="button" href="{{ route('user.shuttle-4-listC', date('Y')) }}"
                                            class="btn" style="background-color:#f3e741f3;color:black;border-color:#bbb235f3">Borang 4C</a>
                                        <a type="button" href="{{ route('user.shuttle-4-listD', date('Y')) }}"
                                            class="btn" style="background-color:white;color:black;border-color:#1b9e21f3">Borang 4D</a>
                                            <a type="button" href="{{ route('user.shuttle-4-listE', date('Y')) }}"
                                            class="btn" style="background-color:white;color:black;border-color:rgb(54, 140, 238">Borang 4E</a>
                                    </div>
                                </div>
                            </div>
                            <br><br>
                            ...
                            <h4 class="text-center">PENYATA SHUTTLE 4 - KILANG PAPAN LAPIS/VENIR</h4>
                                ...
                                <h4 class="text-center">BORANG 4C - PENYATA KEMASUKAN & PEMPROSESAN KAYU BALAK
                                ...
                                <table id="example" class="display" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                @include('partials.status-icon-ibk', ['form' => $data, 'editLink' => route('edit-form4c',$shuttle->id)])
                                            </td>
    ...
    <script>
        function changePage(){
            ...
            window.location.href = "<?php echo URL::to('/pengguna/shuttle-4-listC/" + year +"'); ?>";
        }
    </script>
