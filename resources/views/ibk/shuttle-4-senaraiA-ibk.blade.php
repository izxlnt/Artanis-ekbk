                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                ...
                                                @elseif ($list && $list->status == 'Lulus')
                                                    <a href="{{ route('pengguna.shuttle-3-view-formA', $list->id) }}"><img
                                                            src="{{ asset((!empty($list->tiada_pengeluaran) && $list->tiada_pengeluaran == 1) ? 'tp_logo2.png' : 'circle_check_yellow.png') }}" height='30px' alt=""
                                                            style="color: green; font-size: 20pt;" data-toggle="tooltip"
                                                            data-placement="bottom" title="{{ (!empty($list->tiada_pengeluaran) && $list->tiada_pengeluaran == 1) ? 'Borang telah dihantar - Tiada Pengeluaran' : 'Borang telah dihantar' }}"></i></a>
