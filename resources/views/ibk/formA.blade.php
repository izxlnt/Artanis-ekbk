            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="rounded-lg card" style="border-color: #000000 !important;">
                        ...
                        <div class="card-body">
                            <form action="{{ route('update.formA', $kilang_info->id) }}" method="post"
                                                ...
                                                <div class="card">
                                                    ...
                                                    <form class="form-horizontal">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <input type="text" class="form-control"
                                                                        ...
                                                                        onkeypress="return isNumberKey(event)" oninput="validate(this)"
                                                            ...
                                                            @if ($forma_count > 0)
                                                                @if ($form_a->status == 'Tidak Lengkap')
                                                                    <div class="row" style="text-align:center">
                                                                        <div class="col-md-12">
                                                                            <label>Ulasan PHD</label><br>

                                                                            @if ($ulasan == null)
                                                                                <textarea name="ulasan_phd" cols="100%"
                                                                                    rows="5" readonly
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="text-right form-group m-b-0">
                                                                            <a href="{{ route('user.shuttle-3-senaraiA', date('Y')) }}"
