...
@section('content')
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <h4 class="text-center">BORANG 4D - PENYATA PENGELUARAN DARIPADA JENTERA MEMPROSES PAPAN
                                    LAPIS/VENIR</h4>
                            </div>
                            <div class="">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($list as $data)
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    @include('partials.status-icon-ibk', ['form' => $data, 'editLink' => route('edit-form4d', $data->id)])
                                                </td>
                                        @endforeach
                                        </tr>
                                    </tbody>
    ...
    <script>
        function changePage() {
            ...
            window.location.href = "<?php echo URL::to('/pengguna/shuttle-4-listD/" + year +"'); ?>";
        }
    </script>
