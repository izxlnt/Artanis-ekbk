...
@section('content')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <a type="button" href="{{ route('user.shuttle-5-listD', date('Y')) }}"
                                        class="btn" style="background-color:rgb(33, 235, 77);color:black;border-color:#1b9e21f3">Borang 5D</a>
                            ...
                            <br><br>
                            <div>
                                <h4 class="text-center">BORANG 5D -  PENYATA PENGELUARAN KAYU KUMAI MENGIKUT JENIS KAYU KUMAI</h4>
                            </div>
                            <div class="">
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('user.shuttle-5-edit-formD',$data->id) }}" > <img
                                                    ...
                                                    alt="" data-toggle="tooltip" data-placement="bottom" title="Borang tidak lengkap"></a>
                                                @elseif($data->status == 'Tidak Diisi')
                                                    <a href="{{ route('user.shuttle-5-formD', [$year, $data->bulan]) }}"
    ...
    <script>
        function changePage(){
            ...
            window.location.href = "<?php echo URL::to('/pengguna/shuttle-5-listD/" + year +"'); ?>";
        }
    </script>
