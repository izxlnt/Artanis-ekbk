...
@section('content')
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <a type="button" href="{{ route('user.shuttle-4-listB', date('Y')) }}"
                                            class="btn" style="background-color:#ee8dcd;color:black;border-color:#e72cc8f3">Borang 4B</a>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($list as $data)
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    @include('partials.status-icon-ibk', ['form' => $data, 'editLink' => route('edit-form3b', $data->id)])
                                                </td>
    ...
    <script>
        function changePage(){
            ...
            window.location.href = "<?php echo URL::to('/pengguna/shuttle-4-listB/" + year +"'); ?>";
        }
    </script>
