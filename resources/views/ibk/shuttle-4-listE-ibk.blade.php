...
@section('content')
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <h4 class="text-center">BORANG 4E - PENYATA PENJUALAN PAPAN LAPIS/VENIR
                                    DALAM PASARAN TEMPATAN DAN EKSPORT</h4>
                            </div>
                            <div class="">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($list as $data)
                                            <tr class="text-center">
                                                ...
                                                <td>
                                                    @include('partials.status-icon-ibk', ['form' => $data, 'editLink' => route('edit-form4E', $data->id)])
                                                </td>
                                        @endforeach
                                        </tr>
                                    </tbody>
    ...
    {{-- <script>
        function changePage(){
            ...
            window.location.href = "<?php echo URL::to('/pengguna/shuttle-4-listE/" + year +"'); ?>";
        }
    </script> --}}
