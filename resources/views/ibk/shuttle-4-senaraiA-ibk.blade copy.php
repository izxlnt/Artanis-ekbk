                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4 class="text-center">PENYATA SHUTTLE 4 - KILANG PAPAN LAPIS/VENIR</h4>
                                ...
                                <h4 class="text-center">BORANG 4A - MAKLUMAT KILANG</h4>
                            </div>
                            <br>
                            <div class="">
                                    ...
                                    <tbody>
                                        <tr class="text-center">
                                            ...
                                            <td class="text-center">
                                                @if ($list->status == 'Sedang Diproses' || $list->status == 'Dihantar ke IPJPSM' || $list->status == 'Lulus')
                                                ...
                                                @elseif($list->status == 'Tidak Diisi')
                                                    ...
                                                    <a href="{{ route('user.shuttle-4-formA') }}"
                                                        ...
                                                        data-placement="bottom" title="Borang belum diisi" style="font-size: 15pt;"></i></a>
                                                    @else
