...
@section('content')
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <a type="button" href="{{ route('user.shuttle-5-listC', date('Y')) }}"
                                            class="btn" style="background-color:white;color:black;border-color:#9e9c7bf3">Borang 5C</a>
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($data->status =="Dihantar ke IPJPSM")
                                                        <a href="" class="mr-1 btn btn-dark disabled"><i
                                                                class="fas fa-pencil-alt"></i></a>
                                                    @elseif($data->status =="Tidak Lengkap")
                                                        <a href="{{ route('edit-form4a', $shuttle->id) }}"><img src="{{ asset('history.png') }}" height='30px' alt="" style="font-size: 15pt;"
    ...
    <script>
        function changePage(){
            ...
            window.location.href = "<?php echo URL::to('/pengguna/shuttle-5-listA/" + year +"'); ?>";
        }
    </script>
