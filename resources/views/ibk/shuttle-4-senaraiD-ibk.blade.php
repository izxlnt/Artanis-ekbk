                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <a type="button "
                                                    href="{{ route('user.shuttle-4-senaraiA', $year) }}"
                                                    class="btn"
                                                ...
                                                <a type="button" href="{{ route('user.shuttle-4-senaraiB', $year) }}"
                                                    class="btn"
                                                    style="background-color:white;color:black;border-color:#e72cc8f3">Borang
                                                    4B</a>
                                                <a type="button" href="{{ route('user.shuttle-4-senaraiC', $year) }}"
                                                    class="btn"
                                                    style="background-color:white;color:black;border-color:#bbb235f3">Borang
                                                    4C</a>
                                                <a type="button" href="{{ route('user.shuttle-4-senaraiD', $year) }}"
                                                    class="btn"
                                                    style="background-color:rgb(33, 235, 77);color:black;border-color:#1b9e21f3">Borang
                                                    4D</a>
                                    ...
                                    <div>
                                        ...
                                        <h4 class="text-center">BORANG 4D - PENYATA PENGELUARAN DARIPADA JENTERA
                                            MEMPROSES
                                            PAPAN LAPIS/VENIR</h4>
                                    </div> <br>
                                    <div class="">
                                        <table id="" class="text-center table-bordered" style="width:100%">
                                            <thead>
                                                <tr style="background-color: rgb(33, 235, 77) ">
                                                    <th width="10%">vBulan</th>
                                                    ...
                                                    <td>
                                                        ...
                                                        @foreach ($list as $data)
                                                            @if ($data->status == 'Tidak Diisi' && $data->bulan == '1')
                                                                @if ($flow['formD'][1]['can_fill'])
                                                                    <a href="{{ route('user.shuttle-4-formD', [$year, '1']) }}" data-toggle="tooltip" data-placement="bottom" title="Borang belum diisi">
                                                                        <img src="{{ asset('circle_times.png') }}" height='30px' alt="" style="font-size: 15pt;"></a>
                                                                @elseif ($flow['formD'][1]['date_blocked'])
                                                                    <img src="{{ asset('calendar.png') }}" height='30px' alt="" data-toggle="tooltip" data-placement="bottom" title="{{ $flow['formD'][1]['reason'] }}" style="color: black; font-size: 20pt;">
                                                                @else
                                                            ...
                                                            @elseif($data->status == 'Dihantar ke IPJPSM' && $data->bulan == '1')
                                                                <a
                                                                    href="{{ route('pengguna.shuttle-4-view-form4D', $data->id) }}">
                                                                    <img src="{{ asset((!empty($data->tiada_pengeluaran) && $data->tiada_pengeluaran == 1) ? 'tp_logo2.png' : 'circle_check_yellow.png') }}"
                                                                        height='30px' alt="" data-toggle="tooltip"
                                                                        data-placement="bottom"
                                                    ...
                                                    <td>
                                                        ...
                                                        @foreach ($list as $data)
                                                            @if ($data->status == 'Tidak Diisi' && $data->bulan == '2')
                                                                @if ($flow['formD'][2]['can_fill'])
                                                                    <a href="{{ route('user.shuttle-4-formD', [$year, '2']) }}" data-toggle="tooltip" data-placement="bottom" title="Borang belum diisi">
                                                                        <img src="{{ asset('circle_times.png') }}" height='30px' alt="" style="font-size: 15pt;"></a>
                                                                @elseif ($flow['formD'][2]['date_blocked'])
                                                                    <img src="{{ asset('calendar.png') }}" height='30px' alt="" data-toggle="tooltip" data-placement="bottom" title="{{ $flow['formD'][2]['reason'] }}" style="color: black; font-size: 20pt;">
                                                                @else
                                                    ...
                                                    <td>
                                                        ...
                                                        @foreach ($list as $data)
                                                            @if ($data->status == 'Tidak Diisi' && $data->bulan == '3')
                                                                @if ($flow['formD'][3]['can_fill'])
                                                                    <a href="{{ route('user.shuttle-4-formD', [$year, '3']) }}" data-toggle="tooltip" data-placement="bottom" title="Borang belum diisi">
                                                                        <img src="{{ asset('circle_times.png') }}" height='30px' alt="" style="font-size: 15pt;"></a>
                                                                @elseif ($flow['formD'][3]['date_blocked'])
                                                                    <img src="{{ asset('calendar.png') }}" height='30px' alt="" data-toggle="tooltip" data-placement="bottom" title="{{ $flow['formD'][3]['reason'] }}" style="color: black; font-size: 20pt;">
                                                                @else
                                                    ...
                                                    <td>
                                                        ...
                                                        @foreach ($list as $data)
                                                            @if ($data->status == 'Tidak Diisi' && $data->bulan == '4')
                                                                @if ($flow['formD'][4]['can_fill'])
                                                                    <a href="{{ route('user.shuttle-4-formD', [$year, '4']) }}" data-toggle="tooltip" data-placement="bottom" title="Borang belum diisi">
                                                                        <img src="{{ asset('circle_times.png') }}" height='30px' alt="" style="font-size: 15pt;"></a>
                                                                @elseif ($flow['formD'][4]['date_blocked'])
                                                                    <img src="{{ asset('calendar.png') }}" height='30px' alt="" data-toggle="tooltip" data-placement="bottom" title="{{ $flow['formD'][4]['reason'] }}" style="color: black; font-size: 20pt;">
                                                                @else
                                                    ...
                                                    <td>
                                                        ...
                                                        @foreach ($list as $data)
                                                            @if ($data->status == 'Tidak Diisi' && $data->bulan == '5')
                                                                @if ($flow['formD'][5]['can_fill'])
                                                                    <a href="{{ route('user.shuttle-4-formD', [$year, '5']) }}" data-toggle="tooltip" data-placement="bottom" title="Borang belum diisi">
                                                                        <img src="{{ asset('circle_times.png') }}" height='30px' alt="" style="font-size: 15pt;"></a>
                                                                @elseif ($flow['formD'][5]['date_blocked'])
                                                                    <img src="{{ asset('calendar.png') }}" height='30px' alt="" data-toggle="tooltip" data-placement="bottom" title="{{ $flow['formD'][5]['reason'] }}" style="color: black; font-size: 20pt;">
                                                                @else
                                                    ...
                                                    <td>
                                                        ...
                                                        @foreach ($list as $data)
                                                            @if ($data->status == 'Tidak Diisi' && $data->bulan == '6')
                                                                @if ($flow['formD'][6]['can_fill'])
                                                                    <a href="{{ route('user.shuttle-4-formD', [$year, '6']) }}" data-toggle="tooltip" data-placement="bottom" title="Borang belum diisi">
                                                                        <img src="{{ asset('circle_times.png') }}" height='30px' alt="" style="font-size: 15pt;"></a>
                                                                @elseif ($flow['formD'][6]['date_blocked'])
                                                                    <img src="{{ asset('calendar.png') }}" height='30px' alt="" data-toggle="tooltip" data-placement="bottom" title="{{ $flow['formD'][6]['reason'] }}" style="color: black; font-size: 20pt;">
                                                                @else
                                                    ...
                                                    <td>
                                                        ...
                                                        @foreach ($list as $data)
                                                            @if ($data->status == 'Tidak Diisi' && $data->bulan == '7')
                                                                @if ($flow['formD'][7]['can_fill'])
                                                                    <a href="{{ route('user.shuttle-4-formD', [$year, '7']) }}" data-toggle="tooltip" data-placement="bottom" title="Borang belum diisi">
                                                                        <img src="{{ asset('circle_times.png') }}" height='30px' alt="" style="font-size: 15pt;"></a>
                                                                @elseif ($flow['formD'][7]['date_blocked'])
                                                                    <img src="{{ asset('calendar.png') }}" height='30px' alt="" data-toggle="tooltip" data-placement="bottom" title="{{ $flow['formD'][7]['reason'] }}" style="color: black; font-size: 20pt;">
                                                                @else
                                                    ...
                                                    <td>
                                                        ...
                                                        @foreach ($list as $data)
                                                            @if ($data->status == 'Tidak Diisi' && $data->bulan == '8')
                                                                @if ($flow['formD'][8]['can_fill'])
                                                                    <a href="{{ route('user.shuttle-4-formD', [$year, '8']) }}" data-toggle="tooltip" data-placement="bottom" title="Borang belum diisi">
                                                                        <img src="{{ asset('circle_times.png') }}" height='30px' alt="" style="font-size: 15pt;"></a>
                                                                @elseif ($flow['formD'][8]['date_blocked'])
                                                                    <img src="{{ asset('calendar.png') }}" height='30px' alt="" data-toggle="tooltip" data-placement="bottom" title="{{ $flow['formD'][8]['reason'] }}" style="color: black; font-size: 20pt;">
                                                                @else
                                                    ...
                                                    <td>
                                                        ...
                                                        @foreach ($list as $data)
                                                            @if ($data->status == 'Tidak Diisi' && $data->bulan == '9')
                                                                @if ($flow['formD'][9]['can_fill'])
                                                                    <a href="{{ route('user.shuttle-4-formD', [$year, '9']) }}" data-toggle="tooltip" data-placement="bottom" title="Borang belum diisi">
                                                                        <img src="{{ asset('circle_times.png') }}" height='30px' alt="" style="font-size: 15pt;"></a>
                                                                @elseif ($flow['formD'][9]['date_blocked'])
                                                                    <img src="{{ asset('calendar.png') }}" height='30px' alt="" data-toggle="tooltip" data-placement="bottom" title="{{ $flow['formD'][9]['reason'] }}" style="color: black; font-size: 20pt;">
                                                                @else
                                                    ...
                                                    <td>
                                                        ...
                                                        @foreach ($list as $data)
                                                            @if ($data->status == 'Tidak Diisi' && $data->bulan == '10')
                                                                @if ($flow['formD'][10]['can_fill'])
                                                                    <a href="{{ route('user.shuttle-4-formD', [$year, '10']) }}" data-toggle="tooltip" data-placement="bottom" title="Borang belum diisi">
                                                                        <img src="{{ asset('circle_times.png') }}" height='30px' alt="" style="font-size: 15pt;"></a>
                                                                @elseif ($flow['formD'][10]['date_blocked'])
                                                                    <img src="{{ asset('calendar.png') }}" height='30px' alt="" data-toggle="tooltip" data-placement="bottom" title="{{ $flow['formD'][10]['reason'] }}" style="color: black; font-size: 20pt;">
                                                                @else
                                                    ...
                                                    <td>
                                                        ...
                                                        @foreach ($list as $data)
                                                            @if ($data->status == 'Tidak Diisi' && $data->bulan == '11')
                                                                @if ($flow['formD'][11]['can_fill'])
                                                                    <a href="{{ route('user.shuttle-4-formD', [$year, '11']) }}" data-toggle="tooltip" data-placement="bottom" title="Borang belum diisi">
                                                                        <img src="{{ asset('circle_times.png') }}" height='30px' alt="" style="font-size: 15pt;"></a>
                                                                @elseif ($flow['formD'][11]['date_blocked'])
                                                                    <img src="{{ asset('calendar.png') }}" height='30px' alt="" data-toggle="tooltip" data-placement="bottom" title="{{ $flow['formD'][11]['reason'] }}" style="color: black; font-size: 20pt;">
                                                                @else
                                                    ...
                                                    <td>
                                                        ...
                                                        @foreach ($list as $data)
                                                            @if ($data->status == 'Tidak Diisi' && $data->bulan == '12')
                                                                @if ($flow['formD'][12]['can_fill'])
                                                                    <a href="{{ route('user.shuttle-4-formD', [$year, '12']) }}" data-toggle="tooltip" data-placement="bottom" title="Borang belum diisi">
                                                                        <img src="{{ asset('circle_times.png') }}" height='30px' alt="" style="font-size: 15pt;"></a>
                                                                @elseif ($flow['formD'][12]['date_blocked'])
                                                                    <img src="{{ asset('calendar.png') }}" height='30px' alt="" data-toggle="tooltip" data-placement="bottom" title="{{ $flow['formD'][12]['reason'] }}" style="color: black; font-size: 20pt;">
                                                                @else
...
@endif
    ...
    <script>
        function changePage() {
            ...
            window.location.href = "<?php echo URL::to('/pengguna/shuttle-4-senaraiD/" + year +"'); ?>";
        }
    </script>
