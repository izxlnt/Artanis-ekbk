                                                        ...
                                                        @foreach ($list as $data)
                                                            @if ($data->status == 'Tidak Diisi' && $data->bulan == '1')
                                                                ...
                                                                @elseif ($isPreviousYear || (date('Y-m-d') >= $data->tarikh_buka_borang && date('Y-m-d') <= $tarikh_tutup_terkini))
                                                                    <a href="{{ route('user.shuttle-4-formD', [$year, '1']) }}"
                                                        ...
                                                        @foreach ($list as $data)
                                                            @if ($data->status == 'Tidak Diisi' && $data->bulan == '2')
                                                                ...
                                                                @if (!$formCFilled[2])
                                                                    <img src="{{ asset('calendar.png') }}" height='30px' alt="" data-toggle="tooltip" data-placement="bottom" title="Sila isi Borang C terlebih dahulu" style="color: black; font-size: 20pt;">
                                                                @elseif ($isPreviousYear || (date('Y-m-d') >= $data->tarikh_buka_borang && date('Y-m-d') <= $tarikh_tutup_terkini))
                                                                    <a href="{{ route('user.shuttle-4-formD', [$year, '2']) }}"
                                                                        data-toggle="tooltip" data-placement="bottom"
                                                                        title="Borang belum diisi">
                                                                        <img src="{{ asset('circle_times.png') }}"
                                                                            height='30px' alt=""
                                                        ...
                                                        @foreach ($list as $data)
                                                            @if ($data->status == 'Tidak Diisi' && $data->bulan == '3')
                                                                ...
                                                                @if (!$formCFilled[3])
                                                                    <img src="{{ asset('calendar.png') }}" height='30px' alt="" data-toggle="tooltip" data-placement="bottom" title="Sila isi Borang C terlebih dahulu" style="color: black; font-size: 20pt;">
                                                                @elseif ($isPreviousYear || (date('Y-m-d') >= $data->tarikh_buka_borang && date('Y-m-d') <= $tarikh_tutup_terkini))
                                                                    <a href="{{ route('user.shuttle-4-formD', [$year, '3']) }}"
                                                                        data-toggle="tooltip" data-placement="bottom"
                                                                        title="Borang belum diisi">
                                                                        <img src="{{ asset('circle_times.png') }}"
                                                                            height='30px' alt=""
                                                        ...
                                                        @foreach ($list as $data)
                                                            @if ($data->status == 'Tidak Diisi' && $data->bulan == '4')
                                                                ...
                                                                @if (!$formCFilled[4])
                                                                    <img src="{{ asset('calendar.png') }}" height='30px' alt="" data-toggle="tooltip" data-placement="bottom" title="Sila isi Borang C terlebih dahulu" style="color: black; font-size: 20pt;">
                                                                @elseif ($isPreviousYear || (date('Y-m-d') >= $data->tarikh_buka_borang && date('Y-m-d') <= $tarikh_tutup_terkini))
                                                                    <a href="{{ route('user.shuttle-4-formD', [$year, '4']) }}"
                                                                        data-toggle="tooltip" data-placement="bottom"
                                                                        title="Borang belum diisi">
                                                                        <img src="{{ asset('circle_times.png') }}"
                                                                            height='30px' alt=""
                                                        ...
                                                        @foreach ($list as $data)
                                                            @if ($data->status == 'Tidak Diisi' && $data->bulan == '5')
                                                                ...
                                                                @if (!$formCFilled[5])
                                                                    <img src="{{ asset('calendar.png') }}" height='30px' alt="" data-toggle="tooltip" data-placement="bottom" title="Sila isi Borang C terlebih dahulu" style="color: black; font-size: 20pt;">
                                                                @elseif ($isPreviousYear || (date('Y-m-d') >= $data->tarikh_buka_borang && date('Y-m-d') <= $tarikh_tutup_terkini))
                                                                    <a href="{{ route('user.shuttle-4-formD', [$year, '5']) }}"
                                                                        data-toggle="tooltip" data-placement="bottom"
                                                                        title="Borang belum diisi">
                                                                        <img src="{{ asset('circle_times.png') }}"
                                                                            height='30px' alt=""
                                                        ...
                                                        @foreach ($list as $data)
                                                            @if ($data->status == 'Tidak Diisi' && $data->bulan == '6')
                                                                ...
                                                                @if (!$formCFilled[6])
                                                                    <img src="{{ asset('calendar.png') }}" height='30px' alt="" data-toggle="tooltip" data-placement="bottom" title="Sila isi Borang C terlebih dahulu" style="color: black; font-size: 20pt;">
                                                                @elseif ($isPreviousYear || (date('Y-m-d') >= $data->tarikh_buka_borang && date('Y-m-d') <= $tarikh_tutup_terkini))
                                                                    <a href="{{ route('user.shuttle-4-formD', [$year, '6']) }}"
                                                                        data-toggle="tooltip" data-placement="bottom"
                                                                        title="Borang belum diisi">
                                                                        <img src="{{ asset('circle_times.png') }}"
                                                                            height='30px' alt=""
                                                        ...
                                                        @foreach ($list as $data)
                                                            @if ($data->status == 'Tidak Diisi' && $data->bulan == '7')
                                                                ...
                                                                @if (!$formCFilled[7])
                                                                    <img src="{{ asset('calendar.png') }}" height='30px' alt="" data-toggle="tooltip" data-placement="bottom" title="Sila isi Borang C terlebih dahulu" style="color: black; font-size: 20pt;">
                                                                @elseif ($isPreviousYear || (date('Y-m-d') >= $data->tarikh_buka_borang && date('Y-m-d') <= $tarikh_tutup_terkini))
                                                                    <a href="{{ route('user.shuttle-4-formD', [$year, '7']) }}"
                                                                        data-toggle="tooltip" data-placement="bottom"
                                                                        title="Borang belum diisi">
                                                                        <img src="{{ asset('circle_times.png') }}"
                                                                            height='30px' alt=""
                                                        ...
                                                        @foreach ($list as $data)
                                                            @if ($data->status == 'Tidak Diisi' && $data->bulan == '8')
                                                                ...
                                                                @if (!$formCFilled[8])
                                                                    <img src="{{ asset('calendar.png') }}" height='30px' alt="" data-toggle="tooltip" data-placement="bottom" title="Sila isi Borang C terlebih dahulu" style="color: black; font-size: 20pt;">
                                                                @elseif ($isPreviousYear || (date('Y-m-d') >= $data->tarikh_buka_borang && date('Y-m-d') <= $tarikh_tutup_terkini))
                                                                    <a href="{{ route('user.shuttle-4-formD', [$year, '8']) }}"
                                                                        data-toggle="tooltip" data-placement="bottom"
                                                                        title="Borang belum diisi">
                                                                        <img src="{{ asset('circle_times.png') }}"
                                                                            height='30px' alt=""
                                                        ...
                                                        @foreach ($list as $data)
                                                            @if ($data->status == 'Tidak Diisi' && $data->bulan == '9')
                                                                ...
                                                                @if (!$formCFilled[9])
                                                                    <img src="{{ asset('calendar.png') }}" height='30px' alt="" data-toggle="tooltip" data-placement="bottom" title="Sila isi Borang C terlebih dahulu" style="color: black; font-size: 20pt;">
                                                                @elseif ($isPreviousYear || (date('Y-m-d') >= $data->tarikh_buka_borang && date('Y-m-d') <= $tarikh_tutup_terkini))
                                                                    <a href="{{ route('user.shuttle-4-formD', [$year, '9']) }}"
                                                                        data-toggle="tooltip" data-placement="bottom"
                                                                        title="Borang belum diisi">
                                                                        <img src="{{ asset('circle_times.png') }}"
                                                                            height='30px' alt=""
                                                        ...
                                                        @foreach ($list as $data)
                                                            @if ($data->status == 'Tidak Diisi' && $data->bulan == '10')
                                                                ...
                                                                @if (!$formCFilled[10])
                                                                    <img src="{{ asset('calendar.png') }}" height='30px' alt="" data-toggle="tooltip" data-placement="bottom" title="Sila isi Borang C terlebih dahulu" style="color: black; font-size: 20pt;">
                                                                @elseif ($isPreviousYear || (date('Y-m-d') >= $data->tarikh_buka_borang && date('Y-m-d') <= $tarikh_tutup_terkini))
                                                                    <a href="{{ route('user.shuttle-4-formD', [$year, '10']) }}"
                                                                        data-toggle="tooltip" data-placement="bottom"
                                                                        title="Borang belum diisi">
                                                                        <img src="{{ asset('circle_times.png') }}"
                                                                            height='30px' alt=""
                                                        ...
                                                        @foreach ($list as $data)
                                                            @if ($data->status == 'Tidak Diisi' && $data->bulan == '11')
                                                                ...
                                                                @if (!$formCFilled[11])
                                                                    <img src="{{ asset('calendar.png') }}" height='30px' alt="" data-toggle="tooltip" data-placement="bottom" title="Sila isi Borang C terlebih dahulu" style="color: black; font-size: 20pt;">
                                                                @elseif ($isPreviousYear || (date('Y-m-d') >= $data->tarikh_buka_borang && date('Y-m-d') <= $tarikh_tutup_terkini))
                                                                    <a href="{{ route('user.shuttle-4-formD', [$year, '11']) }}"
                                                                        data-toggle="tooltip" data-placement="bottom"
                                                                        title="Borang belum diisi">
                                                                        <img src="{{ asset('circle_times.png') }}"
                                                                            height='30px' alt=""
                                                        ...
                                                        @foreach ($list as $data)
                                                            @if ($data->status == 'Tidak Diisi' && $data->bulan == '12')
                                                                ...
                                                                @if (!$formCFilled[12])
                                                                    <img src="{{ asset('calendar.png') }}" height='30px' alt="" data-toggle="tooltip" data-placement="bottom" title="Sila isi Borang C terlebih dahulu" style="color: black; font-size: 20pt;">
                                                                @elseif ($isPreviousYear || (date('Y-m-d') >= $data->tarikh_buka_borang && date('Y-m-d') <= $tarikh_tutup_terkini))
                                                                    <a href="{{ route('user.shuttle-4-formD', [$year, '12']) }}"
                                                                        data-toggle="tooltip" data-placement="bottom"
                                                                        title="Borang belum diisi">
                                                                        <img src="{{ asset('circle_times.png') }}"
                                                                            height='30px' alt=""
