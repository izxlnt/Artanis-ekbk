...
@section('content')
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div>
                                ...
                                <h4 class="text-center">BORANG 5E - PENYATA PENJUALAN KAYU KUMAI DALAM PASARAN TEMPATAN
                                    DAN EKSPORT
                                </h4>
                            </div> <br>
                            <div class="">
                                            ...
                                            <td>
                                                @foreach ($list as $data)
                                                    ...
                                                    @elseif($data->status == 'Sedang Diproses' && $data->bulan == '1')
                                                        <a
                                                            href="{{ route('pengguna.shuttle-5-view-form5E', $data->id) }}">
                                                    ...
                                                    @elseif($data->status == 'Tidak Lengkap' && $data->bulan == '1')
                                                        <a href="{{ route('user.shuttle-5-edit-formE', $data->id) }}"
                                                            data-toggle="tooltip" data-placement="bottom"
    ...
    <script>
        function changePage() {
            ...
            window.location.href = "<?php echo URL::to('/pengguna/shuttle-5-senaraiE/" + year +"'); ?>";
        }
    </script>
