...
@section('content')
                    ...
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <a type="button " href="{{ route('user.shuttle-4-listA', date('Y')) }}"
                                            class="btn" style="background-color:rgb(196, 188, 186);color:black;border-color:rgb(196, 188, 186)">Borang 4A</a>
                                        ...
                                        <a type="button" href="{{ route('user.shuttle-4-listC', date('Y')) }}"
                                            class="btn" style="background-color:white;color:black;border-color:#9e9c7bf3">Borang 4C</a>
                            ...
                            <h4 class="text-center">PENYATA SHUTTLE 4 - KILANG PAPAN LAPIS/VENIR</h4>
                                ...
                                <h4 class="text-center">BORANG 4A - MAKLUMAT KILANG PAPAN LAPIS/VENIR</h4>
                            </div>
                            <div class="">
    ...
    <script>
        function changePage(){
            ...
            window.location.href = "<?php echo URL::to('/pengguna/shuttle-4-listA/" + year +"'); ?>";
        }
    </script>
