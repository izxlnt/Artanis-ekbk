...
@section('content')
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <a type="button" href="{{ route('user.shuttle-5-listD', date('Y')) }}"
                                        ...
                                        class="btn" style="background-color:rgb(54, 140, 238);color:black;border-color:rgb(54, 140, 238">Borang 5E</a>
                                    </div>
                                </div>
                            </div>
                            <br><br>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('user.shuttle-5-edit-formE',$data->id) }}"> <img src="{{ asset('history.png') }}" height='30px' alt="" style="font-size: 15pt;"
                                                    data-toggle="tooltip" data-placement="bottom"
                                                    title="Borang Tidak Lengkap"></i></a>
                                                @elseif($data->status == 'Tidak Diisi')
                                                    <a href="{{ route('user.shuttle-5-formE', [$year, $data->bulan]) }}"
    ...
    <script>
        function changePage(){
            ...
            window.location.href = "<?php echo URL::to('/pengguna/shuttle-5-listE/" + year +"'); ?>";
        }
    </script>
