...
@section('content')
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <a type="button" href="{{ route('user.shuttle-5-listB', date('Y')) }}"
                                            class="btn" style="background-color:#ee8dcd;color:black;border-color:#e72cc8f3">Borang 5B</a>
    ...
    <script>
        function changePage(){
            ...
            window.location.href = "<?php echo URL::to('/pengguna/shuttle-5-listB/" + year +"'); ?>";
        }
    </script>
